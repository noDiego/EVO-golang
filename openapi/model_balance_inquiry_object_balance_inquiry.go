...
// BalanceInquiryObjectBalanceInquiry struct for BalanceInquiryObjectBalanceInquiry
type BalanceInquiryObjectBalanceInquiry struct {
...
func NewBalanceInquiryObjectBalanceInquiry(companyIdentification string, systemIdentification string) *BalanceInquiryObjectBalanceInquiry {
	this := BalanceInquiryObjectBalanceInquiry{}
...
func (o BalanceInquiryObjectBalanceInquiry) MarshalJSON() ([]byte, error) {
...
type NullableBalanceInquiryObjectBalanceInquiry struct {
	value *BalanceInquiryObjectBalanceInquiry
	isSet bool
}

func (v NullableBalanceInquiryObjectBalanceInquiry) Get() *BalanceInquiryObjectBalanceInquiry {
	return v.value
}

func (v *NullableBalanceInquiryObjectBalanceInquiry) Set(val *BalanceInquiryObjectBalanceInquiry) {
	v.value = val
	v.isSet = true
}

func (v NullableBalanceInquiryObjectBalanceInquiry) IsSet() bool {
	return v.isSet
}

func (v *NullableBalanceInquiryObjectBalanceInquiry) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBalanceInquiryObjectBalanceInquiry(val *BalanceInquiryObjectBalanceInquiry) *NullableBalanceInquiryObjectBalanceInquiry {
	return &NullableBalanceInquiryObjectBalanceInquiry{value: val, isSet: true}
}

func (v NullableBalanceInquiryObjectBalanceInquiry) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBalanceInquiryObjectBalanceInquiry) UnmarshalJSON(src []byte) error {
	v.isSet = true
