...
// SaleObjectSalePayer Datos del Pagador
type SaleObjectSalePayer struct {
...
func (o SaleObjectSalePayer) MarshalJSON() ([]byte, error) {
...
type NullableSaleObjectSalePayer struct {
	value *SaleObjectSalePayer
	isSet bool
}

func (v NullableSaleObjectSalePayer) Get() *SaleObjectSalePayer {
	return v.value
}

func (v *NullableSaleObjectSalePayer) Set(val *SaleObjectSalePayer) {
	v.value = val
	v.isSet = true
}

func (v NullableSaleObjectSalePayer) IsSet() bool {
	return v.isSet
}

func (v *NullableSaleObjectSalePayer) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSaleObjectSalePayer(val *SaleObjectSalePayer) *NullableSaleObjectSalePayer {
	return &NullableSaleObjectSalePayer{value: val, isSet: true}
}

func (v NullableSaleObjectSalePayer) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSaleObjectSalePayer) UnmarshalJSON(src []byte) error {
	v.isSet = true
