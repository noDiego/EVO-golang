...
// PaymentMethodResponseObjectPaymentMethodResponseConfigurationCompany Datos de la compañía.
type PaymentMethodResponseObjectPaymentMethodResponseConfigurationCompany struct {
	// Id de la compañía.
	...
	// RegionCode de la región la compañía.
	RegionCode *string `json:"RegionCode,omitempty"`
	// ZipCode de la compañía.
	ZipCode *string `json:"ZipCode,omitempty"`
	// Código del país de la compañía.
	CountryCode *string `json:"CountryCode,omitempty"`
	// Categoría de la compañía.
...
func NewPaymentMethodResponseObjectPaymentMethodResponseConfigurationCompany() *PaymentMethodResponseObjectPaymentMethodResponseConfigurationCompany {
	this := PaymentMethodResponseObjectPaymentMethodResponseConfigurationCompany{}
	return &this
}
...
// and a boolean to check if the value has been set.
func (o *PaymentMethodResponseObjectPaymentMethodResponseConfigurationCompany) GetDescriptionOk() (*string, bool) {
	if o == nil || o.Description == nil {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
func (o *PaymentMethodResponseObjectPaymentMethodResponseConfigurationCompany) GetCaptionOk() (*string, bool) {
	if o == nil || o.Caption == nil {
		return nil, false
	}
...
func (o *PaymentMethodResponseObjectPaymentMethodResponseConfigurationCompany) SetRegionCode(v string) {
	o.RegionCode = &v
}
...
func (o *PaymentMethodResponseObjectPaymentMethodResponseConfigurationCompany) SetCountryCode(v string) {
	o.CountryCode = &v
}
...
// SetAdditionalConfig gets a reference to the given map[string]interface{} and assigns it to the AdditionalConfig field.
func (o *PaymentMethodResponseObjectPaymentMethodResponseConfigurationCompany) SetAdditionalConfig(v map[string]interface{}) {
	o.AdditionalConfig = v
}

func (o PaymentMethodResponseObjectPaymentMethodResponseConfigurationCompany) MarshalJSON() ([]byte, error) {
	...
	if o.AdditionalConfig != nil {
		toSerialize["AdditionalConfig"] = o.AdditionalConfig
	}
	return json.Marshal(toSerialize)
}

type NullablePaymentMethodResponseObjectPaymentMethodResponseConfigurationCompany struct {
	value *PaymentMethodResponseObjectPaymentMethodResponseConfigurationCompany
	isSet bool
}

func (v NullablePaymentMethodResponseObjectPaymentMethodResponseConfigurationCompany) Get() *PaymentMethodResponseObjectPaymentMethodResponseConfigurationCompany {
	return v.value
}

func (v *NullablePaymentMethodResponseObjectPaymentMethodResponseConfigurationCompany) Set(val *PaymentMethodResponseObjectPaymentMethodResponseConfigurationCompany) {
	v.value = val
	v.isSet = true
}

func (v NullablePaymentMethodResponseObjectPaymentMethodResponseConfigurationCompany) IsSet() bool {
	return v.isSet
}

func (v *NullablePaymentMethodResponseObjectPaymentMethodResponseConfigurationCompany) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaymentMethodResponseObjectPaymentMethodResponseConfigurationCompany(val *PaymentMethodResponseObjectPaymentMethodResponseConfigurationCompany) *NullablePaymentMethodResponseObjectPaymentMethodResponseConfigurationCompany {
	return &NullablePaymentMethodResponseObjectPaymentMethodResponseConfigurationCompany{value: val, isSet: true}
}

func (v NullablePaymentMethodResponseObjectPaymentMethodResponseConfigurationCompany) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaymentMethodResponseObjectPaymentMethodResponseConfigurationCompany) UnmarshalJSON(src []byte) error {
	v.isSet = true
