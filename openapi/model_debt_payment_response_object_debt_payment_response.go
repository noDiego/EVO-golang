...
// DebtPaymentResponseObjectDebtPaymentResponse struct for DebtPaymentResponseObjectDebtPaymentResponse
type DebtPaymentResponseObjectDebtPaymentResponse struct {
	...
	// Monto con la que se realizo transacción
...
func NewDebtPaymentResponseObjectDebtPaymentResponse(responseActions []string, responseMessage string, responseCode int32) *DebtPaymentResponseObjectDebtPaymentResponse {
	this := DebtPaymentResponseObjectDebtPaymentResponse{}
...
func (o DebtPaymentResponseObjectDebtPaymentResponse) MarshalJSON() ([]byte, error) {
...
type NullableDebtPaymentResponseObjectDebtPaymentResponse struct {
	value *DebtPaymentResponseObjectDebtPaymentResponse
	isSet bool
}

func (v NullableDebtPaymentResponseObjectDebtPaymentResponse) Get() *DebtPaymentResponseObjectDebtPaymentResponse {
	return v.value
}

func (v *NullableDebtPaymentResponseObjectDebtPaymentResponse) Set(val *DebtPaymentResponseObjectDebtPaymentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDebtPaymentResponseObjectDebtPaymentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDebtPaymentResponseObjectDebtPaymentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDebtPaymentResponseObjectDebtPaymentResponse(val *DebtPaymentResponseObjectDebtPaymentResponse) *NullableDebtPaymentResponseObjectDebtPaymentResponse {
	return &NullableDebtPaymentResponseObjectDebtPaymentResponse{value: val, isSet: true}
}

func (v NullableDebtPaymentResponseObjectDebtPaymentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDebtPaymentResponseObjectDebtPaymentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
