...
// SaleObjectSaleProducts struct for SaleObjectSaleProducts
type SaleObjectSaleProducts struct {
	// Número de Producto, Elemento o Item de la operación
...
func (o SaleObjectSaleProducts) MarshalJSON() ([]byte, error) {
...
type NullableSaleObjectSaleProducts struct {
	value *SaleObjectSaleProducts
	isSet bool
}

func (v NullableSaleObjectSaleProducts) Get() *SaleObjectSaleProducts {
	return v.value
}

func (v *NullableSaleObjectSaleProducts) Set(val *SaleObjectSaleProducts) {
	v.value = val
	v.isSet = true
}

func (v NullableSaleObjectSaleProducts) IsSet() bool {
	return v.isSet
}

func (v *NullableSaleObjectSaleProducts) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSaleObjectSaleProducts(val *SaleObjectSaleProducts) *NullableSaleObjectSaleProducts {
	return &NullableSaleObjectSaleProducts{value: val, isSet: true}
}

func (v NullableSaleObjectSaleProducts) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSaleObjectSaleProducts) UnmarshalJSON(src []byte) error {
	v.isSet = true
