...
// SaleResponseObjectSaleResponseRequiredInformation struct for SaleResponseObjectSaleResponseRequiredInformation
type SaleResponseObjectSaleResponseRequiredInformation struct {
...
func NewSaleResponseObjectSaleResponseRequiredInformation() *SaleResponseObjectSaleResponseRequiredInformation {
	this := SaleResponseObjectSaleResponseRequiredInformation{}
	return &this
}
...
func (o SaleResponseObjectSaleResponseRequiredInformation) MarshalJSON() ([]byte, error) {
...
type NullableSaleResponseObjectSaleResponseRequiredInformation struct {
	value *SaleResponseObjectSaleResponseRequiredInformation
	isSet bool
}

func (v NullableSaleResponseObjectSaleResponseRequiredInformation) Get() *SaleResponseObjectSaleResponseRequiredInformation {
	return v.value
}

func (v *NullableSaleResponseObjectSaleResponseRequiredInformation) Set(val *SaleResponseObjectSaleResponseRequiredInformation) {
	v.value = val
	v.isSet = true
}

func (v NullableSaleResponseObjectSaleResponseRequiredInformation) IsSet() bool {
	return v.isSet
}

func (v *NullableSaleResponseObjectSaleResponseRequiredInformation) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSaleResponseObjectSaleResponseRequiredInformation(val *SaleResponseObjectSaleResponseRequiredInformation) *NullableSaleResponseObjectSaleResponseRequiredInformation {
	return &NullableSaleResponseObjectSaleResponseRequiredInformation{value: val, isSet: true}
}

func (v NullableSaleResponseObjectSaleResponseRequiredInformation) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSaleResponseObjectSaleResponseRequiredInformation) UnmarshalJSON(src []byte) error {
	v.isSet = true
