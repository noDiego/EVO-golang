...
// PaymentMethodsResponseObjectPaymentMethodsResponse struct for PaymentMethodsResponseObjectPaymentMethodsResponse
type PaymentMethodsResponseObjectPaymentMethodsResponse struct {
	// Código de respueta interno, generado por el Plataforma. Este código de respuesta será el primero que debe ser analizado por parte del punto de venta. Solo en caso de que el código fuese -1, se deberá continuar analizando el resto de la respuesta para comprobar si fue aprobada o no por parte del host.
	...
	// Array de todos los medios de pago encontrados para la companía solicitada
	PaymentMethods []PaymentMethodsResponseObjectPaymentMethodsResponsePaymentMethods `json:"PaymentMethods,omitempty"`
...
func NewPaymentMethodsResponseObjectPaymentMethodsResponse(responseCode int32, responseActions []string, responseMessage string) *PaymentMethodsResponseObjectPaymentMethodsResponse {
	this := PaymentMethodsResponseObjectPaymentMethodsResponse{}
...
func (o *PaymentMethodsResponseObjectPaymentMethodsResponse) GetPaymentMethods() []PaymentMethodsResponseObjectPaymentMethodsResponsePaymentMethods {
	if o == nil || o.PaymentMethods == nil {
		var ret []PaymentMethodsResponseObjectPaymentMethodsResponsePaymentMethods
		return ret
	}
...
// SetPaymentMethods gets a reference to the given []PaymentMethodsResponseObjectPaymentMethodsResponsePaymentMethods and assigns it to the PaymentMethods field.
...
func (o PaymentMethodsResponseObjectPaymentMethodsResponse) MarshalJSON() ([]byte, error) {
...
type NullablePaymentMethodsResponseObjectPaymentMethodsResponse struct {
	value *PaymentMethodsResponseObjectPaymentMethodsResponse
	isSet bool
}

func (v NullablePaymentMethodsResponseObjectPaymentMethodsResponse) Get() *PaymentMethodsResponseObjectPaymentMethodsResponse {
	return v.value
}

func (v *NullablePaymentMethodsResponseObjectPaymentMethodsResponse) Set(val *PaymentMethodsResponseObjectPaymentMethodsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullablePaymentMethodsResponseObjectPaymentMethodsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullablePaymentMethodsResponseObjectPaymentMethodsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaymentMethodsResponseObjectPaymentMethodsResponse(val *PaymentMethodsResponseObjectPaymentMethodsResponse) *NullablePaymentMethodsResponseObjectPaymentMethodsResponse {
	return &NullablePaymentMethodsResponseObjectPaymentMethodsResponse{value: val, isSet: true}
}

func (v NullablePaymentMethodsResponseObjectPaymentMethodsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaymentMethodsResponseObjectPaymentMethodsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
