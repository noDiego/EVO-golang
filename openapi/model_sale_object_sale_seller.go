...
// SaleObjectSaleSeller Datos del vendedor
type SaleObjectSaleSeller struct {
	// Identificador del Vendedor
	Identification *string `json:"Identification,omitempty"`
	// Tipo de documento del Vendedor. CI, Cédula de identidad - PAS, Pasaporte, Documento nacional de identidad, Contrato - CONTRACT, Número de Cuenta - ACCOUNT_NUMBER
	IdentificationType *string `json:"IdentificationType,omitempty"`
	// Email del Vendedor
	Email *string `json:"Email,omitempty"`
	// Tipo de documento del Vendedor. CI, Cédula de identidad - PAS, Pasaporte, Documento nacional de identidad, Contrato - CONTRACT, Número de Cuenta - ACCOUNT_NUMBER
	DocumentType *string `json:"DocumentType,omitempty"`
	// Número de Documento o identificación del Vendedor
	...
	// Tipo o de categoría  del Comercio Vendedor (ISO 18245)
	CategoryCode *int32 `json:"CategoryCode,omitempty"`
	// Tipo de categoría tributaria del Vendedor
	...
	// URL para notificación del Vendedor
...
func (o SaleObjectSaleSeller) MarshalJSON() ([]byte, error) {
...
type NullableSaleObjectSaleSeller struct {
	value *SaleObjectSaleSeller
	isSet bool
}

func (v NullableSaleObjectSaleSeller) Get() *SaleObjectSaleSeller {
	return v.value
}

func (v *NullableSaleObjectSaleSeller) Set(val *SaleObjectSaleSeller) {
	v.value = val
	v.isSet = true
}

func (v NullableSaleObjectSaleSeller) IsSet() bool {
	return v.isSet
}

func (v *NullableSaleObjectSaleSeller) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSaleObjectSaleSeller(val *SaleObjectSaleSeller) *NullableSaleObjectSaleSeller {
	return &NullableSaleObjectSaleSeller{value: val, isSet: true}
}

func (v NullableSaleObjectSaleSeller) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSaleObjectSaleSeller) UnmarshalJSON(src []byte) error {
	v.isSet = true
