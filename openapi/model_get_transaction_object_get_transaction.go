...
// GetTransactionObjectGetTransaction struct for GetTransactionObjectGetTransaction
type GetTransactionObjectGetTransaction struct {
...
func NewGetTransactionObjectGetTransaction(companyIdentification string, systemIdentification string) *GetTransactionObjectGetTransaction {
	this := GetTransactionObjectGetTransaction{}
...
func (o GetTransactionObjectGetTransaction) MarshalJSON() ([]byte, error) {
...
type NullableGetTransactionObjectGetTransaction struct {
	value *GetTransactionObjectGetTransaction
	isSet bool
}

func (v NullableGetTransactionObjectGetTransaction) Get() *GetTransactionObjectGetTransaction {
	return v.value
}

func (v *NullableGetTransactionObjectGetTransaction) Set(val *GetTransactionObjectGetTransaction) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTransactionObjectGetTransaction) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTransactionObjectGetTransaction) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTransactionObjectGetTransaction(val *GetTransactionObjectGetTransaction) *NullableGetTransactionObjectGetTransaction {
	return &NullableGetTransactionObjectGetTransaction{value: val, isSet: true}
}

func (v NullableGetTransactionObjectGetTransaction) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTransactionObjectGetTransaction) UnmarshalJSON(src []byte) error {
	v.isSet = true
