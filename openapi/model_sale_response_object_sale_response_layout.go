...
// SaleResponseObjectSaleResponseLayout struct for SaleResponseObjectSaleResponseLayout
type SaleResponseObjectSaleResponseLayout struct {
	// Posibles atributos de impresión que se aplicarán en el Data. En caso de no estar presente el elemento se imprime el texto en el tamaño predefinido como normal y con justificación a la izquierda (LeftJustified).
	...
	// Tipo de codificación de los datos. En caso de no estar presente el elemento se asume que el elemento Data está codificado como Plain.
	EncodeType *string `json:"EncodeType,omitempty"`
	// Dato a imprimir codificado según los valores presentes en ContentType y EncodeType.
...
func NewSaleResponseObjectSaleResponseLayout() *SaleResponseObjectSaleResponseLayout {
	this := SaleResponseObjectSaleResponseLayout{}
	return &this
}
...
// GetEncodeType returns the EncodeType field value if set, zero value otherwise.
func (o *SaleResponseObjectSaleResponseLayout) GetEncodeType() string {
	if o == nil || o.EncodeType == nil {
		var ret string
		return ret
	}
	return *o.EncodeType
...
// GetEncodeTypeOk returns a tuple with the EncodeType field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SaleResponseObjectSaleResponseLayout) GetEncodeTypeOk() (*string, bool) {
	if o == nil || o.EncodeType == nil {
		return nil, false
	}
	return o.EncodeType, true
}
...
// SetEncodeType gets a reference to the given string and assigns it to the EncodeType field.
...
func (o SaleResponseObjectSaleResponseLayout) MarshalJSON() ([]byte, error) {
	...
	if o.EncodeType != nil {
		toSerialize["EncodeType"] = o.EncodeType
	}
	if o.Data != nil {
...
type NullableSaleResponseObjectSaleResponseLayout struct {
	value *SaleResponseObjectSaleResponseLayout
	isSet bool
}

func (v NullableSaleResponseObjectSaleResponseLayout) Get() *SaleResponseObjectSaleResponseLayout {
	return v.value
}

func (v *NullableSaleResponseObjectSaleResponseLayout) Set(val *SaleResponseObjectSaleResponseLayout) {
	v.value = val
	v.isSet = true
}

func (v NullableSaleResponseObjectSaleResponseLayout) IsSet() bool {
	return v.isSet
}

func (v *NullableSaleResponseObjectSaleResponseLayout) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSaleResponseObjectSaleResponseLayout(val *SaleResponseObjectSaleResponseLayout) *NullableSaleResponseObjectSaleResponseLayout {
	return &NullableSaleResponseObjectSaleResponseLayout{value: val, isSet: true}
}

func (v NullableSaleResponseObjectSaleResponseLayout) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSaleResponseObjectSaleResponseLayout) UnmarshalJSON(src []byte) error {
	v.isSet = true
