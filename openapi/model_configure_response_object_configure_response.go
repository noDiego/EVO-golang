...
// ConfigureResponseObjectConfigureResponse struct for ConfigureResponseObjectConfigureResponse
type ConfigureResponseObjectConfigureResponse struct {
...
func NewConfigureResponseObjectConfigureResponse(responseActions []string, responseMessage string, responseCode int32) *ConfigureResponseObjectConfigureResponse {
	this := ConfigureResponseObjectConfigureResponse{}
...
func (o ConfigureResponseObjectConfigureResponse) MarshalJSON() ([]byte, error) {
...
type NullableConfigureResponseObjectConfigureResponse struct {
	value *ConfigureResponseObjectConfigureResponse
	isSet bool
}

func (v NullableConfigureResponseObjectConfigureResponse) Get() *ConfigureResponseObjectConfigureResponse {
	return v.value
}

func (v *NullableConfigureResponseObjectConfigureResponse) Set(val *ConfigureResponseObjectConfigureResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableConfigureResponseObjectConfigureResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableConfigureResponseObjectConfigureResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConfigureResponseObjectConfigureResponse(val *ConfigureResponseObjectConfigureResponse) *NullableConfigureResponseObjectConfigureResponse {
	return &NullableConfigureResponseObjectConfigureResponse{value: val, isSet: true}
}

func (v NullableConfigureResponseObjectConfigureResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConfigureResponseObjectConfigureResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
