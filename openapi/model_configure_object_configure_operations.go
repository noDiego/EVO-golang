...
// ConfigureObjectConfigureOperations Cada objetorepresenta un tipo de Operación/transacción
type ConfigureObjectConfigureOperations struct {
	// Identificador de tipo de Operación, Ej Sale
	...
	// Timeout por default para dicha operación expresado en milisegúndos
...
func NewConfigureObjectConfigureOperations() *ConfigureObjectConfigureOperations {
	this := ConfigureObjectConfigureOperations{}
	return &this
}
...
func (o ConfigureObjectConfigureOperations) MarshalJSON() ([]byte, error) {
...
type NullableConfigureObjectConfigureOperations struct {
	value *ConfigureObjectConfigureOperations
	isSet bool
}

func (v NullableConfigureObjectConfigureOperations) Get() *ConfigureObjectConfigureOperations {
	return v.value
}

func (v *NullableConfigureObjectConfigureOperations) Set(val *ConfigureObjectConfigureOperations) {
	v.value = val
	v.isSet = true
}

func (v NullableConfigureObjectConfigureOperations) IsSet() bool {
	return v.isSet
}

func (v *NullableConfigureObjectConfigureOperations) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConfigureObjectConfigureOperations(val *ConfigureObjectConfigureOperations) *NullableConfigureObjectConfigureOperations {
	return &NullableConfigureObjectConfigureOperations{value: val, isSet: true}
}

func (v NullableConfigureObjectConfigureOperations) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConfigureObjectConfigureOperations) UnmarshalJSON(src []byte) error {
	v.isSet = true
