...
// GetCardResponseObjectGetCardResponse struct for GetCardResponseObjectGetCardResponse
type GetCardResponseObjectGetCardResponse struct {
	...
	// código de seguridad de la tarjeta. Este dato solo sera requerido si la parametrización de la marca a la que la tarjeta corresponde lo indique.
	SecurityCode *string `json:"SecurityCode,omitempty"`
	// Criptograma obtenido del Chip
...
func NewGetCardResponseObjectGetCardResponse(responseCode int32, responseActions []string, responseMessage string) *GetCardResponseObjectGetCardResponse {
	this := GetCardResponseObjectGetCardResponse{}
...
func (o GetCardResponseObjectGetCardResponse) MarshalJSON() ([]byte, error) {
...
type NullableGetCardResponseObjectGetCardResponse struct {
	value *GetCardResponseObjectGetCardResponse
	isSet bool
}

func (v NullableGetCardResponseObjectGetCardResponse) Get() *GetCardResponseObjectGetCardResponse {
	return v.value
}

func (v *NullableGetCardResponseObjectGetCardResponse) Set(val *GetCardResponseObjectGetCardResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableGetCardResponseObjectGetCardResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableGetCardResponseObjectGetCardResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetCardResponseObjectGetCardResponse(val *GetCardResponseObjectGetCardResponse) *NullableGetCardResponseObjectGetCardResponse {
	return &NullableGetCardResponseObjectGetCardResponse{value: val, isSet: true}
}

func (v NullableGetCardResponseObjectGetCardResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetCardResponseObjectGetCardResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
