...
// SaleResponseObjectSaleResponsePlansDeferral Objeto que contiene toda la información para conocer lo que el plan permite con respecto al diferimiento.
type SaleResponseObjectSaleResponsePlansDeferral struct {
	// Permite Diferimiento.
	IsAllowed *bool `json:"IsAllowed,omitempty"`
	// Máxima Cantidad de Días.
	MaxDays *float32 `json:"MaxDays,omitempty"`
	// Mínima Cantidad de Días.
	MinDays *float32 `json:"MinDays,omitempty"`
}
...
func NewSaleResponseObjectSaleResponsePlansDeferral() *SaleResponseObjectSaleResponsePlansDeferral {
	this := SaleResponseObjectSaleResponsePlansDeferral{}
	return &this
}
...
// SetMaxDays gets a reference to the given float32 and assigns it to the MaxDays field.
...
// SetMinDays gets a reference to the given float32 and assigns it to the MinDays field.
func (o *SaleResponseObjectSaleResponsePlansDeferral) SetMinDays(v float32) {
	o.MinDays = &v
}

func (o SaleResponseObjectSaleResponsePlansDeferral) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if o.IsAllowed != nil {
		toSerialize["IsAllowed"] = o.IsAllowed
	}
	if o.MaxDays != nil {
		toSerialize["MaxDays"] = o.MaxDays
	}
	if o.MinDays != nil {
...
type NullableSaleResponseObjectSaleResponsePlansDeferral struct {
	value *SaleResponseObjectSaleResponsePlansDeferral
	isSet bool
}

func (v NullableSaleResponseObjectSaleResponsePlansDeferral) Get() *SaleResponseObjectSaleResponsePlansDeferral {
	return v.value
}

func (v *NullableSaleResponseObjectSaleResponsePlansDeferral) Set(val *SaleResponseObjectSaleResponsePlansDeferral) {
	v.value = val
	v.isSet = true
}

func (v NullableSaleResponseObjectSaleResponsePlansDeferral) IsSet() bool {
	return v.isSet
}

func (v *NullableSaleResponseObjectSaleResponsePlansDeferral) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSaleResponseObjectSaleResponsePlansDeferral(val *SaleResponseObjectSaleResponsePlansDeferral) *NullableSaleResponseObjectSaleResponsePlansDeferral {
	return &NullableSaleResponseObjectSaleResponsePlansDeferral{value: val, isSet: true}
}

func (v NullableSaleResponseObjectSaleResponsePlansDeferral) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSaleResponseObjectSaleResponsePlansDeferral) UnmarshalJSON(src []byte) error {
	v.isSet = true
