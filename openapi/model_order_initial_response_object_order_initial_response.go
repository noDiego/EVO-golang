...
// OrderInitialResponseObjectOrderInitialResponse struct for OrderInitialResponseObjectOrderInitialResponse
type OrderInitialResponseObjectOrderInitialResponse struct {
...
func NewOrderInitialResponseObjectOrderInitialResponse(responseActions []string, responseMessage string, responseCode int32) *OrderInitialResponseObjectOrderInitialResponse {
	this := OrderInitialResponseObjectOrderInitialResponse{}
...
func (o OrderInitialResponseObjectOrderInitialResponse) MarshalJSON() ([]byte, error) {
...
type NullableOrderInitialResponseObjectOrderInitialResponse struct {
	value *OrderInitialResponseObjectOrderInitialResponse
	isSet bool
}

func (v NullableOrderInitialResponseObjectOrderInitialResponse) Get() *OrderInitialResponseObjectOrderInitialResponse {
	return v.value
}

func (v *NullableOrderInitialResponseObjectOrderInitialResponse) Set(val *OrderInitialResponseObjectOrderInitialResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableOrderInitialResponseObjectOrderInitialResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableOrderInitialResponseObjectOrderInitialResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrderInitialResponseObjectOrderInitialResponse(val *OrderInitialResponseObjectOrderInitialResponse) *NullableOrderInitialResponseObjectOrderInitialResponse {
	return &NullableOrderInitialResponseObjectOrderInitialResponse{value: val, isSet: true}
}

func (v NullableOrderInitialResponseObjectOrderInitialResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOrderInitialResponseObjectOrderInitialResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
