...
// BlockCloseResponseObjectBlockCloseResponse struct for BlockCloseResponseObjectBlockCloseResponse
type BlockCloseResponseObjectBlockCloseResponse struct {
...
func NewBlockCloseResponseObjectBlockCloseResponse(responseActions []string, responseMessage string, responseCode int32) *BlockCloseResponseObjectBlockCloseResponse {
	this := BlockCloseResponseObjectBlockCloseResponse{}
...
func (o BlockCloseResponseObjectBlockCloseResponse) MarshalJSON() ([]byte, error) {
...
type NullableBlockCloseResponseObjectBlockCloseResponse struct {
	value *BlockCloseResponseObjectBlockCloseResponse
	isSet bool
}

func (v NullableBlockCloseResponseObjectBlockCloseResponse) Get() *BlockCloseResponseObjectBlockCloseResponse {
	return v.value
}

func (v *NullableBlockCloseResponseObjectBlockCloseResponse) Set(val *BlockCloseResponseObjectBlockCloseResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableBlockCloseResponseObjectBlockCloseResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableBlockCloseResponseObjectBlockCloseResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBlockCloseResponseObjectBlockCloseResponse(val *BlockCloseResponseObjectBlockCloseResponse) *NullableBlockCloseResponseObjectBlockCloseResponse {
	return &NullableBlockCloseResponseObjectBlockCloseResponse{value: val, isSet: true}
}

func (v NullableBlockCloseResponseObjectBlockCloseResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBlockCloseResponseObjectBlockCloseResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
