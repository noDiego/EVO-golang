...
// KeysRenewalResponseObjectKeysRenewalResponse struct for KeysRenewalResponseObjectKeysRenewalResponse
type KeysRenewalResponseObjectKeysRenewalResponse struct {
	...
	// Retornado en todas las respuestas que el POS/PINPAD debe enviar en el próximo requerimiento. En caso de que el POS no lo envíe, envíe vacío o con un valor que no corresponde se produce “La Ruptura de Secuencia” y la plataforma, si la última transacción que realizó el POS no esta confirmada y esta aprobada, genera una reversa de la misma.
...
func NewKeysRenewalResponseObjectKeysRenewalResponse(responseCode int32, responseActions []string, responseMessage string) *KeysRenewalResponseObjectKeysRenewalResponse {
	this := KeysRenewalResponseObjectKeysRenewalResponse{}
...
func (o KeysRenewalResponseObjectKeysRenewalResponse) MarshalJSON() ([]byte, error) {
...
type NullableKeysRenewalResponseObjectKeysRenewalResponse struct {
	value *KeysRenewalResponseObjectKeysRenewalResponse
	isSet bool
}

func (v NullableKeysRenewalResponseObjectKeysRenewalResponse) Get() *KeysRenewalResponseObjectKeysRenewalResponse {
	return v.value
}

func (v *NullableKeysRenewalResponseObjectKeysRenewalResponse) Set(val *KeysRenewalResponseObjectKeysRenewalResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableKeysRenewalResponseObjectKeysRenewalResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableKeysRenewalResponseObjectKeysRenewalResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableKeysRenewalResponseObjectKeysRenewalResponse(val *KeysRenewalResponseObjectKeysRenewalResponse) *NullableKeysRenewalResponseObjectKeysRenewalResponse {
	return &NullableKeysRenewalResponseObjectKeysRenewalResponse{value: val, isSet: true}
}

func (v NullableKeysRenewalResponseObjectKeysRenewalResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableKeysRenewalResponseObjectKeysRenewalResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
