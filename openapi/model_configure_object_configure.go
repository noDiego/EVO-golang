...
// ConfigureObjectConfigure struct for ConfigureObjectConfigure
type ConfigureObjectConfigure struct {
	...
	// Diferentes modos de ingresos para los cuales el plan puede ser utilizado
	OperationMode *string `json:"OperationMode,omitempty"`
	// Descripción del campo OperationMode
	OperationModeDescription *string `json:"OperationModeDescription,omitempty"`
	// Operaciones y su configuración.
	Operations []ConfigureObjectConfigureOperations `json:"Operations,omitempty"`
	// Tablas de  configuración.
	Tables []ConfigureObjectConfigureTables `json:"Tables,omitempty"`
	// Archivos de  configuración, Contenido Multimedia, Aplicaciones, Firmware.
	Files []ConfigureObjectConfigureFiles `json:"Files,omitempty"`
}
...
// GetOperationModeDescription returns the OperationModeDescription field value if set, zero value otherwise.
func (o *ConfigureObjectConfigure) GetOperationModeDescription() string {
	if o == nil || o.OperationModeDescription == nil {
		var ret string
		return ret
	}
	return *o.OperationModeDescription
}

// GetOperationModeDescriptionOk returns a tuple with the OperationModeDescription field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ConfigureObjectConfigure) GetOperationModeDescriptionOk() (*string, bool) {
	if o == nil || o.OperationModeDescription == nil {
		return nil, false
	}
	return o.OperationModeDescription, true
}
...
// SetOperations gets a reference to the given []ConfigureObjectConfigureOperations and assigns it to the Operations field.
...
func (o *ConfigureObjectConfigure) GetTables() []ConfigureObjectConfigureTables {
	if o == nil || o.Tables == nil {
		var ret []ConfigureObjectConfigureTables
		return ret
	}
	return o.Tables
}
...
// SetTables gets a reference to the given []ConfigureObjectConfigureTables and assigns it to the Tables field.
...
func (o *ConfigureObjectConfigure) GetFiles() []ConfigureObjectConfigureFiles {
	if o == nil || o.Files == nil {
		var ret []ConfigureObjectConfigureFiles
		return ret
	}
	return o.Files
}
...
// SetFiles gets a reference to the given []ConfigureObjectConfigureFiles and assigns it to the Files field.
func (o *ConfigureObjectConfigure) SetFiles(v []ConfigureObjectConfigureFiles) {
	o.Files = v
}

func (o ConfigureObjectConfigure) MarshalJSON() ([]byte, error) {
	...
	if o.OperationModeDescription != nil {
		toSerialize["OperationModeDescription"] = o.OperationModeDescription
	}
	if o.Operations != nil {
...
type NullableConfigureObjectConfigure struct {
	value *ConfigureObjectConfigure
	isSet bool
}

func (v NullableConfigureObjectConfigure) Get() *ConfigureObjectConfigure {
	return v.value
}

func (v *NullableConfigureObjectConfigure) Set(val *ConfigureObjectConfigure) {
	v.value = val
	v.isSet = true
}

func (v NullableConfigureObjectConfigure) IsSet() bool {
	return v.isSet
}

func (v *NullableConfigureObjectConfigure) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConfigureObjectConfigure(val *ConfigureObjectConfigure) *NullableConfigureObjectConfigure {
	return &NullableConfigureObjectConfigure{value: val, isSet: true}
}

func (v NullableConfigureObjectConfigure) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConfigureObjectConfigure) UnmarshalJSON(src []byte) error {
	v.isSet = true
