...
// CancelObjectCancel struct for CancelObjectCancel
type CancelObjectCancel struct {
	...
	// Motivo por el cual se requiere Cancelar.
...
func (o CancelObjectCancel) MarshalJSON() ([]byte, error) {
...
type NullableCancelObjectCancel struct {
	value *CancelObjectCancel
	isSet bool
}

func (v NullableCancelObjectCancel) Get() *CancelObjectCancel {
	return v.value
}

func (v *NullableCancelObjectCancel) Set(val *CancelObjectCancel) {
	v.value = val
	v.isSet = true
}

func (v NullableCancelObjectCancel) IsSet() bool {
	return v.isSet
}

func (v *NullableCancelObjectCancel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCancelObjectCancel(val *CancelObjectCancel) *NullableCancelObjectCancel {
	return &NullableCancelObjectCancel{value: val, isSet: true}
}

func (v NullableCancelObjectCancel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCancelObjectCancel) UnmarshalJSON(src []byte) error {
	v.isSet = true
