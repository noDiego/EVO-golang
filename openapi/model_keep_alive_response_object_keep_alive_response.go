...
// KeepAliveResponseObjectKeepAliveResponse struct for KeepAliveResponseObjectKeepAliveResponse
type KeepAliveResponseObjectKeepAliveResponse struct {
...
func NewKeepAliveResponseObjectKeepAliveResponse(responseActions []string, responseMessage string, responseCode int32) *KeepAliveResponseObjectKeepAliveResponse {
	this := KeepAliveResponseObjectKeepAliveResponse{}
...
func (o KeepAliveResponseObjectKeepAliveResponse) MarshalJSON() ([]byte, error) {
...
type NullableKeepAliveResponseObjectKeepAliveResponse struct {
	value *KeepAliveResponseObjectKeepAliveResponse
	isSet bool
}

func (v NullableKeepAliveResponseObjectKeepAliveResponse) Get() *KeepAliveResponseObjectKeepAliveResponse {
	return v.value
}

func (v *NullableKeepAliveResponseObjectKeepAliveResponse) Set(val *KeepAliveResponseObjectKeepAliveResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableKeepAliveResponseObjectKeepAliveResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableKeepAliveResponseObjectKeepAliveResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableKeepAliveResponseObjectKeepAliveResponse(val *KeepAliveResponseObjectKeepAliveResponse) *NullableKeepAliveResponseObjectKeepAliveResponse {
	return &NullableKeepAliveResponseObjectKeepAliveResponse{value: val, isSet: true}
}

func (v NullableKeepAliveResponseObjectKeepAliveResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableKeepAliveResponseObjectKeepAliveResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
