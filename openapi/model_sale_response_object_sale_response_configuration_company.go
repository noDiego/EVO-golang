...
// SaleResponseObjectSaleResponseConfigurationCompany Datos de la compañía.
type SaleResponseObjectSaleResponseConfigurationCompany struct {
	// Id de la compañía.
...
func NewSaleResponseObjectSaleResponseConfigurationCompany() *SaleResponseObjectSaleResponseConfigurationCompany {
	this := SaleResponseObjectSaleResponseConfigurationCompany{}
	return &this
}
...
func (o SaleResponseObjectSaleResponseConfigurationCompany) MarshalJSON() ([]byte, error) {
...
type NullableSaleResponseObjectSaleResponseConfigurationCompany struct {
	value *SaleResponseObjectSaleResponseConfigurationCompany
	isSet bool
}

func (v NullableSaleResponseObjectSaleResponseConfigurationCompany) Get() *SaleResponseObjectSaleResponseConfigurationCompany {
	return v.value
}

func (v *NullableSaleResponseObjectSaleResponseConfigurationCompany) Set(val *SaleResponseObjectSaleResponseConfigurationCompany) {
	v.value = val
	v.isSet = true
}

func (v NullableSaleResponseObjectSaleResponseConfigurationCompany) IsSet() bool {
	return v.isSet
}

func (v *NullableSaleResponseObjectSaleResponseConfigurationCompany) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSaleResponseObjectSaleResponseConfigurationCompany(val *SaleResponseObjectSaleResponseConfigurationCompany) *NullableSaleResponseObjectSaleResponseConfigurationCompany {
	return &NullableSaleResponseObjectSaleResponseConfigurationCompany{value: val, isSet: true}
}

func (v NullableSaleResponseObjectSaleResponseConfigurationCompany) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSaleResponseObjectSaleResponseConfigurationCompany) UnmarshalJSON(src []byte) error {
	v.isSet = true
