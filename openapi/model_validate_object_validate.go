...
// ValidateObjectValidate struct for ValidateObjectValidate
type ValidateObjectValidate struct {
...
func (o ValidateObjectValidate) MarshalJSON() ([]byte, error) {
...
type NullableValidateObjectValidate struct {
	value *ValidateObjectValidate
	isSet bool
}

func (v NullableValidateObjectValidate) Get() *ValidateObjectValidate {
	return v.value
}

func (v *NullableValidateObjectValidate) Set(val *ValidateObjectValidate) {
	v.value = val
	v.isSet = true
}

func (v NullableValidateObjectValidate) IsSet() bool {
	return v.isSet
}

func (v *NullableValidateObjectValidate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableValidateObjectValidate(val *ValidateObjectValidate) *NullableValidateObjectValidate {
	return &NullableValidateObjectValidate{value: val, isSet: true}
}

func (v NullableValidateObjectValidate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableValidateObjectValidate) UnmarshalJSON(src []byte) error {
	v.isSet = true
