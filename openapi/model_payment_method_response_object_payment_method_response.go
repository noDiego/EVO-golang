...
// PaymentMethodResponseObjectPaymentMethodResponse struct for PaymentMethodResponseObjectPaymentMethodResponse
type PaymentMethodResponseObjectPaymentMethodResponse struct {
	...
	Configuration *PaymentMethodResponseObjectPaymentMethodResponseConfiguration `json:"Configuration,omitempty"`
}
...
func NewPaymentMethodResponseObjectPaymentMethodResponse(responseCode int32, responseActions []string, responseMessage string) *PaymentMethodResponseObjectPaymentMethodResponse {
	this := PaymentMethodResponseObjectPaymentMethodResponse{}
...
func (o *PaymentMethodResponseObjectPaymentMethodResponse) GetConfiguration() PaymentMethodResponseObjectPaymentMethodResponseConfiguration {
	if o == nil || o.Configuration == nil {
		var ret PaymentMethodResponseObjectPaymentMethodResponseConfiguration
		return ret
	}
...
// SetConfiguration gets a reference to the given PaymentMethodResponseObjectPaymentMethodResponseConfiguration and assigns it to the Configuration field.
...
func (o PaymentMethodResponseObjectPaymentMethodResponse) MarshalJSON() ([]byte, error) {
...
type NullablePaymentMethodResponseObjectPaymentMethodResponse struct {
	value *PaymentMethodResponseObjectPaymentMethodResponse
	isSet bool
}

func (v NullablePaymentMethodResponseObjectPaymentMethodResponse) Get() *PaymentMethodResponseObjectPaymentMethodResponse {
	return v.value
}

func (v *NullablePaymentMethodResponseObjectPaymentMethodResponse) Set(val *PaymentMethodResponseObjectPaymentMethodResponse) {
	v.value = val
	v.isSet = true
}

func (v NullablePaymentMethodResponseObjectPaymentMethodResponse) IsSet() bool {
	return v.isSet
}

func (v *NullablePaymentMethodResponseObjectPaymentMethodResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaymentMethodResponseObjectPaymentMethodResponse(val *PaymentMethodResponseObjectPaymentMethodResponse) *NullablePaymentMethodResponseObjectPaymentMethodResponse {
	return &NullablePaymentMethodResponseObjectPaymentMethodResponse{value: val, isSet: true}
}

func (v NullablePaymentMethodResponseObjectPaymentMethodResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaymentMethodResponseObjectPaymentMethodResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
