...
// CloseObjectClose struct for CloseObjectClose
type CloseObjectClose struct {
...
func (o CloseObjectClose) MarshalJSON() ([]byte, error) {
...
type NullableCloseObjectClose struct {
	value *CloseObjectClose
	isSet bool
}

func (v NullableCloseObjectClose) Get() *CloseObjectClose {
	return v.value
}

func (v *NullableCloseObjectClose) Set(val *CloseObjectClose) {
	v.value = val
	v.isSet = true
}

func (v NullableCloseObjectClose) IsSet() bool {
	return v.isSet
}

func (v *NullableCloseObjectClose) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCloseObjectClose(val *CloseObjectClose) *NullableCloseObjectClose {
	return &NullableCloseObjectClose{value: val, isSet: true}
}

func (v NullableCloseObjectClose) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCloseObjectClose) UnmarshalJSON(src []byte) error {
	v.isSet = true
