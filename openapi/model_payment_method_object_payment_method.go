...
// PaymentMethodObjectPaymentMethod struct for PaymentMethodObjectPaymentMethod
type PaymentMethodObjectPaymentMethod struct {
	...
	// Tipo de Transacción (Sale, Void, Return, Authorize,...) por la cual se está realizado el requerimiento
	...
	// ID del  metodo de pago que se requerie la información
	...
	PaymentMethodForeignIdentifier *int32 `json:"PaymentMethodForeignIdentifier,omitempty"`
	// Tipo de operación financiera a la cual se pretende anular o devolver, para la cual se pretende utilizar esta lectura de tarjeta. Este campo sera de uso obligatorio solo para determinados tipos de dispositivos de captura.
	OrigTransactionType *string `json:"OrigTransactionType,omitempty"`
	// ID del emisor que se encuentra disponible para este plan
	Issuer *string `json:"Issuer,omitempty"`
	// Flag utilizado para indicar si se quiere conocer los planes dinamicos tambien, como Plan V de Prisma.
	GetDinamicPlans *float32 `json:"GetDinamicPlans,omitempty"`
...
func NewPaymentMethodObjectPaymentMethod(companyIdentification string, systemIdentification string) *PaymentMethodObjectPaymentMethod {
	this := PaymentMethodObjectPaymentMethod{}
...
// GetPaymentMethodForeignIdentifier returns the PaymentMethodForeignIdentifier field value if set, zero value otherwise.
func (o *PaymentMethodObjectPaymentMethod) GetPaymentMethodForeignIdentifier() int32 {
	if o == nil || o.PaymentMethodForeignIdentifier == nil {
		var ret int32
		return ret
	}
	return *o.PaymentMethodForeignIdentifier
}

// GetPaymentMethodForeignIdentifierOk returns a tuple with the PaymentMethodForeignIdentifier field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PaymentMethodObjectPaymentMethod) GetPaymentMethodForeignIdentifierOk() (*int32, bool) {
	if o == nil || o.PaymentMethodForeignIdentifier == nil {
		return nil, false
	}
	return o.PaymentMethodForeignIdentifier, true
}
...
// SetPaymentMethodForeignIdentifier gets a reference to the given int32 and assigns it to the PaymentMethodForeignIdentifier field.
func (o *PaymentMethodObjectPaymentMethod) SetPaymentMethodForeignIdentifier(v int32) {
	o.PaymentMethodForeignIdentifier = &v
}

// GetOrigTransactionType returns the OrigTransactionType field value if set, zero value otherwise.
func (o *PaymentMethodObjectPaymentMethod) GetOrigTransactionType() string {
	if o == nil || o.OrigTransactionType == nil {
		var ret string
		return ret
	}
	return *o.OrigTransactionType
}

// GetOrigTransactionTypeOk returns a tuple with the OrigTransactionType field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PaymentMethodObjectPaymentMethod) GetOrigTransactionTypeOk() (*string, bool) {
	if o == nil || o.OrigTransactionType == nil {
		return nil, false
	}
	return o.OrigTransactionType, true
}
...
// SetOrigTransactionType gets a reference to the given string and assigns it to the OrigTransactionType field.
func (o *PaymentMethodObjectPaymentMethod) SetOrigTransactionType(v string) {
	o.OrigTransactionType = &v
}
...
// GetGetDinamicPlans returns the GetDinamicPlans field value if set, zero value otherwise.
func (o *PaymentMethodObjectPaymentMethod) GetGetDinamicPlans() float32 {
	if o == nil || o.GetDinamicPlans == nil {
		var ret float32
		return ret
	}
	return *o.GetDinamicPlans
}

// GetGetDinamicPlansOk returns a tuple with the GetDinamicPlans field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PaymentMethodObjectPaymentMethod) GetGetDinamicPlansOk() (*float32, bool) {
	if o == nil || o.GetDinamicPlans == nil {
		return nil, false
	}
	return o.GetDinamicPlans, true
}
...
// SetGetDinamicPlans gets a reference to the given float32 and assigns it to the GetDinamicPlans field.
...
func (o PaymentMethodObjectPaymentMethod) MarshalJSON() ([]byte, error) {
	...
	if o.PaymentMethodForeignIdentifier != nil {
		toSerialize["PaymentMethodForeignIdentifier"] = o.PaymentMethodForeignIdentifier
	}
	if o.OrigTransactionType != nil {
		toSerialize["OrigTransactionType"] = o.OrigTransactionType
	}
	if o.Issuer != nil {
		toSerialize["Issuer"] = o.Issuer
	}
	if o.GetDinamicPlans != nil {
		toSerialize["GetDinamicPlans"] = o.GetDinamicPlans
	}
...
type NullablePaymentMethodObjectPaymentMethod struct {
	value *PaymentMethodObjectPaymentMethod
	isSet bool
}

func (v NullablePaymentMethodObjectPaymentMethod) Get() *PaymentMethodObjectPaymentMethod {
	return v.value
}

func (v *NullablePaymentMethodObjectPaymentMethod) Set(val *PaymentMethodObjectPaymentMethod) {
	v.value = val
	v.isSet = true
}

func (v NullablePaymentMethodObjectPaymentMethod) IsSet() bool {
	return v.isSet
}

func (v *NullablePaymentMethodObjectPaymentMethod) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaymentMethodObjectPaymentMethod(val *PaymentMethodObjectPaymentMethod) *NullablePaymentMethodObjectPaymentMethod {
	return &NullablePaymentMethodObjectPaymentMethod{value: val, isSet: true}
}

func (v NullablePaymentMethodObjectPaymentMethod) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaymentMethodObjectPaymentMethod) UnmarshalJSON(src []byte) error {
	v.isSet = true
