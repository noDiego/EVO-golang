...
// EnableServiceObjectEnableService struct for EnableServiceObjectEnableService
type EnableServiceObjectEnableService struct {
	...
	// Información Recibida para autenticar la operación, puede una un Token, PIN o Clave.
...
func NewEnableServiceObjectEnableService(systemIdentification string, companyIdentification string, authenticationInformation string) *EnableServiceObjectEnableService {
	this := EnableServiceObjectEnableService{}
...
// GetAuthenticationInformation returns the AuthenticationInformation field value
func (o *EnableServiceObjectEnableService) GetAuthenticationInformation() string {
	...
	return o.AuthenticationInformation
}

// GetAuthenticationInformationOk returns a tuple with the AuthenticationInformation field value
// and a boolean to check if the value has been set.
func (o *EnableServiceObjectEnableService) GetAuthenticationInformationOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
	return &o.AuthenticationInformation, true
}

// SetAuthenticationInformation sets field value
func (o *EnableServiceObjectEnableService) SetAuthenticationInformation(v string) {
	o.AuthenticationInformation = v
}
...
func (o EnableServiceObjectEnableService) MarshalJSON() ([]byte, error) {
	...
	if true {
		toSerialize["AuthenticationInformation"] = o.AuthenticationInformation
	}
...
type NullableEnableServiceObjectEnableService struct {
	value *EnableServiceObjectEnableService
	isSet bool
}

func (v NullableEnableServiceObjectEnableService) Get() *EnableServiceObjectEnableService {
	return v.value
}

func (v *NullableEnableServiceObjectEnableService) Set(val *EnableServiceObjectEnableService) {
	v.value = val
	v.isSet = true
}

func (v NullableEnableServiceObjectEnableService) IsSet() bool {
	return v.isSet
}

func (v *NullableEnableServiceObjectEnableService) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEnableServiceObjectEnableService(val *EnableServiceObjectEnableService) *NullableEnableServiceObjectEnableService {
	return &NullableEnableServiceObjectEnableService{value: val, isSet: true}
}

func (v NullableEnableServiceObjectEnableService) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEnableServiceObjectEnableService) UnmarshalJSON(src []byte) error {
	v.isSet = true
