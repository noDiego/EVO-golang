...
// VoidDebtPaymentObjectVoidDebtPayment struct for VoidDebtPaymentObjectVoidDebtPayment
type VoidDebtPaymentObjectVoidDebtPayment struct {
	...
	Products []VoidDebtPaymentObjectVoidDebtPaymentProducts `json:"Products,omitempty"`
...
func NewVoidDebtPaymentObjectVoidDebtPayment(companyIdentification string, systemIdentification string) *VoidDebtPaymentObjectVoidDebtPayment {
	this := VoidDebtPaymentObjectVoidDebtPayment{}
...
func (o *VoidDebtPaymentObjectVoidDebtPayment) GetProducts() []VoidDebtPaymentObjectVoidDebtPaymentProducts {
	if o == nil || o.Products == nil {
		var ret []VoidDebtPaymentObjectVoidDebtPaymentProducts
		return ret
	}
	return o.Products
}
...
// SetProducts gets a reference to the given []VoidDebtPaymentObjectVoidDebtPaymentProducts and assigns it to the Products field.
...
func (o VoidDebtPaymentObjectVoidDebtPayment) MarshalJSON() ([]byte, error) {
...
type NullableVoidDebtPaymentObjectVoidDebtPayment struct {
	value *VoidDebtPaymentObjectVoidDebtPayment
	isSet bool
}

func (v NullableVoidDebtPaymentObjectVoidDebtPayment) Get() *VoidDebtPaymentObjectVoidDebtPayment {
	return v.value
}

func (v *NullableVoidDebtPaymentObjectVoidDebtPayment) Set(val *VoidDebtPaymentObjectVoidDebtPayment) {
	v.value = val
	v.isSet = true
}

func (v NullableVoidDebtPaymentObjectVoidDebtPayment) IsSet() bool {
	return v.isSet
}

func (v *NullableVoidDebtPaymentObjectVoidDebtPayment) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVoidDebtPaymentObjectVoidDebtPayment(val *VoidDebtPaymentObjectVoidDebtPayment) *NullableVoidDebtPaymentObjectVoidDebtPayment {
	return &NullableVoidDebtPaymentObjectVoidDebtPayment{value: val, isSet: true}
}

func (v NullableVoidDebtPaymentObjectVoidDebtPayment) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVoidDebtPaymentObjectVoidDebtPayment) UnmarshalJSON(src []byte) error {
	v.isSet = true
