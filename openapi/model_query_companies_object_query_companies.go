...
// QueryCompaniesObjectQueryCompanies struct for QueryCompaniesObjectQueryCompanies
type QueryCompaniesObjectQueryCompanies struct {
	...
	// ID de Rubro para el cual queremos obtener las empresas
...
func NewQueryCompaniesObjectQueryCompanies(systemIdentification string, companyIdentification string) *QueryCompaniesObjectQueryCompanies {
	this := QueryCompaniesObjectQueryCompanies{}
...
func (o QueryCompaniesObjectQueryCompanies) MarshalJSON() ([]byte, error) {
...
type NullableQueryCompaniesObjectQueryCompanies struct {
	value *QueryCompaniesObjectQueryCompanies
	isSet bool
}

func (v NullableQueryCompaniesObjectQueryCompanies) Get() *QueryCompaniesObjectQueryCompanies {
	return v.value
}

func (v *NullableQueryCompaniesObjectQueryCompanies) Set(val *QueryCompaniesObjectQueryCompanies) {
	v.value = val
	v.isSet = true
}

func (v NullableQueryCompaniesObjectQueryCompanies) IsSet() bool {
	return v.isSet
}

func (v *NullableQueryCompaniesObjectQueryCompanies) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQueryCompaniesObjectQueryCompanies(val *QueryCompaniesObjectQueryCompanies) *NullableQueryCompaniesObjectQueryCompanies {
	return &NullableQueryCompaniesObjectQueryCompanies{value: val, isSet: true}
}

func (v NullableQueryCompaniesObjectQueryCompanies) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQueryCompaniesObjectQueryCompanies) UnmarshalJSON(src []byte) error {
	v.isSet = true
