...
// OrderStatusResponseObjectOrderStatusResponse struct for OrderStatusResponseObjectOrderStatusResponse
type OrderStatusResponseObjectOrderStatusResponse struct {
...
func NewOrderStatusResponseObjectOrderStatusResponse(responseCode int32, responseActions []string, responseMessage string) *OrderStatusResponseObjectOrderStatusResponse {
	this := OrderStatusResponseObjectOrderStatusResponse{}
...
func (o OrderStatusResponseObjectOrderStatusResponse) MarshalJSON() ([]byte, error) {
...
type NullableOrderStatusResponseObjectOrderStatusResponse struct {
	value *OrderStatusResponseObjectOrderStatusResponse
	isSet bool
}

func (v NullableOrderStatusResponseObjectOrderStatusResponse) Get() *OrderStatusResponseObjectOrderStatusResponse {
	return v.value
}

func (v *NullableOrderStatusResponseObjectOrderStatusResponse) Set(val *OrderStatusResponseObjectOrderStatusResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableOrderStatusResponseObjectOrderStatusResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableOrderStatusResponseObjectOrderStatusResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrderStatusResponseObjectOrderStatusResponse(val *OrderStatusResponseObjectOrderStatusResponse) *NullableOrderStatusResponseObjectOrderStatusResponse {
	return &NullableOrderStatusResponseObjectOrderStatusResponse{value: val, isSet: true}
}

func (v NullableOrderStatusResponseObjectOrderStatusResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOrderStatusResponseObjectOrderStatusResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
