...
// SaleResponseObjectSaleResponseWorkingKeys struct for SaleResponseObjectSaleResponseWorkingKeys
type SaleResponseObjectSaleResponseWorkingKeys struct {
...
func NewSaleResponseObjectSaleResponseWorkingKeys() *SaleResponseObjectSaleResponseWorkingKeys {
	this := SaleResponseObjectSaleResponseWorkingKeys{}
	return &this
}
...
func (o SaleResponseObjectSaleResponseWorkingKeys) MarshalJSON() ([]byte, error) {
...
type NullableSaleResponseObjectSaleResponseWorkingKeys struct {
	value *SaleResponseObjectSaleResponseWorkingKeys
	isSet bool
}

func (v NullableSaleResponseObjectSaleResponseWorkingKeys) Get() *SaleResponseObjectSaleResponseWorkingKeys {
	return v.value
}

func (v *NullableSaleResponseObjectSaleResponseWorkingKeys) Set(val *SaleResponseObjectSaleResponseWorkingKeys) {
	v.value = val
	v.isSet = true
}

func (v NullableSaleResponseObjectSaleResponseWorkingKeys) IsSet() bool {
	return v.isSet
}

func (v *NullableSaleResponseObjectSaleResponseWorkingKeys) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSaleResponseObjectSaleResponseWorkingKeys(val *SaleResponseObjectSaleResponseWorkingKeys) *NullableSaleResponseObjectSaleResponseWorkingKeys {
	return &NullableSaleResponseObjectSaleResponseWorkingKeys{value: val, isSet: true}
}

func (v NullableSaleResponseObjectSaleResponseWorkingKeys) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSaleResponseObjectSaleResponseWorkingKeys) UnmarshalJSON(src []byte) error {
	v.isSet = true
