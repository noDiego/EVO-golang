...
// DebtInquiryResponseObjectDebtInquiryResponseCompanies struct for DebtInquiryResponseObjectDebtInquiryResponseCompanies
type DebtInquiryResponseObjectDebtInquiryResponseCompanies struct {
...
func NewDebtInquiryResponseObjectDebtInquiryResponseCompanies() *DebtInquiryResponseObjectDebtInquiryResponseCompanies {
	this := DebtInquiryResponseObjectDebtInquiryResponseCompanies{}
	return &this
}
...
func (o DebtInquiryResponseObjectDebtInquiryResponseCompanies) MarshalJSON() ([]byte, error) {
...
type NullableDebtInquiryResponseObjectDebtInquiryResponseCompanies struct {
	value *DebtInquiryResponseObjectDebtInquiryResponseCompanies
	isSet bool
}

func (v NullableDebtInquiryResponseObjectDebtInquiryResponseCompanies) Get() *DebtInquiryResponseObjectDebtInquiryResponseCompanies {
	return v.value
}

func (v *NullableDebtInquiryResponseObjectDebtInquiryResponseCompanies) Set(val *DebtInquiryResponseObjectDebtInquiryResponseCompanies) {
	v.value = val
	v.isSet = true
}

func (v NullableDebtInquiryResponseObjectDebtInquiryResponseCompanies) IsSet() bool {
	return v.isSet
}

func (v *NullableDebtInquiryResponseObjectDebtInquiryResponseCompanies) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDebtInquiryResponseObjectDebtInquiryResponseCompanies(val *DebtInquiryResponseObjectDebtInquiryResponseCompanies) *NullableDebtInquiryResponseObjectDebtInquiryResponseCompanies {
	return &NullableDebtInquiryResponseObjectDebtInquiryResponseCompanies{value: val, isSet: true}
}

func (v NullableDebtInquiryResponseObjectDebtInquiryResponseCompanies) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDebtInquiryResponseObjectDebtInquiryResponseCompanies) UnmarshalJSON(src []byte) error {
	v.isSet = true
