...
// SaleResponseObjectSaleResponseAdditionalInformation struct for SaleResponseObjectSaleResponseAdditionalInformation
type SaleResponseObjectSaleResponseAdditionalInformation struct {
...
func NewSaleResponseObjectSaleResponseAdditionalInformation() *SaleResponseObjectSaleResponseAdditionalInformation {
	this := SaleResponseObjectSaleResponseAdditionalInformation{}
	return &this
}
...
func (o SaleResponseObjectSaleResponseAdditionalInformation) MarshalJSON() ([]byte, error) {
...
type NullableSaleResponseObjectSaleResponseAdditionalInformation struct {
	value *SaleResponseObjectSaleResponseAdditionalInformation
	isSet bool
}

func (v NullableSaleResponseObjectSaleResponseAdditionalInformation) Get() *SaleResponseObjectSaleResponseAdditionalInformation {
	return v.value
}

func (v *NullableSaleResponseObjectSaleResponseAdditionalInformation) Set(val *SaleResponseObjectSaleResponseAdditionalInformation) {
	v.value = val
	v.isSet = true
}

func (v NullableSaleResponseObjectSaleResponseAdditionalInformation) IsSet() bool {
	return v.isSet
}

func (v *NullableSaleResponseObjectSaleResponseAdditionalInformation) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSaleResponseObjectSaleResponseAdditionalInformation(val *SaleResponseObjectSaleResponseAdditionalInformation) *NullableSaleResponseObjectSaleResponseAdditionalInformation {
	return &NullableSaleResponseObjectSaleResponseAdditionalInformation{value: val, isSet: true}
}

func (v NullableSaleResponseObjectSaleResponseAdditionalInformation) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSaleResponseObjectSaleResponseAdditionalInformation) UnmarshalJSON(src []byte) error {
	v.isSet = true
