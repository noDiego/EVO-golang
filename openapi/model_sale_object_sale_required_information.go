...
// SaleObjectSaleRequiredInformation struct for SaleObjectSaleRequiredInformation
type SaleObjectSaleRequiredInformation struct {
...
func NewSaleObjectSaleRequiredInformation() *SaleObjectSaleRequiredInformation {
	this := SaleObjectSaleRequiredInformation{}
	return &this
}
...
func (o SaleObjectSaleRequiredInformation) MarshalJSON() ([]byte, error) {
...
type NullableSaleObjectSaleRequiredInformation struct {
	value *SaleObjectSaleRequiredInformation
	isSet bool
}

func (v NullableSaleObjectSaleRequiredInformation) Get() *SaleObjectSaleRequiredInformation {
	return v.value
}

func (v *NullableSaleObjectSaleRequiredInformation) Set(val *SaleObjectSaleRequiredInformation) {
	v.value = val
	v.isSet = true
}

func (v NullableSaleObjectSaleRequiredInformation) IsSet() bool {
	return v.isSet
}

func (v *NullableSaleObjectSaleRequiredInformation) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSaleObjectSaleRequiredInformation(val *SaleObjectSaleRequiredInformation) *NullableSaleObjectSaleRequiredInformation {
	return &NullableSaleObjectSaleRequiredInformation{value: val, isSet: true}
}

func (v NullableSaleObjectSaleRequiredInformation) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSaleObjectSaleRequiredInformation) UnmarshalJSON(src []byte) error {
	v.isSet = true
