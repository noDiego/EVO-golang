...
// GetCardObjectGetCard struct for GetCardObjectGetCard
type GetCardObjectGetCard struct {
	...
	// Tipo de Transacción (Sale, Void, Return, Authorize,...) por la cual se está realizado el requerimiento (Usado en GetCard)
...
func (o GetCardObjectGetCard) MarshalJSON() ([]byte, error) {
...
type NullableGetCardObjectGetCard struct {
	value *GetCardObjectGetCard
	isSet bool
}

func (v NullableGetCardObjectGetCard) Get() *GetCardObjectGetCard {
	return v.value
}

func (v *NullableGetCardObjectGetCard) Set(val *GetCardObjectGetCard) {
	v.value = val
	v.isSet = true
}

func (v NullableGetCardObjectGetCard) IsSet() bool {
	return v.isSet
}

func (v *NullableGetCardObjectGetCard) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetCardObjectGetCard(val *GetCardObjectGetCard) *NullableGetCardObjectGetCard {
	return &NullableGetCardObjectGetCard{value: val, isSet: true}
}

func (v NullableGetCardObjectGetCard) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetCardObjectGetCard) UnmarshalJSON(src []byte) error {
	v.isSet = true
