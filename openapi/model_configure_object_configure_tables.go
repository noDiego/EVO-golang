...
// ConfigureObjectConfigureTables Cada objetorepresenta una tabla de configuración
type ConfigureObjectConfigureTables struct {
	...
	// Representación de la tabla, codificado en Base64 en caso de no ser JSON el mismo
	Data map[string]interface{} `json:"Data,omitempty"`
	// Fecha y hora de a partir de la cual este archivo entra en vigencia - RFC3339 https://xml2rfc.tools.ietf.org/public/rfc/html/rfc3339.html#anchor14
	EffectiveFrom *time.Time `json:"EffectiveFrom,omitempty"`
	// Fecha y hora de a partir de la cual este archivo entra en vigencia - RFC3339 https://xml2rfc.tools.ietf.org/public/rfc/html/rfc3339.html#anchor14
	EffectiveTo *time.Time `json:"EffectiveTo,omitempty"`
	// Timeout de vida  para dicha tabla expresado en milisegúndos
	TimeOfLife *int32 `json:"TimeOfLife,omitempty"`
	// Timeout de vida  para dicha tabla expresado en milisegúndos para el caso de que el POS o dispositivo se encuentre fuera de línea de la plataforma
	TimeOfLifeOffline *int32 `json:"TimeOfLifeOffline,omitempty"`
}
...
func NewConfigureObjectConfigureTables() *ConfigureObjectConfigureTables {
	this := ConfigureObjectConfigureTables{}
	return &this
}
...
// GetTimeOfLife returns the TimeOfLife field value if set, zero value otherwise.
func (o *ConfigureObjectConfigureTables) GetTimeOfLife() int32 {
	if o == nil || o.TimeOfLife == nil {
		var ret int32
		return ret
	}
	return *o.TimeOfLife
...
// GetTimeOfLifeOk returns a tuple with the TimeOfLife field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ConfigureObjectConfigureTables) GetTimeOfLifeOk() (*int32, bool) {
	if o == nil || o.TimeOfLife == nil {
		return nil, false
	}
	return o.TimeOfLife, true
}
...
// SetTimeOfLife gets a reference to the given int32 and assigns it to the TimeOfLife field.
func (o *ConfigureObjectConfigureTables) SetTimeOfLife(v int32) {
	o.TimeOfLife = &v
}

// GetTimeOfLifeOffline returns the TimeOfLifeOffline field value if set, zero value otherwise.
func (o *ConfigureObjectConfigureTables) GetTimeOfLifeOffline() int32 {
	if o == nil || o.TimeOfLifeOffline == nil {
		var ret int32
		return ret
	}
	return *o.TimeOfLifeOffline
}

// GetTimeOfLifeOfflineOk returns a tuple with the TimeOfLifeOffline field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ConfigureObjectConfigureTables) GetTimeOfLifeOfflineOk() (*int32, bool) {
	if o == nil || o.TimeOfLifeOffline == nil {
		return nil, false
	}
	return o.TimeOfLifeOffline, true
}
...
// SetTimeOfLifeOffline gets a reference to the given int32 and assigns it to the TimeOfLifeOffline field.
func (o *ConfigureObjectConfigureTables) SetTimeOfLifeOffline(v int32) {
	o.TimeOfLifeOffline = &v
}

func (o ConfigureObjectConfigureTables) MarshalJSON() ([]byte, error) {
	...
	if o.TimeOfLife != nil {
		toSerialize["TimeOfLife"] = o.TimeOfLife
	}
	if o.TimeOfLifeOffline != nil {
		toSerialize["TimeOfLifeOffline"] = o.TimeOfLifeOffline
	}
	return json.Marshal(toSerialize)
}

type NullableConfigureObjectConfigureTables struct {
	value *ConfigureObjectConfigureTables
	isSet bool
}

func (v NullableConfigureObjectConfigureTables) Get() *ConfigureObjectConfigureTables {
	return v.value
}

func (v *NullableConfigureObjectConfigureTables) Set(val *ConfigureObjectConfigureTables) {
	v.value = val
	v.isSet = true
}

func (v NullableConfigureObjectConfigureTables) IsSet() bool {
	return v.isSet
}

func (v *NullableConfigureObjectConfigureTables) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConfigureObjectConfigureTables(val *ConfigureObjectConfigureTables) *NullableConfigureObjectConfigureTables {
	return &NullableConfigureObjectConfigureTables{value: val, isSet: true}
}

func (v NullableConfigureObjectConfigureTables) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConfigureObjectConfigureTables) UnmarshalJSON(src []byte) error {
	v.isSet = true
