...
// PaymentMethodsObjectPaymentMethods struct for PaymentMethodsObjectPaymentMethods
type PaymentMethodsObjectPaymentMethods struct {
...
func NewPaymentMethodsObjectPaymentMethods() *PaymentMethodsObjectPaymentMethods {
	this := PaymentMethodsObjectPaymentMethods{}
	return &this
}
...
func (o PaymentMethodsObjectPaymentMethods) MarshalJSON() ([]byte, error) {
...
type NullablePaymentMethodsObjectPaymentMethods struct {
	value *PaymentMethodsObjectPaymentMethods
	isSet bool
}

func (v NullablePaymentMethodsObjectPaymentMethods) Get() *PaymentMethodsObjectPaymentMethods {
	return v.value
}

func (v *NullablePaymentMethodsObjectPaymentMethods) Set(val *PaymentMethodsObjectPaymentMethods) {
	v.value = val
	v.isSet = true
}

func (v NullablePaymentMethodsObjectPaymentMethods) IsSet() bool {
	return v.isSet
}

func (v *NullablePaymentMethodsObjectPaymentMethods) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaymentMethodsObjectPaymentMethods(val *PaymentMethodsObjectPaymentMethods) *NullablePaymentMethodsObjectPaymentMethods {
	return &NullablePaymentMethodsObjectPaymentMethods{value: val, isSet: true}
}

func (v NullablePaymentMethodsObjectPaymentMethods) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaymentMethodsObjectPaymentMethods) UnmarshalJSON(src []byte) error {
	v.isSet = true
