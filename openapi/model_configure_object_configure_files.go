...
// ConfigureObjectConfigureFiles Cada objetorepresenta un archivo
type ConfigureObjectConfigureFiles struct {
	...
	// Lugar donde el archivo se encuentra o sebe alojarse
...
func NewConfigureObjectConfigureFiles() *ConfigureObjectConfigureFiles {
	this := ConfigureObjectConfigureFiles{}
	return &this
}
...
func (o ConfigureObjectConfigureFiles) MarshalJSON() ([]byte, error) {
...
type NullableConfigureObjectConfigureFiles struct {
	value *ConfigureObjectConfigureFiles
	isSet bool
}

func (v NullableConfigureObjectConfigureFiles) Get() *ConfigureObjectConfigureFiles {
	return v.value
}

func (v *NullableConfigureObjectConfigureFiles) Set(val *ConfigureObjectConfigureFiles) {
	v.value = val
	v.isSet = true
}

func (v NullableConfigureObjectConfigureFiles) IsSet() bool {
	return v.isSet
}

func (v *NullableConfigureObjectConfigureFiles) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConfigureObjectConfigureFiles(val *ConfigureObjectConfigureFiles) *NullableConfigureObjectConfigureFiles {
	return &NullableConfigureObjectConfigureFiles{value: val, isSet: true}
}

func (v NullableConfigureObjectConfigureFiles) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConfigureObjectConfigureFiles) UnmarshalJSON(src []byte) error {
	v.isSet = true
