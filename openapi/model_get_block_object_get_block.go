...
// GetBlockObjectGetBlock struct for GetBlockObjectGetBlock
type GetBlockObjectGetBlock struct {
	...
	// Permite especificarLas transacciones requeridas y su estado
	TransactionsRequired []GetBlockObjectGetBlockTransactionsRequired `json:"TransactionsRequired,omitempty"`
}
...
// GetTransactionsRequired returns the TransactionsRequired field value if set, zero value otherwise.
func (o *GetBlockObjectGetBlock) GetTransactionsRequired() []GetBlockObjectGetBlockTransactionsRequired {
	if o == nil || o.TransactionsRequired == nil {
		var ret []GetBlockObjectGetBlockTransactionsRequired
		return ret
	}
	return o.TransactionsRequired
}

// GetTransactionsRequiredOk returns a tuple with the TransactionsRequired field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *GetBlockObjectGetBlock) GetTransactionsRequiredOk() ([]GetBlockObjectGetBlockTransactionsRequired, bool) {
	if o == nil || o.TransactionsRequired == nil {
		return nil, false
	}
	return o.TransactionsRequired, true
}
...
// SetTransactionsRequired gets a reference to the given []GetBlockObjectGetBlockTransactionsRequired and assigns it to the TransactionsRequired field.
func (o *GetBlockObjectGetBlock) SetTransactionsRequired(v []GetBlockObjectGetBlockTransactionsRequired) {
	o.TransactionsRequired = v
}

func (o GetBlockObjectGetBlock) MarshalJSON() ([]byte, error) {
	...
	if o.TransactionsRequired != nil {
		toSerialize["TransactionsRequired"] = o.TransactionsRequired
	}
	return json.Marshal(toSerialize)
}

type NullableGetBlockObjectGetBlock struct {
	value *GetBlockObjectGetBlock
	isSet bool
}

func (v NullableGetBlockObjectGetBlock) Get() *GetBlockObjectGetBlock {
	return v.value
}

func (v *NullableGetBlockObjectGetBlock) Set(val *GetBlockObjectGetBlock) {
	v.value = val
	v.isSet = true
}

func (v NullableGetBlockObjectGetBlock) IsSet() bool {
	return v.isSet
}

func (v *NullableGetBlockObjectGetBlock) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetBlockObjectGetBlock(val *GetBlockObjectGetBlock) *NullableGetBlockObjectGetBlock {
	return &NullableGetBlockObjectGetBlock{value: val, isSet: true}
}

func (v NullableGetBlockObjectGetBlock) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetBlockObjectGetBlock) UnmarshalJSON(src []byte) error {
	v.isSet = true
