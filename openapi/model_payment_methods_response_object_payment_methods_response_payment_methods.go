...
// PaymentMethodsResponseObjectPaymentMethodsResponsePaymentMethods struct for PaymentMethodsResponseObjectPaymentMethodsResponsePaymentMethods
type PaymentMethodsResponseObjectPaymentMethodsResponsePaymentMethods struct {
	// ID interno en la base de datos para este metodo de pago
	...
	// Longitud máxima del Número de tarjeta de este medio de pago
	CardNumberMaxLength *int32 `json:"CardNumberMaxLength,omitempty"`
	// Longitud mínima del Número de tarjeta de este medio de pago
	CardNumberMinLength *int32 `json:"CardNumberMinLength,omitempty"`
	// Longitud máxima del código de seguridad de tarjeta de este medio de pago
	SecurityCodeMaxLength *int32 `json:"SecurityCodeMaxLength,omitempty"`
	// Longitud mínima del código de seguridad de tarjeta de este medio de pago
	SecurityCodeMinLength *int32 `json:"SecurityCodeMinLength,omitempty"`
	// LIena que describe al metodo de pago
	Description *string `json:"Description,omitempty"`
	Type *PaymentMethodsResponseObjectPaymentMethodsResponseType `json:"Type,omitempty"`
	Category *PaymentMethodsResponseObjectPaymentMethodsResponseCategory `json:"Category,omitempty"`
}
...
func NewPaymentMethodsResponseObjectPaymentMethodsResponsePaymentMethods() *PaymentMethodsResponseObjectPaymentMethodsResponsePaymentMethods {
	this := PaymentMethodsResponseObjectPaymentMethodsResponsePaymentMethods{}
	return &this
}
...
// GetCardNumberMaxLength returns the CardNumberMaxLength field value if set, zero value otherwise.
func (o *PaymentMethodsResponseObjectPaymentMethodsResponsePaymentMethods) GetCardNumberMaxLength() int32 {
	if o == nil || o.CardNumberMaxLength == nil {
		var ret int32
		return ret
	}
	return *o.CardNumberMaxLength
}

// GetCardNumberMaxLengthOk returns a tuple with the CardNumberMaxLength field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PaymentMethodsResponseObjectPaymentMethodsResponsePaymentMethods) GetCardNumberMaxLengthOk() (*int32, bool) {
	if o == nil || o.CardNumberMaxLength == nil {
		return nil, false
	}
	return o.CardNumberMaxLength, true
}
...
// SetCardNumberMaxLength gets a reference to the given int32 and assigns it to the CardNumberMaxLength field.
func (o *PaymentMethodsResponseObjectPaymentMethodsResponsePaymentMethods) SetCardNumberMaxLength(v int32) {
	o.CardNumberMaxLength = &v
}

// GetCardNumberMinLength returns the CardNumberMinLength field value if set, zero value otherwise.
func (o *PaymentMethodsResponseObjectPaymentMethodsResponsePaymentMethods) GetCardNumberMinLength() int32 {
	if o == nil || o.CardNumberMinLength == nil {
		var ret int32
		return ret
	}
	return *o.CardNumberMinLength
}

// GetCardNumberMinLengthOk returns a tuple with the CardNumberMinLength field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PaymentMethodsResponseObjectPaymentMethodsResponsePaymentMethods) GetCardNumberMinLengthOk() (*int32, bool) {
	if o == nil || o.CardNumberMinLength == nil {
		return nil, false
	}
	return o.CardNumberMinLength, true
}
...
// SetCardNumberMinLength gets a reference to the given int32 and assigns it to the CardNumberMinLength field.
func (o *PaymentMethodsResponseObjectPaymentMethodsResponsePaymentMethods) SetCardNumberMinLength(v int32) {
	o.CardNumberMinLength = &v
}

// GetSecurityCodeMaxLength returns the SecurityCodeMaxLength field value if set, zero value otherwise.
func (o *PaymentMethodsResponseObjectPaymentMethodsResponsePaymentMethods) GetSecurityCodeMaxLength() int32 {
	if o == nil || o.SecurityCodeMaxLength == nil {
		var ret int32
		return ret
	}
	return *o.SecurityCodeMaxLength
}

// GetSecurityCodeMaxLengthOk returns a tuple with the SecurityCodeMaxLength field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PaymentMethodsResponseObjectPaymentMethodsResponsePaymentMethods) GetSecurityCodeMaxLengthOk() (*int32, bool) {
	if o == nil || o.SecurityCodeMaxLength == nil {
		return nil, false
	}
	return o.SecurityCodeMaxLength, true
}
...
// SetSecurityCodeMaxLength gets a reference to the given int32 and assigns it to the SecurityCodeMaxLength field.
func (o *PaymentMethodsResponseObjectPaymentMethodsResponsePaymentMethods) SetSecurityCodeMaxLength(v int32) {
	o.SecurityCodeMaxLength = &v
}

// GetSecurityCodeMinLength returns the SecurityCodeMinLength field value if set, zero value otherwise.
func (o *PaymentMethodsResponseObjectPaymentMethodsResponsePaymentMethods) GetSecurityCodeMinLength() int32 {
	if o == nil || o.SecurityCodeMinLength == nil {
		var ret int32
		return ret
	}
	return *o.SecurityCodeMinLength
}

// GetSecurityCodeMinLengthOk returns a tuple with the SecurityCodeMinLength field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PaymentMethodsResponseObjectPaymentMethodsResponsePaymentMethods) GetSecurityCodeMinLengthOk() (*int32, bool) {
	if o == nil || o.SecurityCodeMinLength == nil {
		return nil, false
	}
	return o.SecurityCodeMinLength, true
}
...
// SetSecurityCodeMinLength gets a reference to the given int32 and assigns it to the SecurityCodeMinLength field.
func (o *PaymentMethodsResponseObjectPaymentMethodsResponsePaymentMethods) SetSecurityCodeMinLength(v int32) {
	o.SecurityCodeMinLength = &v
}
...
func (o *PaymentMethodsResponseObjectPaymentMethodsResponsePaymentMethods) GetType() PaymentMethodsResponseObjectPaymentMethodsResponseType {
	if o == nil || o.Type == nil {
		var ret PaymentMethodsResponseObjectPaymentMethodsResponseType
		return ret
	}
	return *o.Type
}
...
// SetType gets a reference to the given PaymentMethodsResponseObjectPaymentMethodsResponseType and assigns it to the Type field.
...
func (o *PaymentMethodsResponseObjectPaymentMethodsResponsePaymentMethods) GetCategory() PaymentMethodsResponseObjectPaymentMethodsResponseCategory {
	if o == nil || o.Category == nil {
		var ret PaymentMethodsResponseObjectPaymentMethodsResponseCategory
		return ret
	}
	return *o.Category
}
...
// SetCategory gets a reference to the given PaymentMethodsResponseObjectPaymentMethodsResponseCategory and assigns it to the Category field.
...
func (o PaymentMethodsResponseObjectPaymentMethodsResponsePaymentMethods) MarshalJSON() ([]byte, error) {
	...
	if o.CardNumberMaxLength != nil {
		toSerialize["CardNumberMaxLength"] = o.CardNumberMaxLength
	}
	if o.CardNumberMinLength != nil {
		toSerialize["CardNumberMinLength"] = o.CardNumberMinLength
	}
	if o.SecurityCodeMaxLength != nil {
		toSerialize["SecurityCodeMaxLength"] = o.SecurityCodeMaxLength
	}
	if o.SecurityCodeMinLength != nil {
		toSerialize["SecurityCodeMinLength"] = o.SecurityCodeMinLength
	}
...
type NullablePaymentMethodsResponseObjectPaymentMethodsResponsePaymentMethods struct {
	value *PaymentMethodsResponseObjectPaymentMethodsResponsePaymentMethods
	isSet bool
}

func (v NullablePaymentMethodsResponseObjectPaymentMethodsResponsePaymentMethods) Get() *PaymentMethodsResponseObjectPaymentMethodsResponsePaymentMethods {
	return v.value
}

func (v *NullablePaymentMethodsResponseObjectPaymentMethodsResponsePaymentMethods) Set(val *PaymentMethodsResponseObjectPaymentMethodsResponsePaymentMethods) {
	v.value = val
	v.isSet = true
}

func (v NullablePaymentMethodsResponseObjectPaymentMethodsResponsePaymentMethods) IsSet() bool {
	return v.isSet
}

func (v *NullablePaymentMethodsResponseObjectPaymentMethodsResponsePaymentMethods) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaymentMethodsResponseObjectPaymentMethodsResponsePaymentMethods(val *PaymentMethodsResponseObjectPaymentMethodsResponsePaymentMethods) *NullablePaymentMethodsResponseObjectPaymentMethodsResponsePaymentMethods {
	return &NullablePaymentMethodsResponseObjectPaymentMethodsResponsePaymentMethods{value: val, isSet: true}
}

func (v NullablePaymentMethodsResponseObjectPaymentMethodsResponsePaymentMethods) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaymentMethodsResponseObjectPaymentMethodsResponsePaymentMethods) UnmarshalJSON(src []byte) error {
	v.isSet = true
