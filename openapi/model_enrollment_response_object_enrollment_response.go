...
// EnrollmentResponseObjectEnrollmentResponse struct for EnrollmentResponseObjectEnrollmentResponse
type EnrollmentResponseObjectEnrollmentResponse struct {
...
func NewEnrollmentResponseObjectEnrollmentResponse(responseCode int32, responseActions []string, responseMessage string) *EnrollmentResponseObjectEnrollmentResponse {
	this := EnrollmentResponseObjectEnrollmentResponse{}
...
func (o EnrollmentResponseObjectEnrollmentResponse) MarshalJSON() ([]byte, error) {
...
type NullableEnrollmentResponseObjectEnrollmentResponse struct {
	value *EnrollmentResponseObjectEnrollmentResponse
	isSet bool
}

func (v NullableEnrollmentResponseObjectEnrollmentResponse) Get() *EnrollmentResponseObjectEnrollmentResponse {
	return v.value
}

func (v *NullableEnrollmentResponseObjectEnrollmentResponse) Set(val *EnrollmentResponseObjectEnrollmentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableEnrollmentResponseObjectEnrollmentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableEnrollmentResponseObjectEnrollmentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEnrollmentResponseObjectEnrollmentResponse(val *EnrollmentResponseObjectEnrollmentResponse) *NullableEnrollmentResponseObjectEnrollmentResponse {
	return &NullableEnrollmentResponseObjectEnrollmentResponse{value: val, isSet: true}
}

func (v NullableEnrollmentResponseObjectEnrollmentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEnrollmentResponseObjectEnrollmentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
