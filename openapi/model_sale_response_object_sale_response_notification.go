...
// SaleResponseObjectSaleResponseNotification Notificación a generar alertas vía e-mail. El separador de la lista sera la coma (,).
type SaleResponseObjectSaleResponseNotification struct {
	// Razón por la cuál se envía la notificación, puede ser BlackList, ExceptionList o ControlUse.
	Reason *string `json:"Reason,omitempty"`
	// Mensaje a enviar el cuál puede ser proveniente de la sucursal, de la compañía, del canal o del sistema. Sólo se envía si la razón no es por Regla de control.
	Message *string `json:"Message,omitempty"`
	ControlUseRule *SaleResponseObjectSaleResponseNotificationControlUseRule `json:"ControlUseRule,omitempty"`
	DistributionList *SaleResponseObjectSaleResponseNotificationDistributionList `json:"DistributionList,omitempty"`
}
...
func NewSaleResponseObjectSaleResponseNotification() *SaleResponseObjectSaleResponseNotification {
	this := SaleResponseObjectSaleResponseNotification{}
	return &this
}
...
// GetControlUseRule returns the ControlUseRule field value if set, zero value otherwise.
func (o *SaleResponseObjectSaleResponseNotification) GetControlUseRule() SaleResponseObjectSaleResponseNotificationControlUseRule {
	if o == nil || o.ControlUseRule == nil {
		var ret SaleResponseObjectSaleResponseNotificationControlUseRule
		return ret
	}
	return *o.ControlUseRule
}

// GetControlUseRuleOk returns a tuple with the ControlUseRule field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetControlUseRule gets a reference to the given SaleResponseObjectSaleResponseNotificationControlUseRule and assigns it to the ControlUseRule field.
...
// GetDistributionList returns the DistributionList field value if set, zero value otherwise.
func (o *SaleResponseObjectSaleResponseNotification) GetDistributionList() SaleResponseObjectSaleResponseNotificationDistributionList {
	if o == nil || o.DistributionList == nil {
		var ret SaleResponseObjectSaleResponseNotificationDistributionList
		return ret
	}
	return *o.DistributionList
}

// GetDistributionListOk returns a tuple with the DistributionList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SaleResponseObjectSaleResponseNotification) GetDistributionListOk() (*SaleResponseObjectSaleResponseNotificationDistributionList, bool) {
	...
	return o.DistributionList, true
}
...
// SetDistributionList gets a reference to the given SaleResponseObjectSaleResponseNotificationDistributionList and assigns it to the DistributionList field.
func (o *SaleResponseObjectSaleResponseNotification) SetDistributionList(v SaleResponseObjectSaleResponseNotificationDistributionList) {
	o.DistributionList = &v
}

func (o SaleResponseObjectSaleResponseNotification) MarshalJSON() ([]byte, error) {
	...
	if o.ControlUseRule != nil {
		toSerialize["ControlUseRule"] = o.ControlUseRule
	}
	if o.DistributionList != nil {
		toSerialize["DistributionList"] = o.DistributionList
	}
	return json.Marshal(toSerialize)
}

type NullableSaleResponseObjectSaleResponseNotification struct {
	value *SaleResponseObjectSaleResponseNotification
	isSet bool
}

func (v NullableSaleResponseObjectSaleResponseNotification) Get() *SaleResponseObjectSaleResponseNotification {
	return v.value
}

func (v *NullableSaleResponseObjectSaleResponseNotification) Set(val *SaleResponseObjectSaleResponseNotification) {
	v.value = val
	v.isSet = true
}

func (v NullableSaleResponseObjectSaleResponseNotification) IsSet() bool {
	return v.isSet
}

func (v *NullableSaleResponseObjectSaleResponseNotification) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSaleResponseObjectSaleResponseNotification(val *SaleResponseObjectSaleResponseNotification) *NullableSaleResponseObjectSaleResponseNotification {
	return &NullableSaleResponseObjectSaleResponseNotification{value: val, isSet: true}
}

func (v NullableSaleResponseObjectSaleResponseNotification) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSaleResponseObjectSaleResponseNotification) UnmarshalJSON(src []byte) error {
	v.isSet = true
