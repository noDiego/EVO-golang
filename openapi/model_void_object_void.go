...
// VoidObjectVoid struct for VoidObjectVoid
type VoidObjectVoid struct {
	...
	OrigAnswerKey string `json:"OrigAnswerKey"`
...
func NewVoidObjectVoid(companyIdentification string, systemIdentification string, origAnswerKey string) *VoidObjectVoid {
	...
	this.OrigAnswerKey = origAnswerKey
	return &this
}
...
// GetOrigAnswerKey returns the OrigAnswerKey field value
...
// GetOrigAnswerKeyOk returns a tuple with the OrigAnswerKey field value
// and a boolean to check if the value has been set.
...
// SetOrigAnswerKey sets field value
...
func (o VoidObjectVoid) MarshalJSON() ([]byte, error) {
...
type NullableVoidObjectVoid struct {
	value *VoidObjectVoid
	isSet bool
}

func (v NullableVoidObjectVoid) Get() *VoidObjectVoid {
	return v.value
}

func (v *NullableVoidObjectVoid) Set(val *VoidObjectVoid) {
	v.value = val
	v.isSet = true
}

func (v NullableVoidObjectVoid) IsSet() bool {
	return v.isSet
}

func (v *NullableVoidObjectVoid) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVoidObjectVoid(val *VoidObjectVoid) *NullableVoidObjectVoid {
	return &NullableVoidObjectVoid{value: val, isSet: true}
}

func (v NullableVoidObjectVoid) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVoidObjectVoid) UnmarshalJSON(src []byte) error {
	v.isSet = true
