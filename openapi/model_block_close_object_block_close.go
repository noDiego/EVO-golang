...
// BlockCloseObjectBlockClose struct for BlockCloseObjectBlockClose
type BlockCloseObjectBlockClose struct {
...
func NewBlockCloseObjectBlockClose(companyIdentification string, systemIdentification string, block string) *BlockCloseObjectBlockClose {
	this := BlockCloseObjectBlockClose{}
...
func (o BlockCloseObjectBlockClose) MarshalJSON() ([]byte, error) {
...
type NullableBlockCloseObjectBlockClose struct {
	value *BlockCloseObjectBlockClose
	isSet bool
}

func (v NullableBlockCloseObjectBlockClose) Get() *BlockCloseObjectBlockClose {
	return v.value
}

func (v *NullableBlockCloseObjectBlockClose) Set(val *BlockCloseObjectBlockClose) {
	v.value = val
	v.isSet = true
}

func (v NullableBlockCloseObjectBlockClose) IsSet() bool {
	return v.isSet
}

func (v *NullableBlockCloseObjectBlockClose) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBlockCloseObjectBlockClose(val *BlockCloseObjectBlockClose) *NullableBlockCloseObjectBlockClose {
	return &NullableBlockCloseObjectBlockClose{value: val, isSet: true}
}

func (v NullableBlockCloseObjectBlockClose) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBlockCloseObjectBlockClose) UnmarshalJSON(src []byte) error {
	v.isSet = true
