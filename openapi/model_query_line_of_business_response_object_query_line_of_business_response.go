...
// QueryLineOfBusinessResponseObjectQueryLineOfBusinessResponse struct for QueryLineOfBusinessResponseObjectQueryLineOfBusinessResponse
type QueryLineOfBusinessResponseObjectQueryLineOfBusinessResponse struct {
	...
	// Rubros
	LineOfBusiness []QueryLineOfBusinessResponseObjectQueryLineOfBusinessResponseLineOfBusiness `json:"LineOfBusiness,omitempty"`
...
func NewQueryLineOfBusinessResponseObjectQueryLineOfBusinessResponse(responseActions []string, responseMessage string, responseCode int32, answerKey string) *QueryLineOfBusinessResponseObjectQueryLineOfBusinessResponse {
	this := QueryLineOfBusinessResponseObjectQueryLineOfBusinessResponse{}
...
func (o *QueryLineOfBusinessResponseObjectQueryLineOfBusinessResponse) GetResponseActions() []string {
	if o == nil {
		var ret []string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *QueryLineOfBusinessResponseObjectQueryLineOfBusinessResponse) GetBranchIdentificationOk() (*string, bool) {
	if o == nil || o.BranchIdentification == nil {
		return nil, false
	}
...
func (o *QueryLineOfBusinessResponseObjectQueryLineOfBusinessResponse) HasRequestKey() bool {
	if o != nil && o.RequestKey != nil {
		return true
	}
...
func (o *QueryLineOfBusinessResponseObjectQueryLineOfBusinessResponse) HasAdapterInputNodeName() bool {
	if o != nil && o.AdapterInputNodeName != nil {
		return true
	}
...
func (o *QueryLineOfBusinessResponseObjectQueryLineOfBusinessResponse) SetServiceVersion(v string) {
	o.ServiceVersion = &v
}
...
func (o *QueryLineOfBusinessResponseObjectQueryLineOfBusinessResponse) SetWasClosedPreviousBlock(v int32) {
...
func (o *QueryLineOfBusinessResponseObjectQueryLineOfBusinessResponse) GetLineOfBusiness() []QueryLineOfBusinessResponseObjectQueryLineOfBusinessResponseLineOfBusiness {
	if o == nil || o.LineOfBusiness == nil {
		var ret []QueryLineOfBusinessResponseObjectQueryLineOfBusinessResponseLineOfBusiness
		return ret
	}
...
// SetLineOfBusiness gets a reference to the given []QueryLineOfBusinessResponseObjectQueryLineOfBusinessResponseLineOfBusiness and assigns it to the LineOfBusiness field.
...
// and a boolean to check if the value has been set.
func (o *QueryLineOfBusinessResponseObjectQueryLineOfBusinessResponse) GetConfigurationOk() (*SaleResponseObjectSaleResponseConfiguration, bool) {
	if o == nil || o.Configuration == nil {
		return nil, false
	}
...
func (o QueryLineOfBusinessResponseObjectQueryLineOfBusinessResponse) MarshalJSON() ([]byte, error) {
...
type NullableQueryLineOfBusinessResponseObjectQueryLineOfBusinessResponse struct {
	value *QueryLineOfBusinessResponseObjectQueryLineOfBusinessResponse
	isSet bool
}

func (v NullableQueryLineOfBusinessResponseObjectQueryLineOfBusinessResponse) Get() *QueryLineOfBusinessResponseObjectQueryLineOfBusinessResponse {
	return v.value
}

func (v *NullableQueryLineOfBusinessResponseObjectQueryLineOfBusinessResponse) Set(val *QueryLineOfBusinessResponseObjectQueryLineOfBusinessResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableQueryLineOfBusinessResponseObjectQueryLineOfBusinessResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableQueryLineOfBusinessResponseObjectQueryLineOfBusinessResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQueryLineOfBusinessResponseObjectQueryLineOfBusinessResponse(val *QueryLineOfBusinessResponseObjectQueryLineOfBusinessResponse) *NullableQueryLineOfBusinessResponseObjectQueryLineOfBusinessResponse {
	return &NullableQueryLineOfBusinessResponseObjectQueryLineOfBusinessResponse{value: val, isSet: true}
}

func (v NullableQueryLineOfBusinessResponseObjectQueryLineOfBusinessResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQueryLineOfBusinessResponseObjectQueryLineOfBusinessResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
