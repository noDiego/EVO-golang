...
// WalletsResponseObjectWalletsResponse struct for WalletsResponseObjectWalletsResponse
type WalletsResponseObjectWalletsResponse struct {
	...
	// Colección de Billeteras de Pagos disponibles.
	Wallets []WalletsResponseObjectWalletsResponseWallets `json:"Wallets,omitempty"`
}
...
func NewWalletsResponseObjectWalletsResponse(responseActions []string, responseMessage string, responseCode int32, answerKey string) *WalletsResponseObjectWalletsResponse {
	this := WalletsResponseObjectWalletsResponse{}
...
func (o *WalletsResponseObjectWalletsResponse) GetWallets() []WalletsResponseObjectWalletsResponseWallets {
	if o == nil || o.Wallets == nil {
		var ret []WalletsResponseObjectWalletsResponseWallets
		return ret
	}
	return o.Wallets
}
...
// SetWallets gets a reference to the given []WalletsResponseObjectWalletsResponseWallets and assigns it to the Wallets field.
func (o *WalletsResponseObjectWalletsResponse) SetWallets(v []WalletsResponseObjectWalletsResponseWallets) {
	o.Wallets = v
}

func (o WalletsResponseObjectWalletsResponse) MarshalJSON() ([]byte, error) {
...
type NullableWalletsResponseObjectWalletsResponse struct {
	value *WalletsResponseObjectWalletsResponse
	isSet bool
}

func (v NullableWalletsResponseObjectWalletsResponse) Get() *WalletsResponseObjectWalletsResponse {
	return v.value
}

func (v *NullableWalletsResponseObjectWalletsResponse) Set(val *WalletsResponseObjectWalletsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableWalletsResponseObjectWalletsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableWalletsResponseObjectWalletsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWalletsResponseObjectWalletsResponse(val *WalletsResponseObjectWalletsResponse) *NullableWalletsResponseObjectWalletsResponse {
	return &NullableWalletsResponseObjectWalletsResponse{value: val, isSet: true}
}

func (v NullableWalletsResponseObjectWalletsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWalletsResponseObjectWalletsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
