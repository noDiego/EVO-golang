...
// ConfirmObjectConfirm struct for ConfirmObjectConfirm
type ConfirmObjectConfirm struct {
...
func (o ConfirmObjectConfirm) MarshalJSON() ([]byte, error) {
...
type NullableConfirmObjectConfirm struct {
	value *ConfirmObjectConfirm
	isSet bool
}

func (v NullableConfirmObjectConfirm) Get() *ConfirmObjectConfirm {
	return v.value
}

func (v *NullableConfirmObjectConfirm) Set(val *ConfirmObjectConfirm) {
	v.value = val
	v.isSet = true
}

func (v NullableConfirmObjectConfirm) IsSet() bool {
	return v.isSet
}

func (v *NullableConfirmObjectConfirm) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConfirmObjectConfirm(val *ConfirmObjectConfirm) *NullableConfirmObjectConfirm {
	return &NullableConfirmObjectConfirm{value: val, isSet: true}
}

func (v NullableConfirmObjectConfirm) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConfirmObjectConfirm) UnmarshalJSON(src []byte) error {
	v.isSet = true
