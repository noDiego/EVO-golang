...
// WalletRequestObjectWalletRequest struct for WalletRequestObjectWalletRequest
type WalletRequestObjectWalletRequest struct {
	// Identificación  del sistema o Aplicativo.
	...
	// ID de la sucursal, en caso de no existir ese concepto y ser un dispotivo que tiene posiciónamiento, deberá ser el mismo en caso contrario el mismo valor que el elemento <b>CompanyIdentification</b>
	BranchIdentification *string `json:"BranchIdentification,omitempty"`
	// ID de la caja perteneciente a la sucursal indicada, en caso de no existir ese concepto y ser un dispotivo que tiene un identificador unico como por ejemplo el IMEI deberá viajar este.
	POSIdentification *string `json:"POSIdentification,omitempty"`
	// Tipo de Requerimiento. Solo requerido para protocolos de transporte donde el tipo no se este especificando o en el PATH o en el tipo complejo que contiene al mismo
	...
	// Identificador Privado para ser identificar la transacción a realizar, normalmente es un código a Presentar, solo sera enviado si ya fue creado por un WalletRequest previo y solamente queremos obtener los datos que pudo el Pagador Selecciónar, como el Medio de Pago para poder aplicar una promoción
	...
	// Tipo de Transacción (Sale, Void, Return, Authorize,...) por la cual se está realizado el requerimiento (Usado en WalletRequest)
	...
	// Tiempo en segúndos que la transacción permanecera vigente
	TransactionTimeout *float32 `json:"TransactionTimeout,omitempty"`
	...
	// Monto de la transacción a ser enviada
	...
	// Identificador del Wallet Retornado por la Operación Wallets
	WalletIdentification *string `json:"WalletIdentification,omitempty"`
	...
	ValidThru *time.Time `json:"ValidThru,omitempty"`
...
func NewWalletRequestObjectWalletRequest(systemIdentification string, companyIdentification string) *WalletRequestObjectWalletRequest {
	this := WalletRequestObjectWalletRequest{}
...
// GetTransactionTimeout returns the TransactionTimeout field value if set, zero value otherwise.
func (o *WalletRequestObjectWalletRequest) GetTransactionTimeout() float32 {
	if o == nil || o.TransactionTimeout == nil {
		var ret float32
		return ret
	}
	return *o.TransactionTimeout
}

// GetTransactionTimeoutOk returns a tuple with the TransactionTimeout field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *WalletRequestObjectWalletRequest) GetTransactionTimeoutOk() (*float32, bool) {
	if o == nil || o.TransactionTimeout == nil {
		return nil, false
	}
	return o.TransactionTimeout, true
}
...
// SetTransactionTimeout gets a reference to the given float32 and assigns it to the TransactionTimeout field.
func (o *WalletRequestObjectWalletRequest) SetTransactionTimeout(v float32) {
	o.TransactionTimeout = &v
}
...
// GetWalletIdentification returns the WalletIdentification field value if set, zero value otherwise.
func (o *WalletRequestObjectWalletRequest) GetWalletIdentification() string {
	if o == nil || o.WalletIdentification == nil {
		var ret string
		return ret
	}
	return *o.WalletIdentification
}

// GetWalletIdentificationOk returns a tuple with the WalletIdentification field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *WalletRequestObjectWalletRequest) GetWalletIdentificationOk() (*string, bool) {
	if o == nil || o.WalletIdentification == nil {
		return nil, false
	}
	return o.WalletIdentification, true
}
...
// SetWalletIdentification gets a reference to the given string and assigns it to the WalletIdentification field.
func (o *WalletRequestObjectWalletRequest) SetWalletIdentification(v string) {
	o.WalletIdentification = &v
}
...
// GetValidThru returns the ValidThru field value if set, zero value otherwise.
func (o *WalletRequestObjectWalletRequest) GetValidThru() time.Time {
	if o == nil || o.ValidThru == nil {
		var ret time.Time
		return ret
	}
	return *o.ValidThru
...
// GetValidThruOk returns a tuple with the ValidThru field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *WalletRequestObjectWalletRequest) GetValidThruOk() (*time.Time, bool) {
	if o == nil || o.ValidThru == nil {
		return nil, false
	}
	return o.ValidThru, true
}
...
// SetValidThru gets a reference to the given time.Time and assigns it to the ValidThru field.
...
func (o WalletRequestObjectWalletRequest) MarshalJSON() ([]byte, error) {
	...
	if o.TransactionTimeout != nil {
		toSerialize["TransactionTimeout"] = o.TransactionTimeout
	}
	if o.POSType != nil {
	...
	if o.WalletIdentification != nil {
		toSerialize["WalletIdentification"] = o.WalletIdentification
	}
	if o.Payer != nil {
	...
	if o.ValidThru != nil {
		toSerialize["ValidThru"] = o.ValidThru
	}
...
type NullableWalletRequestObjectWalletRequest struct {
	value *WalletRequestObjectWalletRequest
	isSet bool
}

func (v NullableWalletRequestObjectWalletRequest) Get() *WalletRequestObjectWalletRequest {
	return v.value
}

func (v *NullableWalletRequestObjectWalletRequest) Set(val *WalletRequestObjectWalletRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableWalletRequestObjectWalletRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableWalletRequestObjectWalletRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWalletRequestObjectWalletRequest(val *WalletRequestObjectWalletRequest) *NullableWalletRequestObjectWalletRequest {
	return &NullableWalletRequestObjectWalletRequest{value: val, isSet: true}
}

func (v NullableWalletRequestObjectWalletRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWalletRequestObjectWalletRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
