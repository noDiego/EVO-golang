...
// ReturnObjectReturn struct for ReturnObjectReturn
type ReturnObjectReturn struct {
	...
	// Referencia de la transacción para el punto de venta. Corresponde a la transacción original que se está referenciando.
	OrigReference *string `json:"OrigReference,omitempty"`
	...
	// Identificador de Comercio o Afiliación que se usó para hacer la transacción referenciada.
	OrigMerchantID *string `json:"OrigMerchantID,omitempty"`
	// Identificador de Terminal que se usó para hacer la transacción referenciada.
	OrigTerminalID *int32 `json:"OrigTerminalID,omitempty"`
...
// GetOrigReference returns the OrigReference field value if set, zero value otherwise.
func (o *ReturnObjectReturn) GetOrigReference() string {
	if o == nil || o.OrigReference == nil {
		var ret string
		return ret
	}
	return *o.OrigReference
}

// GetOrigReferenceOk returns a tuple with the OrigReference field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ReturnObjectReturn) GetOrigReferenceOk() (*string, bool) {
	if o == nil || o.OrigReference == nil {
		return nil, false
	}
	return o.OrigReference, true
}
...
// SetOrigReference gets a reference to the given string and assigns it to the OrigReference field.
...
// GetOrigMerchantID returns the OrigMerchantID field value if set, zero value otherwise.
func (o *ReturnObjectReturn) GetOrigMerchantID() string {
	if o == nil || o.OrigMerchantID == nil {
		var ret string
		return ret
	}
	return *o.OrigMerchantID
}

// GetOrigMerchantIDOk returns a tuple with the OrigMerchantID field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ReturnObjectReturn) GetOrigMerchantIDOk() (*string, bool) {
	if o == nil || o.OrigMerchantID == nil {
		return nil, false
	}
	return o.OrigMerchantID, true
}
...
// SetOrigMerchantID gets a reference to the given string and assigns it to the OrigMerchantID field.
func (o *ReturnObjectReturn) SetOrigMerchantID(v string) {
	o.OrigMerchantID = &v
}

// GetOrigTerminalID returns the OrigTerminalID field value if set, zero value otherwise.
func (o *ReturnObjectReturn) GetOrigTerminalID() int32 {
	if o == nil || o.OrigTerminalID == nil {
		var ret int32
		return ret
	}
	return *o.OrigTerminalID
}

// GetOrigTerminalIDOk returns a tuple with the OrigTerminalID field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ReturnObjectReturn) GetOrigTerminalIDOk() (*int32, bool) {
	if o == nil || o.OrigTerminalID == nil {
		return nil, false
	}
	return o.OrigTerminalID, true
}
...
// SetOrigTerminalID gets a reference to the given int32 and assigns it to the OrigTerminalID field.
...
func (o ReturnObjectReturn) MarshalJSON() ([]byte, error) {
	...
	if o.OrigReference != nil {
		toSerialize["OrigReference"] = o.OrigReference
	}
	...
	if o.OrigMerchantID != nil {
		toSerialize["OrigMerchantID"] = o.OrigMerchantID
	}
	if o.OrigTerminalID != nil {
		toSerialize["OrigTerminalID"] = o.OrigTerminalID
	}
...
type NullableReturnObjectReturn struct {
	value *ReturnObjectReturn
	isSet bool
}

func (v NullableReturnObjectReturn) Get() *ReturnObjectReturn {
	return v.value
}

func (v *NullableReturnObjectReturn) Set(val *ReturnObjectReturn) {
	v.value = val
	v.isSet = true
}

func (v NullableReturnObjectReturn) IsSet() bool {
	return v.isSet
}

func (v *NullableReturnObjectReturn) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReturnObjectReturn(val *ReturnObjectReturn) *NullableReturnObjectReturn {
	return &NullableReturnObjectReturn{value: val, isSet: true}
}

func (v NullableReturnObjectReturn) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReturnObjectReturn) UnmarshalJSON(src []byte) error {
	v.isSet = true
