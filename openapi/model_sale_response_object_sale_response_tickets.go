...
// SaleResponseObjectSaleResponseTickets struct for SaleResponseObjectSaleResponseTickets
type SaleResponseObjectSaleResponseTickets struct {
	// Tipo de Ticket
	Type *string `json:"Type,omitempty"`
	// Acción a ejecutar para cada Ticket por el punto de venta
	Action []string `json:"Action,omitempty"`
	DeviceAction []string `json:"DeviceAction,omitempty"`
	// Acción que ejecutó la plataforma para los tickets
	ExecutedAction []string `json:"ExecutedAction,omitempty"`
	// Formato del Ticket a Imprimir
	Layout []SaleResponseObjectSaleResponseLayout `json:"Layout,omitempty"`
}
...
func NewSaleResponseObjectSaleResponseTickets() *SaleResponseObjectSaleResponseTickets {
	this := SaleResponseObjectSaleResponseTickets{}
	return &this
}
...
// GetDeviceAction returns the DeviceAction field value if set, zero value otherwise.
func (o *SaleResponseObjectSaleResponseTickets) GetDeviceAction() []string {
	if o == nil || o.DeviceAction == nil {
		var ret []string
		return ret
	}
	return o.DeviceAction
}

// GetDeviceActionOk returns a tuple with the DeviceAction field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SaleResponseObjectSaleResponseTickets) GetDeviceActionOk() ([]string, bool) {
	if o == nil || o.DeviceAction == nil {
		return nil, false
	}
	return o.DeviceAction, true
}
...
// SetDeviceAction gets a reference to the given []string and assigns it to the DeviceAction field.
func (o *SaleResponseObjectSaleResponseTickets) SetDeviceAction(v []string) {
	o.DeviceAction = v
}

// GetExecutedAction returns the ExecutedAction field value if set, zero value otherwise.
func (o *SaleResponseObjectSaleResponseTickets) GetExecutedAction() []string {
	if o == nil || o.ExecutedAction == nil {
		var ret []string
		return ret
	}
	return o.ExecutedAction
}

// GetExecutedActionOk returns a tuple with the ExecutedAction field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SaleResponseObjectSaleResponseTickets) GetExecutedActionOk() ([]string, bool) {
	if o == nil || o.ExecutedAction == nil {
		return nil, false
	}
	return o.ExecutedAction, true
}
...
// SetExecutedAction gets a reference to the given []string and assigns it to the ExecutedAction field.
...
func (o *SaleResponseObjectSaleResponseTickets) GetLayout() []SaleResponseObjectSaleResponseLayout {
	if o == nil || o.Layout == nil {
		var ret []SaleResponseObjectSaleResponseLayout
		return ret
	}
	return o.Layout
}
...
// SetLayout gets a reference to the given []SaleResponseObjectSaleResponseLayout and assigns it to the Layout field.
func (o *SaleResponseObjectSaleResponseTickets) SetLayout(v []SaleResponseObjectSaleResponseLayout) {
	o.Layout = v
}

func (o SaleResponseObjectSaleResponseTickets) MarshalJSON() ([]byte, error) {
	...
	if o.DeviceAction != nil {
		toSerialize["DeviceAction"] = o.DeviceAction
	}
	if o.ExecutedAction != nil {
		toSerialize["ExecutedAction"] = o.ExecutedAction
	}
	if o.Layout != nil {
...
type NullableSaleResponseObjectSaleResponseTickets struct {
	value *SaleResponseObjectSaleResponseTickets
	isSet bool
}

func (v NullableSaleResponseObjectSaleResponseTickets) Get() *SaleResponseObjectSaleResponseTickets {
	return v.value
}

func (v *NullableSaleResponseObjectSaleResponseTickets) Set(val *SaleResponseObjectSaleResponseTickets) {
	v.value = val
	v.isSet = true
}

func (v NullableSaleResponseObjectSaleResponseTickets) IsSet() bool {
	return v.isSet
}

func (v *NullableSaleResponseObjectSaleResponseTickets) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSaleResponseObjectSaleResponseTickets(val *SaleResponseObjectSaleResponseTickets) *NullableSaleResponseObjectSaleResponseTickets {
	return &NullableSaleResponseObjectSaleResponseTickets{value: val, isSet: true}
}

func (v NullableSaleResponseObjectSaleResponseTickets) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSaleResponseObjectSaleResponseTickets) UnmarshalJSON(src []byte) error {
	v.isSet = true
