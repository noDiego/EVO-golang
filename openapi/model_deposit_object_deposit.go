...
// DepositObjectDeposit struct for DepositObjectDeposit
type DepositObjectDeposit struct {
...
func (o DepositObjectDeposit) MarshalJSON() ([]byte, error) {
...
type NullableDepositObjectDeposit struct {
	value *DepositObjectDeposit
	isSet bool
}

func (v NullableDepositObjectDeposit) Get() *DepositObjectDeposit {
	return v.value
}

func (v *NullableDepositObjectDeposit) Set(val *DepositObjectDeposit) {
	v.value = val
	v.isSet = true
}

func (v NullableDepositObjectDeposit) IsSet() bool {
	return v.isSet
}

func (v *NullableDepositObjectDeposit) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDepositObjectDeposit(val *DepositObjectDeposit) *NullableDepositObjectDeposit {
	return &NullableDepositObjectDeposit{value: val, isSet: true}
}

func (v NullableDepositObjectDeposit) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDepositObjectDeposit) UnmarshalJSON(src []byte) error {
	v.isSet = true
