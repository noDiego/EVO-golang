...
// WalletsResponseObjectWalletsResponseWallets struct for WalletsResponseObjectWalletsResponseWallets
type WalletsResponseObjectWalletsResponseWallets struct {
	// Identificador o código de la Billetera o Wallet
	Identification *string `json:"Identification,omitempty"`
	// Nombre del Wallet
	Name *string `json:"Name,omitempty"`
	// Etiqueta a Mostrar para el Wallet
	Label *string `json:"Label,omitempty"`
	// Nombre de la Imagen o Logo o la imagen codificado en base64
	Image *string `json:"Image,omitempty"`
	// Nombre de la Imagen o Logo o la imagen codificado en base64
	LargeImage *string `json:"LargeImage,omitempty"`
	// Nombre de la Imagen o Logo o la imagen codificado en base64
	SmallImage *string `json:"SmallImage,omitempty"`
	// ID externo de este metodo de pago, utilizado por el punto de venta para reconocer al medio de pago en su base de datos
	ForeignIdentifier *string `json:"ForeignIdentifier,omitempty"`
	// Indica de las Operaciones Financieras son AutoConfirmadas para este Wallet
	AutoConfirm *bool `json:"AutoConfirm,omitempty"`
	// Indica si dicho Wallet Soporta la cancelación del Requerimiento
	SupportRequestCancel *bool `json:"SupportRequestCancel,omitempty"`
	// Indica si dicho Wallet Soporta la en el envio de Requerimiento de Pago el tiempo de Vida del Requerimiento de Pagos usando el Elemento TransactionTimeout
	SupportValidityOfTheRequest *bool `json:"SupportValidityOfTheRequest,omitempty"`
	// Especifica el tipo las Canlelaciones/Anulaciones son soportadas
	VoidSupport *string `json:"VoidSupport,omitempty"`
	// Indica si para Cancelar/Anular una transacción es requerida nuevamente la interacción contra el Wallet
	WalletUseInVoidTransaction *bool `json:"WalletUseInVoidTransaction,omitempty"`
	// Especifica el tipo las Devoluciones son soportadas y de que tipo
	ReturnSupport *string `json:"ReturnSupport,omitempty"`
	// Indica si para Devolver una transacción es requerida nuevamente la interacción contra el Wallet
	WalletUseInReturnTransaction *bool `json:"WalletUseInReturnTransaction,omitempty"`
	// Indica Si el importe a cobrar debe enviarse en la Operación WalletRequest
	AmountRequired *bool `json:"AmountRequired,omitempty"`
	// Indica el Tipo de Token
	TokenType *string `json:"TokenType,omitempty"`
	// Tiempo por omision en caso de que no sea retornaro en la respuesta de la operación WalletRequest expresado en milisegúndos
	DefaultRetryTime *int32 `json:"DefaultRetryTime,omitempty"`
}
...
func NewWalletsResponseObjectWalletsResponseWallets() *WalletsResponseObjectWalletsResponseWallets {
	this := WalletsResponseObjectWalletsResponseWallets{}
	return &this
}
...
// GetLargeImage returns the LargeImage field value if set, zero value otherwise.
func (o *WalletsResponseObjectWalletsResponseWallets) GetLargeImage() string {
	if o == nil || o.LargeImage == nil {
		var ret string
		return ret
	}
	return *o.LargeImage
...
// GetLargeImageOk returns a tuple with the LargeImage field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *WalletsResponseObjectWalletsResponseWallets) GetLargeImageOk() (*string, bool) {
	if o == nil || o.LargeImage == nil {
		return nil, false
	}
	return o.LargeImage, true
}
...
// SetLargeImage gets a reference to the given string and assigns it to the LargeImage field.
func (o *WalletsResponseObjectWalletsResponseWallets) SetLargeImage(v string) {
	o.LargeImage = &v
}

// GetSmallImage returns the SmallImage field value if set, zero value otherwise.
func (o *WalletsResponseObjectWalletsResponseWallets) GetSmallImage() string {
	if o == nil || o.SmallImage == nil {
		var ret string
		return ret
	}
	return *o.SmallImage
...
// GetSmallImageOk returns a tuple with the SmallImage field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *WalletsResponseObjectWalletsResponseWallets) GetSmallImageOk() (*string, bool) {
	if o == nil || o.SmallImage == nil {
		return nil, false
	}
	return o.SmallImage, true
}
...
// SetSmallImage gets a reference to the given string and assigns it to the SmallImage field.
...
// GetSupportRequestCancel returns the SupportRequestCancel field value if set, zero value otherwise.
func (o *WalletsResponseObjectWalletsResponseWallets) GetSupportRequestCancel() bool {
	if o == nil || o.SupportRequestCancel == nil {
		var ret bool
		return ret
	}
	return *o.SupportRequestCancel
}

// GetSupportRequestCancelOk returns a tuple with the SupportRequestCancel field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *WalletsResponseObjectWalletsResponseWallets) GetSupportRequestCancelOk() (*bool, bool) {
	if o == nil || o.SupportRequestCancel == nil {
		return nil, false
	}
	return o.SupportRequestCancel, true
}
...
// SetSupportRequestCancel gets a reference to the given bool and assigns it to the SupportRequestCancel field.
func (o *WalletsResponseObjectWalletsResponseWallets) SetSupportRequestCancel(v bool) {
	o.SupportRequestCancel = &v
}

// GetSupportValidityOfTheRequest returns the SupportValidityOfTheRequest field value if set, zero value otherwise.
func (o *WalletsResponseObjectWalletsResponseWallets) GetSupportValidityOfTheRequest() bool {
	if o == nil || o.SupportValidityOfTheRequest == nil {
		var ret bool
		return ret
	}
	return *o.SupportValidityOfTheRequest
}

// GetSupportValidityOfTheRequestOk returns a tuple with the SupportValidityOfTheRequest field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *WalletsResponseObjectWalletsResponseWallets) GetSupportValidityOfTheRequestOk() (*bool, bool) {
	if o == nil || o.SupportValidityOfTheRequest == nil {
		return nil, false
	}
	return o.SupportValidityOfTheRequest, true
}
...
// SetSupportValidityOfTheRequest gets a reference to the given bool and assigns it to the SupportValidityOfTheRequest field.
func (o *WalletsResponseObjectWalletsResponseWallets) SetSupportValidityOfTheRequest(v bool) {
	o.SupportValidityOfTheRequest = &v
}

// GetVoidSupport returns the VoidSupport field value if set, zero value otherwise.
func (o *WalletsResponseObjectWalletsResponseWallets) GetVoidSupport() string {
	if o == nil || o.VoidSupport == nil {
		var ret string
		return ret
	}
	return *o.VoidSupport
}

// GetVoidSupportOk returns a tuple with the VoidSupport field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *WalletsResponseObjectWalletsResponseWallets) GetVoidSupportOk() (*string, bool) {
	if o == nil || o.VoidSupport == nil {
		return nil, false
	}
	return o.VoidSupport, true
}
...
// SetVoidSupport gets a reference to the given string and assigns it to the VoidSupport field.
func (o *WalletsResponseObjectWalletsResponseWallets) SetVoidSupport(v string) {
	o.VoidSupport = &v
}

// GetWalletUseInVoidTransaction returns the WalletUseInVoidTransaction field value if set, zero value otherwise.
func (o *WalletsResponseObjectWalletsResponseWallets) GetWalletUseInVoidTransaction() bool {
	if o == nil || o.WalletUseInVoidTransaction == nil {
		var ret bool
		return ret
	}
	return *o.WalletUseInVoidTransaction
}

// GetWalletUseInVoidTransactionOk returns a tuple with the WalletUseInVoidTransaction field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *WalletsResponseObjectWalletsResponseWallets) GetWalletUseInVoidTransactionOk() (*bool, bool) {
	if o == nil || o.WalletUseInVoidTransaction == nil {
		return nil, false
	}
	return o.WalletUseInVoidTransaction, true
}
...
// SetWalletUseInVoidTransaction gets a reference to the given bool and assigns it to the WalletUseInVoidTransaction field.
func (o *WalletsResponseObjectWalletsResponseWallets) SetWalletUseInVoidTransaction(v bool) {
	o.WalletUseInVoidTransaction = &v
}

// GetReturnSupport returns the ReturnSupport field value if set, zero value otherwise.
func (o *WalletsResponseObjectWalletsResponseWallets) GetReturnSupport() string {
	if o == nil || o.ReturnSupport == nil {
		var ret string
		return ret
	}
	return *o.ReturnSupport
}

// GetReturnSupportOk returns a tuple with the ReturnSupport field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *WalletsResponseObjectWalletsResponseWallets) GetReturnSupportOk() (*string, bool) {
	if o == nil || o.ReturnSupport == nil {
		return nil, false
	}
	return o.ReturnSupport, true
}
...
// SetReturnSupport gets a reference to the given string and assigns it to the ReturnSupport field.
func (o *WalletsResponseObjectWalletsResponseWallets) SetReturnSupport(v string) {
	o.ReturnSupport = &v
}

// GetWalletUseInReturnTransaction returns the WalletUseInReturnTransaction field value if set, zero value otherwise.
func (o *WalletsResponseObjectWalletsResponseWallets) GetWalletUseInReturnTransaction() bool {
	if o == nil || o.WalletUseInReturnTransaction == nil {
		var ret bool
		return ret
	}
	return *o.WalletUseInReturnTransaction
}

// GetWalletUseInReturnTransactionOk returns a tuple with the WalletUseInReturnTransaction field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *WalletsResponseObjectWalletsResponseWallets) GetWalletUseInReturnTransactionOk() (*bool, bool) {
	if o == nil || o.WalletUseInReturnTransaction == nil {
		return nil, false
	}
	return o.WalletUseInReturnTransaction, true
}
...
// SetWalletUseInReturnTransaction gets a reference to the given bool and assigns it to the WalletUseInReturnTransaction field.
func (o *WalletsResponseObjectWalletsResponseWallets) SetWalletUseInReturnTransaction(v bool) {
	o.WalletUseInReturnTransaction = &v
}
...
// SetAmountRequired gets a reference to the given bool and assigns it to the AmountRequired field.
...
// GetDefaultRetryTime returns the DefaultRetryTime field value if set, zero value otherwise.
func (o *WalletsResponseObjectWalletsResponseWallets) GetDefaultRetryTime() int32 {
	if o == nil || o.DefaultRetryTime == nil {
		var ret int32
		return ret
	}
	return *o.DefaultRetryTime
}

// GetDefaultRetryTimeOk returns a tuple with the DefaultRetryTime field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *WalletsResponseObjectWalletsResponseWallets) GetDefaultRetryTimeOk() (*int32, bool) {
	if o == nil || o.DefaultRetryTime == nil {
		return nil, false
	}
	return o.DefaultRetryTime, true
}
...
// SetDefaultRetryTime gets a reference to the given int32 and assigns it to the DefaultRetryTime field.
func (o *WalletsResponseObjectWalletsResponseWallets) SetDefaultRetryTime(v int32) {
	o.DefaultRetryTime = &v
}

func (o WalletsResponseObjectWalletsResponseWallets) MarshalJSON() ([]byte, error) {
	...
	if o.LargeImage != nil {
		toSerialize["LargeImage"] = o.LargeImage
	}
	if o.SmallImage != nil {
		toSerialize["SmallImage"] = o.SmallImage
	}
	if o.ForeignIdentifier != nil {
		toSerialize["ForeignIdentifier"] = o.ForeignIdentifier
	}
	if o.AutoConfirm != nil {
		toSerialize["AutoConfirm"] = o.AutoConfirm
	}
	if o.SupportRequestCancel != nil {
		toSerialize["SupportRequestCancel"] = o.SupportRequestCancel
	}
	if o.SupportValidityOfTheRequest != nil {
		toSerialize["SupportValidityOfTheRequest"] = o.SupportValidityOfTheRequest
	}
	if o.VoidSupport != nil {
		toSerialize["VoidSupport"] = o.VoidSupport
	}
	if o.WalletUseInVoidTransaction != nil {
		toSerialize["WalletUseInVoidTransaction"] = o.WalletUseInVoidTransaction
	}
	if o.ReturnSupport != nil {
		toSerialize["ReturnSupport"] = o.ReturnSupport
	}
	if o.WalletUseInReturnTransaction != nil {
		toSerialize["WalletUseInReturnTransaction"] = o.WalletUseInReturnTransaction
	}
	if o.AmountRequired != nil {
		toSerialize["AmountRequired"] = o.AmountRequired
	}
	if o.TokenType != nil {
		toSerialize["TokenType"] = o.TokenType
	}
	if o.DefaultRetryTime != nil {
		toSerialize["DefaultRetryTime"] = o.DefaultRetryTime
	}
	return json.Marshal(toSerialize)
}

type NullableWalletsResponseObjectWalletsResponseWallets struct {
	value *WalletsResponseObjectWalletsResponseWallets
	isSet bool
}

func (v NullableWalletsResponseObjectWalletsResponseWallets) Get() *WalletsResponseObjectWalletsResponseWallets {
	return v.value
}

func (v *NullableWalletsResponseObjectWalletsResponseWallets) Set(val *WalletsResponseObjectWalletsResponseWallets) {
	v.value = val
	v.isSet = true
}

func (v NullableWalletsResponseObjectWalletsResponseWallets) IsSet() bool {
	return v.isSet
}

func (v *NullableWalletsResponseObjectWalletsResponseWallets) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWalletsResponseObjectWalletsResponseWallets(val *WalletsResponseObjectWalletsResponseWallets) *NullableWalletsResponseObjectWalletsResponseWallets {
	return &NullableWalletsResponseObjectWalletsResponseWallets{value: val, isSet: true}
}

func (v NullableWalletsResponseObjectWalletsResponseWallets) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWalletsResponseObjectWalletsResponseWallets) UnmarshalJSON(src []byte) error {
	v.isSet = true
