...
// EnrollmentObjectEnrollmentRecurrence struct for EnrollmentObjectEnrollmentRecurrence
type EnrollmentObjectEnrollmentRecurrence struct {
	// Tipo de intervalo. 0 - SEMANAL; 1 - MENSUAL; 2 - ANUAL
	IntervalType *string `json:"IntervalType,omitempty"`
	// Cantidad de pagos a realizar.
	IntervalValue *int32 `json:"IntervalValue,omitempty"`
	// Cantidad de recurrencias.
...
func NewEnrollmentObjectEnrollmentRecurrence() *EnrollmentObjectEnrollmentRecurrence {
	this := EnrollmentObjectEnrollmentRecurrence{}
	return &this
}
...
// GetIntervalValue returns the IntervalValue field value if set, zero value otherwise.
func (o *EnrollmentObjectEnrollmentRecurrence) GetIntervalValue() int32 {
	if o == nil || o.IntervalValue == nil {
		var ret int32
		return ret
	}
	return *o.IntervalValue
}

// GetIntervalValueOk returns a tuple with the IntervalValue field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *EnrollmentObjectEnrollmentRecurrence) GetIntervalValueOk() (*int32, bool) {
	if o == nil || o.IntervalValue == nil {
		return nil, false
	}
	return o.IntervalValue, true
}
...
// SetIntervalValue gets a reference to the given int32 and assigns it to the IntervalValue field.
func (o *EnrollmentObjectEnrollmentRecurrence) SetIntervalValue(v int32) {
	o.IntervalValue = &v
}

// GetNumberOfRecurrences returns the NumberOfRecurrences field value if set, zero value otherwise.
func (o *EnrollmentObjectEnrollmentRecurrence) GetNumberOfRecurrences() string {
	if o == nil || o.NumberOfRecurrences == nil {
		var ret string
		return ret
	}
	return *o.NumberOfRecurrences
}

// GetNumberOfRecurrencesOk returns a tuple with the NumberOfRecurrences field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *EnrollmentObjectEnrollmentRecurrence) GetNumberOfRecurrencesOk() (*string, bool) {
	if o == nil || o.NumberOfRecurrences == nil {
		return nil, false
	}
	return o.NumberOfRecurrences, true
}
...
// SetNumberOfRecurrences gets a reference to the given string and assigns it to the NumberOfRecurrences field.
func (o *EnrollmentObjectEnrollmentRecurrence) SetNumberOfRecurrences(v string) {
	o.NumberOfRecurrences = &v
}

func (o EnrollmentObjectEnrollmentRecurrence) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if o.IntervalType != nil {
		toSerialize["IntervalType"] = o.IntervalType
	}
	if o.IntervalValue != nil {
		toSerialize["IntervalValue"] = o.IntervalValue
	}
	if o.NumberOfRecurrences != nil {
		toSerialize["NumberOfRecurrences"] = o.NumberOfRecurrences
	}
	return json.Marshal(toSerialize)
}

type NullableEnrollmentObjectEnrollmentRecurrence struct {
	value *EnrollmentObjectEnrollmentRecurrence
	isSet bool
}

func (v NullableEnrollmentObjectEnrollmentRecurrence) Get() *EnrollmentObjectEnrollmentRecurrence {
	return v.value
}

func (v *NullableEnrollmentObjectEnrollmentRecurrence) Set(val *EnrollmentObjectEnrollmentRecurrence) {
	v.value = val
	v.isSet = true
}

func (v NullableEnrollmentObjectEnrollmentRecurrence) IsSet() bool {
	return v.isSet
}

func (v *NullableEnrollmentObjectEnrollmentRecurrence) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEnrollmentObjectEnrollmentRecurrence(val *EnrollmentObjectEnrollmentRecurrence) *NullableEnrollmentObjectEnrollmentRecurrence {
	return &NullableEnrollmentObjectEnrollmentRecurrence{value: val, isSet: true}
}

func (v NullableEnrollmentObjectEnrollmentRecurrence) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEnrollmentObjectEnrollmentRecurrence) UnmarshalJSON(src []byte) error {
	v.isSet = true
