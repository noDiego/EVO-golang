...
// KeysRenewalObjectKeysRenewal struct for KeysRenewalObjectKeysRenewal
type KeysRenewalObjectKeysRenewal struct {
	...
	// Retornado en todas las respuesta que el POS/PINPAD debe enviar en el próximo requerimiento. En caso de que el POS no lo envíe, envíe vacío o con un valor que no corresponde se produce “La Ruptura de Secuencia” y la plataforma, si la última transacción que realizó el POS no está confirmada y está aprobada, genera una reversa de la misma.
...
func NewKeysRenewalObjectKeysRenewal(companyIdentification string, systemIdentification string) *KeysRenewalObjectKeysRenewal {
	this := KeysRenewalObjectKeysRenewal{}
...
func (o KeysRenewalObjectKeysRenewal) MarshalJSON() ([]byte, error) {
...
type NullableKeysRenewalObjectKeysRenewal struct {
	value *KeysRenewalObjectKeysRenewal
	isSet bool
}

func (v NullableKeysRenewalObjectKeysRenewal) Get() *KeysRenewalObjectKeysRenewal {
	return v.value
}

func (v *NullableKeysRenewalObjectKeysRenewal) Set(val *KeysRenewalObjectKeysRenewal) {
	v.value = val
	v.isSet = true
}

func (v NullableKeysRenewalObjectKeysRenewal) IsSet() bool {
	return v.isSet
}

func (v *NullableKeysRenewalObjectKeysRenewal) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableKeysRenewalObjectKeysRenewal(val *KeysRenewalObjectKeysRenewal) *NullableKeysRenewalObjectKeysRenewal {
	return &NullableKeysRenewalObjectKeysRenewal{value: val, isSet: true}
}

func (v NullableKeysRenewalObjectKeysRenewal) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableKeysRenewalObjectKeysRenewal) UnmarshalJSON(src []byte) error {
	v.isSet = true
