...
// OrderGetObjectOrderGet struct for OrderGetObjectOrderGet
type OrderGetObjectOrderGet struct {
	// .
...
// GetInitialToken returns the InitialToken field value
...
// GetInitialTokenOk returns a tuple with the InitialToken field value
...
// SetInitialToken sets field value
...
func (o OrderGetObjectOrderGet) MarshalJSON() ([]byte, error) {
...
type NullableOrderGetObjectOrderGet struct {
	value *OrderGetObjectOrderGet
	isSet bool
}

func (v NullableOrderGetObjectOrderGet) Get() *OrderGetObjectOrderGet {
	return v.value
}

func (v *NullableOrderGetObjectOrderGet) Set(val *OrderGetObjectOrderGet) {
	v.value = val
	v.isSet = true
}

func (v NullableOrderGetObjectOrderGet) IsSet() bool {
	return v.isSet
}

func (v *NullableOrderGetObjectOrderGet) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrderGetObjectOrderGet(val *OrderGetObjectOrderGet) *NullableOrderGetObjectOrderGet {
	return &NullableOrderGetObjectOrderGet{value: val, isSet: true}
}

func (v NullableOrderGetObjectOrderGet) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOrderGetObjectOrderGet) UnmarshalJSON(src []byte) error {
	v.isSet = true
