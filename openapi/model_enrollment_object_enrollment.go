...
// EnrollmentObjectEnrollment struct for EnrollmentObjectEnrollment
type EnrollmentObjectEnrollment struct {
	...
	// Información de pagos recurrentes
	Recurrence []EnrollmentObjectEnrollmentRecurrence `json:"Recurrence,omitempty"`
...
func NewEnrollmentObjectEnrollment(companyIdentification string, systemIdentification string) *EnrollmentObjectEnrollment {
	this := EnrollmentObjectEnrollment{}
...
func (o *EnrollmentObjectEnrollment) GetRecurrence() []EnrollmentObjectEnrollmentRecurrence {
	if o == nil || o.Recurrence == nil {
		var ret []EnrollmentObjectEnrollmentRecurrence
		return ret
	}
	return o.Recurrence
}
...
// SetRecurrence gets a reference to the given []EnrollmentObjectEnrollmentRecurrence and assigns it to the Recurrence field.
...
func (o EnrollmentObjectEnrollment) MarshalJSON() ([]byte, error) {
...
type NullableEnrollmentObjectEnrollment struct {
	value *EnrollmentObjectEnrollment
	isSet bool
}

func (v NullableEnrollmentObjectEnrollment) Get() *EnrollmentObjectEnrollment {
	return v.value
}

func (v *NullableEnrollmentObjectEnrollment) Set(val *EnrollmentObjectEnrollment) {
	v.value = val
	v.isSet = true
}

func (v NullableEnrollmentObjectEnrollment) IsSet() bool {
	return v.isSet
}

func (v *NullableEnrollmentObjectEnrollment) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEnrollmentObjectEnrollment(val *EnrollmentObjectEnrollment) *NullableEnrollmentObjectEnrollment {
	return &NullableEnrollmentObjectEnrollment{value: val, isSet: true}
}

func (v NullableEnrollmentObjectEnrollment) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEnrollmentObjectEnrollment) UnmarshalJSON(src []byte) error {
	v.isSet = true
