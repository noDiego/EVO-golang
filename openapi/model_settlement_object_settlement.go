...
// SettlementObjectSettlement struct for SettlementObjectSettlement
type SettlementObjectSettlement struct {
...
func NewSettlementObjectSettlement(companyIdentification string, systemIdentification string) *SettlementObjectSettlement {
	this := SettlementObjectSettlement{}
...
func (o SettlementObjectSettlement) MarshalJSON() ([]byte, error) {
...
type NullableSettlementObjectSettlement struct {
	value *SettlementObjectSettlement
	isSet bool
}

func (v NullableSettlementObjectSettlement) Get() *SettlementObjectSettlement {
	return v.value
}

func (v *NullableSettlementObjectSettlement) Set(val *SettlementObjectSettlement) {
	v.value = val
	v.isSet = true
}

func (v NullableSettlementObjectSettlement) IsSet() bool {
	return v.isSet
}

func (v *NullableSettlementObjectSettlement) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSettlementObjectSettlement(val *SettlementObjectSettlement) *NullableSettlementObjectSettlement {
	return &NullableSettlementObjectSettlement{value: val, isSet: true}
}

func (v NullableSettlementObjectSettlement) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSettlementObjectSettlement) UnmarshalJSON(src []byte) error {
	v.isSet = true
