...
// SaleResponseObjectSaleResponseProducts struct for SaleResponseObjectSaleResponseProducts
type SaleResponseObjectSaleResponseProducts struct {
...
func NewSaleResponseObjectSaleResponseProducts() *SaleResponseObjectSaleResponseProducts {
	this := SaleResponseObjectSaleResponseProducts{}
	return &this
}
...
func (o SaleResponseObjectSaleResponseProducts) MarshalJSON() ([]byte, error) {
...
type NullableSaleResponseObjectSaleResponseProducts struct {
	value *SaleResponseObjectSaleResponseProducts
	isSet bool
}

func (v NullableSaleResponseObjectSaleResponseProducts) Get() *SaleResponseObjectSaleResponseProducts {
	return v.value
}

func (v *NullableSaleResponseObjectSaleResponseProducts) Set(val *SaleResponseObjectSaleResponseProducts) {
	v.value = val
	v.isSet = true
}

func (v NullableSaleResponseObjectSaleResponseProducts) IsSet() bool {
	return v.isSet
}

func (v *NullableSaleResponseObjectSaleResponseProducts) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSaleResponseObjectSaleResponseProducts(val *SaleResponseObjectSaleResponseProducts) *NullableSaleResponseObjectSaleResponseProducts {
	return &NullableSaleResponseObjectSaleResponseProducts{value: val, isSet: true}
}

func (v NullableSaleResponseObjectSaleResponseProducts) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSaleResponseObjectSaleResponseProducts) UnmarshalJSON(src []byte) error {
	v.isSet = true
