...
// BlockCancelObjectBlockCancel struct for BlockCancelObjectBlockCancel
type BlockCancelObjectBlockCancel struct {
	...
	ReadingDeviceType interface{} `json:"ReadingDeviceType,omitempty"`
...
func NewBlockCancelObjectBlockCancel(companyIdentification string, systemIdentification string, block string) *BlockCancelObjectBlockCancel {
	this := BlockCancelObjectBlockCancel{}
...
// GetReadingDeviceType returns the ReadingDeviceType field value if set, zero value otherwise (both if not set or set to explicit null).
...
// SetReadingDeviceType gets a reference to the given interface{} and assigns it to the ReadingDeviceType field.
...
func (o BlockCancelObjectBlockCancel) MarshalJSON() ([]byte, error) {
...
type NullableBlockCancelObjectBlockCancel struct {
	value *BlockCancelObjectBlockCancel
	isSet bool
}

func (v NullableBlockCancelObjectBlockCancel) Get() *BlockCancelObjectBlockCancel {
	return v.value
}

func (v *NullableBlockCancelObjectBlockCancel) Set(val *BlockCancelObjectBlockCancel) {
	v.value = val
	v.isSet = true
}

func (v NullableBlockCancelObjectBlockCancel) IsSet() bool {
	return v.isSet
}

func (v *NullableBlockCancelObjectBlockCancel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBlockCancelObjectBlockCancel(val *BlockCancelObjectBlockCancel) *NullableBlockCancelObjectBlockCancel {
	return &NullableBlockCancelObjectBlockCancel{value: val, isSet: true}
}

func (v NullableBlockCancelObjectBlockCancel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBlockCancelObjectBlockCancel) UnmarshalJSON(src []byte) error {
	v.isSet = true
