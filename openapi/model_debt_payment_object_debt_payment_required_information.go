...
// DebtPaymentObjectDebtPaymentRequiredInformation struct for DebtPaymentObjectDebtPaymentRequiredInformation
type DebtPaymentObjectDebtPaymentRequiredInformation struct {
	// Nombre del dato a solicitar.
	Name *string `json:"Name,omitempty"`
	// Tipo de dato a solicitar.
	Type *string `json:"Type,omitempty"`
	// Este elemento se le solicita al POS o el dispositivo de venta/ReadingDevice.  En caso de que se requiera RequieredInformation y no esté definida esta propiedad  se debe asumir que es para el POS.
	InterpretFor *string `json:"InterpretFor,omitempty"`
	// Indicador si el elemento esta documentado/definido en el contrato, en caso de true, entonces solo se informará el Name y opcionalmente Mandatory, ya que todos los otros atributos del mismo, pero si fuese false entonces estarán presentes los otros atributos. Con respecto a cómo deben ser enviados, si está ya definido en el contrato deberá ser enviado como el contrato lo especifica. En caso contrario deberá ser enviado como un objeto compuesto del array de objetos en el elemento RequiredInformation.
	ItIsDefined *bool `json:"ItIsDefined,omitempty"`
	// Tipo de elemento a utilizar para su representación en la Interfaz de Usuario ( Button, etc ).
	UIType *string `json:"UIType,omitempty"`
	// Atributos de Forma, font, color, etc necesarios por el aplicativo.
	UIAttributes *string `json:"UIAttributes,omitempty"`
	// Valor del Elemento Adicional Solicitado.
	Value *string `json:"Value,omitempty"`
	// Leyenda a mostrar en pantalla para el dato a solicitar.
	Label *string `json:"Label,omitempty"`
	// Longitud mínima del dato a solicitar.
	MinLength *int32 `json:"MinLength,omitempty"`
	// Longitud máxima del dato a solicitar.
	MaxLength *int32 `json:"MaxLength,omitempty"`
	// Indica el tipo de Expresión de Validación.
	ValidationExpressionType *string `json:"ValidationExpressionType,omitempty"`
	// Expresión de Validación.
	ValidationExpression *string `json:"ValidationExpression,omitempty"`
	// Indicador de obligatoriedad de ingreso de este dato.
	Mandatory *bool `json:"Mandatory,omitempty"`
}

// NewDebtPaymentObjectDebtPaymentRequiredInformation instantiates a new DebtPaymentObjectDebtPaymentRequiredInformation object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewDebtPaymentObjectDebtPaymentRequiredInformation() *DebtPaymentObjectDebtPaymentRequiredInformation {
	this := DebtPaymentObjectDebtPaymentRequiredInformation{}
	return &this
}

// NewDebtPaymentObjectDebtPaymentRequiredInformationWithDefaults instantiates a new DebtPaymentObjectDebtPaymentRequiredInformation object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewDebtPaymentObjectDebtPaymentRequiredInformationWithDefaults() *DebtPaymentObjectDebtPaymentRequiredInformation {
	this := DebtPaymentObjectDebtPaymentRequiredInformation{}
	return &this
}
...
// GetInterpretFor returns the InterpretFor field value if set, zero value otherwise.
func (o *DebtPaymentObjectDebtPaymentRequiredInformation) GetInterpretFor() string {
	if o == nil || o.InterpretFor == nil {
		var ret string
		return ret
	}
	return *o.InterpretFor
}

// GetInterpretForOk returns a tuple with the InterpretFor field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DebtPaymentObjectDebtPaymentRequiredInformation) GetInterpretForOk() (*string, bool) {
	if o == nil || o.InterpretFor == nil {
		return nil, false
	}
	return o.InterpretFor, true
}
...
// SetInterpretFor gets a reference to the given string and assigns it to the InterpretFor field.
func (o *DebtPaymentObjectDebtPaymentRequiredInformation) SetInterpretFor(v string) {
	o.InterpretFor = &v
}

// GetItIsDefined returns the ItIsDefined field value if set, zero value otherwise.
func (o *DebtPaymentObjectDebtPaymentRequiredInformation) GetItIsDefined() bool {
	if o == nil || o.ItIsDefined == nil {
		var ret bool
		return ret
	}
	return *o.ItIsDefined
}

// GetItIsDefinedOk returns a tuple with the ItIsDefined field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DebtPaymentObjectDebtPaymentRequiredInformation) GetItIsDefinedOk() (*bool, bool) {
	if o == nil || o.ItIsDefined == nil {
		return nil, false
	}
	return o.ItIsDefined, true
}
...
// SetItIsDefined gets a reference to the given bool and assigns it to the ItIsDefined field.
...
// SetUIAttributes gets a reference to the given string and assigns it to the UIAttributes field.
...
// GetValidationExpressionType returns the ValidationExpressionType field value if set, zero value otherwise.
func (o *DebtPaymentObjectDebtPaymentRequiredInformation) GetValidationExpressionType() string {
	if o == nil || o.ValidationExpressionType == nil {
		var ret string
		return ret
	}
	return *o.ValidationExpressionType
}

// GetValidationExpressionTypeOk returns a tuple with the ValidationExpressionType field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DebtPaymentObjectDebtPaymentRequiredInformation) GetValidationExpressionTypeOk() (*string, bool) {
	if o == nil || o.ValidationExpressionType == nil {
		return nil, false
	}
	return o.ValidationExpressionType, true
}
...
// SetValidationExpressionType gets a reference to the given string and assigns it to the ValidationExpressionType field.
func (o *DebtPaymentObjectDebtPaymentRequiredInformation) SetValidationExpressionType(v string) {
	o.ValidationExpressionType = &v
}

// GetValidationExpression returns the ValidationExpression field value if set, zero value otherwise.
func (o *DebtPaymentObjectDebtPaymentRequiredInformation) GetValidationExpression() string {
	if o == nil || o.ValidationExpression == nil {
		var ret string
		return ret
	}
	return *o.ValidationExpression
}

// GetValidationExpressionOk returns a tuple with the ValidationExpression field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DebtPaymentObjectDebtPaymentRequiredInformation) GetValidationExpressionOk() (*string, bool) {
	if o == nil || o.ValidationExpression == nil {
		return nil, false
	}
	return o.ValidationExpression, true
}
...
// SetValidationExpression gets a reference to the given string and assigns it to the ValidationExpression field.
func (o *DebtPaymentObjectDebtPaymentRequiredInformation) SetValidationExpression(v string) {
	o.ValidationExpression = &v
}
...
func (o DebtPaymentObjectDebtPaymentRequiredInformation) MarshalJSON() ([]byte, error) {
	...
	if o.InterpretFor != nil {
		toSerialize["InterpretFor"] = o.InterpretFor
	}
	if o.ItIsDefined != nil {
		toSerialize["ItIsDefined"] = o.ItIsDefined
	}
	if o.UIType != nil {
	...
	if o.ValidationExpressionType != nil {
		toSerialize["ValidationExpressionType"] = o.ValidationExpressionType
	}
	if o.ValidationExpression != nil {
		toSerialize["ValidationExpression"] = o.ValidationExpression
	}
	if o.Mandatory != nil {
...
type NullableDebtPaymentObjectDebtPaymentRequiredInformation struct {
	value *DebtPaymentObjectDebtPaymentRequiredInformation
	isSet bool
}

func (v NullableDebtPaymentObjectDebtPaymentRequiredInformation) Get() *DebtPaymentObjectDebtPaymentRequiredInformation {
	return v.value
}

func (v *NullableDebtPaymentObjectDebtPaymentRequiredInformation) Set(val *DebtPaymentObjectDebtPaymentRequiredInformation) {
	v.value = val
	v.isSet = true
}

func (v NullableDebtPaymentObjectDebtPaymentRequiredInformation) IsSet() bool {
	return v.isSet
}

func (v *NullableDebtPaymentObjectDebtPaymentRequiredInformation) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDebtPaymentObjectDebtPaymentRequiredInformation(val *DebtPaymentObjectDebtPaymentRequiredInformation) *NullableDebtPaymentObjectDebtPaymentRequiredInformation {
	return &NullableDebtPaymentObjectDebtPaymentRequiredInformation{value: val, isSet: true}
}

func (v NullableDebtPaymentObjectDebtPaymentRequiredInformation) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDebtPaymentObjectDebtPaymentRequiredInformation) UnmarshalJSON(src []byte) error {
	v.isSet = true
