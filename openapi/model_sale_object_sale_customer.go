...
// SaleObjectSaleCustomer Datos del Cliente
type SaleObjectSaleCustomer struct {
	// Identificador del Cliente
	Identification *string `json:"Identification,omitempty"`
	// Tipo de documento del Cliente. CI, Cédula de identidad - PAS, Pasaporte, Documento nacional de identidad, Contrato - CONTRACT, Número de Cuenta - ACCOUNT_NUMBER
	...
	// Tipo o de categoría  del Comercio Cliente (ISO 18245)
	CategoryCode *int32 `json:"CategoryCode,omitempty"`
	// Tipo de categoría tributaria del Cliente
	...
	// URL para notificación del Cliente
...
func (o SaleObjectSaleCustomer) MarshalJSON() ([]byte, error) {
...
type NullableSaleObjectSaleCustomer struct {
	value *SaleObjectSaleCustomer
	isSet bool
}

func (v NullableSaleObjectSaleCustomer) Get() *SaleObjectSaleCustomer {
	return v.value
}

func (v *NullableSaleObjectSaleCustomer) Set(val *SaleObjectSaleCustomer) {
	v.value = val
	v.isSet = true
}

func (v NullableSaleObjectSaleCustomer) IsSet() bool {
	return v.isSet
}

func (v *NullableSaleObjectSaleCustomer) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSaleObjectSaleCustomer(val *SaleObjectSaleCustomer) *NullableSaleObjectSaleCustomer {
	return &NullableSaleObjectSaleCustomer{value: val, isSet: true}
}

func (v NullableSaleObjectSaleCustomer) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSaleObjectSaleCustomer) UnmarshalJSON(src []byte) error {
	v.isSet = true
