...
// SaleResponseObjectSaleResponseConfigurationBranch Datos de la sucursal.
type SaleResponseObjectSaleResponseConfigurationBranch struct {
	// Id de la sucursal.
	...
	// Ciudad en que se encuentra ubicada la compañía.
	City *string `json:"City,omitempty"`
	// Estado en que se encuentra ubicada la compañía.
	State *string `json:"State,omitempty"`
	// Código de región en que se encuentra ubicada la compañía.
	RegionCode *string `json:"RegionCode,omitempty"`
	// Código postal en que se encuentra ubicada de la compañía.
	ZipCode *string `json:"ZipCode,omitempty"`
	// Código de pais en que se encuentra ubicada la compañía.
...
func NewSaleResponseObjectSaleResponseConfigurationBranch() *SaleResponseObjectSaleResponseConfigurationBranch {
	this := SaleResponseObjectSaleResponseConfigurationBranch{}
	return &this
}
...
func (o *SaleResponseObjectSaleResponseConfigurationBranch) SetAddress(v string) {
	o.Address = &v
}
...
func (o SaleResponseObjectSaleResponseConfigurationBranch) MarshalJSON() ([]byte, error) {
...
type NullableSaleResponseObjectSaleResponseConfigurationBranch struct {
	value *SaleResponseObjectSaleResponseConfigurationBranch
	isSet bool
}

func (v NullableSaleResponseObjectSaleResponseConfigurationBranch) Get() *SaleResponseObjectSaleResponseConfigurationBranch {
	return v.value
}

func (v *NullableSaleResponseObjectSaleResponseConfigurationBranch) Set(val *SaleResponseObjectSaleResponseConfigurationBranch) {
	v.value = val
	v.isSet = true
}

func (v NullableSaleResponseObjectSaleResponseConfigurationBranch) IsSet() bool {
	return v.isSet
}

func (v *NullableSaleResponseObjectSaleResponseConfigurationBranch) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSaleResponseObjectSaleResponseConfigurationBranch(val *SaleResponseObjectSaleResponseConfigurationBranch) *NullableSaleResponseObjectSaleResponseConfigurationBranch {
	return &NullableSaleResponseObjectSaleResponseConfigurationBranch{value: val, isSet: true}
}

func (v NullableSaleResponseObjectSaleResponseConfigurationBranch) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSaleResponseObjectSaleResponseConfigurationBranch) UnmarshalJSON(src []byte) error {
	v.isSet = true
