...
// VoidDebtPaymentObjectVoidDebtPaymentProducts struct for VoidDebtPaymentObjectVoidDebtPaymentProducts
type VoidDebtPaymentObjectVoidDebtPaymentProducts struct {
	// Número de Producto o Item de la operación
	...
	// Valor Total Neto sin impuestos
...
func NewVoidDebtPaymentObjectVoidDebtPaymentProducts() *VoidDebtPaymentObjectVoidDebtPaymentProducts {
	this := VoidDebtPaymentObjectVoidDebtPaymentProducts{}
	return &this
}
...
func (o VoidDebtPaymentObjectVoidDebtPaymentProducts) MarshalJSON() ([]byte, error) {
...
type NullableVoidDebtPaymentObjectVoidDebtPaymentProducts struct {
	value *VoidDebtPaymentObjectVoidDebtPaymentProducts
	isSet bool
}

func (v NullableVoidDebtPaymentObjectVoidDebtPaymentProducts) Get() *VoidDebtPaymentObjectVoidDebtPaymentProducts {
	return v.value
}

func (v *NullableVoidDebtPaymentObjectVoidDebtPaymentProducts) Set(val *VoidDebtPaymentObjectVoidDebtPaymentProducts) {
	v.value = val
	v.isSet = true
}

func (v NullableVoidDebtPaymentObjectVoidDebtPaymentProducts) IsSet() bool {
	return v.isSet
}

func (v *NullableVoidDebtPaymentObjectVoidDebtPaymentProducts) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVoidDebtPaymentObjectVoidDebtPaymentProducts(val *VoidDebtPaymentObjectVoidDebtPaymentProducts) *NullableVoidDebtPaymentObjectVoidDebtPaymentProducts {
	return &NullableVoidDebtPaymentObjectVoidDebtPaymentProducts{value: val, isSet: true}
}

func (v NullableVoidDebtPaymentObjectVoidDebtPaymentProducts) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVoidDebtPaymentObjectVoidDebtPaymentProducts) UnmarshalJSON(src []byte) error {
	v.isSet = true
