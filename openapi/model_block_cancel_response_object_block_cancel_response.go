...
// BlockCancelResponseObjectBlockCancelResponse struct for BlockCancelResponseObjectBlockCancelResponse
type BlockCancelResponseObjectBlockCancelResponse struct {
...
func NewBlockCancelResponseObjectBlockCancelResponse(responseActions []string, responseMessage string, responseCode int32) *BlockCancelResponseObjectBlockCancelResponse {
	this := BlockCancelResponseObjectBlockCancelResponse{}
...
func (o BlockCancelResponseObjectBlockCancelResponse) MarshalJSON() ([]byte, error) {
...
type NullableBlockCancelResponseObjectBlockCancelResponse struct {
	value *BlockCancelResponseObjectBlockCancelResponse
	isSet bool
}

func (v NullableBlockCancelResponseObjectBlockCancelResponse) Get() *BlockCancelResponseObjectBlockCancelResponse {
	return v.value
}

func (v *NullableBlockCancelResponseObjectBlockCancelResponse) Set(val *BlockCancelResponseObjectBlockCancelResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableBlockCancelResponseObjectBlockCancelResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableBlockCancelResponseObjectBlockCancelResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBlockCancelResponseObjectBlockCancelResponse(val *BlockCancelResponseObjectBlockCancelResponse) *NullableBlockCancelResponseObjectBlockCancelResponse {
	return &NullableBlockCancelResponseObjectBlockCancelResponse{value: val, isSet: true}
}

func (v NullableBlockCancelResponseObjectBlockCancelResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBlockCancelResponseObjectBlockCancelResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
