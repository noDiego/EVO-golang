...
// WalletsObjectWallets struct for WalletsObjectWallets
type WalletsObjectWallets struct {
...
func (o WalletsObjectWallets) MarshalJSON() ([]byte, error) {
...
type NullableWalletsObjectWallets struct {
	value *WalletsObjectWallets
	isSet bool
}

func (v NullableWalletsObjectWallets) Get() *WalletsObjectWallets {
	return v.value
}

func (v *NullableWalletsObjectWallets) Set(val *WalletsObjectWallets) {
	v.value = val
	v.isSet = true
}

func (v NullableWalletsObjectWallets) IsSet() bool {
	return v.isSet
}

func (v *NullableWalletsObjectWallets) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWalletsObjectWallets(val *WalletsObjectWallets) *NullableWalletsObjectWallets {
	return &NullableWalletsObjectWallets{value: val, isSet: true}
}

func (v NullableWalletsObjectWallets) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWalletsObjectWallets) UnmarshalJSON(src []byte) error {
	v.isSet = true
