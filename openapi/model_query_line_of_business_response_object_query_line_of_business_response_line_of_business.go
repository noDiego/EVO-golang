...
// QueryLineOfBusinessResponseObjectQueryLineOfBusinessResponseLineOfBusiness struct for QueryLineOfBusinessResponseObjectQueryLineOfBusinessResponseLineOfBusiness
type QueryLineOfBusinessResponseObjectQueryLineOfBusinessResponseLineOfBusiness struct {
	// Identificacion de Rubrro
...
func NewQueryLineOfBusinessResponseObjectQueryLineOfBusinessResponseLineOfBusiness() *QueryLineOfBusinessResponseObjectQueryLineOfBusinessResponseLineOfBusiness {
	this := QueryLineOfBusinessResponseObjectQueryLineOfBusinessResponseLineOfBusiness{}
	return &this
}
...
func (o QueryLineOfBusinessResponseObjectQueryLineOfBusinessResponseLineOfBusiness) MarshalJSON() ([]byte, error) {
...
type NullableQueryLineOfBusinessResponseObjectQueryLineOfBusinessResponseLineOfBusiness struct {
	value *QueryLineOfBusinessResponseObjectQueryLineOfBusinessResponseLineOfBusiness
	isSet bool
}

func (v NullableQueryLineOfBusinessResponseObjectQueryLineOfBusinessResponseLineOfBusiness) Get() *QueryLineOfBusinessResponseObjectQueryLineOfBusinessResponseLineOfBusiness {
	return v.value
}

func (v *NullableQueryLineOfBusinessResponseObjectQueryLineOfBusinessResponseLineOfBusiness) Set(val *QueryLineOfBusinessResponseObjectQueryLineOfBusinessResponseLineOfBusiness) {
	v.value = val
	v.isSet = true
}

func (v NullableQueryLineOfBusinessResponseObjectQueryLineOfBusinessResponseLineOfBusiness) IsSet() bool {
	return v.isSet
}

func (v *NullableQueryLineOfBusinessResponseObjectQueryLineOfBusinessResponseLineOfBusiness) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQueryLineOfBusinessResponseObjectQueryLineOfBusinessResponseLineOfBusiness(val *QueryLineOfBusinessResponseObjectQueryLineOfBusinessResponseLineOfBusiness) *NullableQueryLineOfBusinessResponseObjectQueryLineOfBusinessResponseLineOfBusiness {
	return &NullableQueryLineOfBusinessResponseObjectQueryLineOfBusinessResponseLineOfBusiness{value: val, isSet: true}
}

func (v NullableQueryLineOfBusinessResponseObjectQueryLineOfBusinessResponseLineOfBusiness) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQueryLineOfBusinessResponseObjectQueryLineOfBusinessResponseLineOfBusiness) UnmarshalJSON(src []byte) error {
	v.isSet = true
