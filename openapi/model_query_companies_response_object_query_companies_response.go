...
// QueryCompaniesResponseObjectQueryCompaniesResponse struct for QueryCompaniesResponseObjectQueryCompaniesResponse
type QueryCompaniesResponseObjectQueryCompaniesResponse struct {
	...
	// Companias 
	Companies []QueryCompaniesResponseObjectQueryCompaniesResponseCompanies `json:"Companies,omitempty"`
}
...
func NewQueryCompaniesResponseObjectQueryCompaniesResponse(responseActions []string, responseMessage string, responseCode int32, answerKey string) *QueryCompaniesResponseObjectQueryCompaniesResponse {
	this := QueryCompaniesResponseObjectQueryCompaniesResponse{}
...
func (o *QueryCompaniesResponseObjectQueryCompaniesResponse) GetCompanies() []QueryCompaniesResponseObjectQueryCompaniesResponseCompanies {
	if o == nil || o.Companies == nil {
		var ret []QueryCompaniesResponseObjectQueryCompaniesResponseCompanies
		return ret
	}
	return o.Companies
}
...
// SetCompanies gets a reference to the given []QueryCompaniesResponseObjectQueryCompaniesResponseCompanies and assigns it to the Companies field.
...
func (o QueryCompaniesResponseObjectQueryCompaniesResponse) MarshalJSON() ([]byte, error) {
...
type NullableQueryCompaniesResponseObjectQueryCompaniesResponse struct {
	value *QueryCompaniesResponseObjectQueryCompaniesResponse
	isSet bool
}

func (v NullableQueryCompaniesResponseObjectQueryCompaniesResponse) Get() *QueryCompaniesResponseObjectQueryCompaniesResponse {
	return v.value
}

func (v *NullableQueryCompaniesResponseObjectQueryCompaniesResponse) Set(val *QueryCompaniesResponseObjectQueryCompaniesResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableQueryCompaniesResponseObjectQueryCompaniesResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableQueryCompaniesResponseObjectQueryCompaniesResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQueryCompaniesResponseObjectQueryCompaniesResponse(val *QueryCompaniesResponseObjectQueryCompaniesResponse) *NullableQueryCompaniesResponseObjectQueryCompaniesResponse {
	return &NullableQueryCompaniesResponseObjectQueryCompaniesResponse{value: val, isSet: true}
}

func (v NullableQueryCompaniesResponseObjectQueryCompaniesResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQueryCompaniesResponseObjectQueryCompaniesResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
