...
// SaleResponseObjectSaleResponsePaymentMethod Objeto representativo del método de pago reconocido.
type SaleResponseObjectSaleResponsePaymentMethod struct {
	// ID interno en la base de datos para este método de pago.
	Id *int32 `json:"Id,omitempty"`
	// ID externo de este método de pago, utilizado por el punto de venta para reconocer el medio de pago en su base de datos.
	ForeignIdentifier *string `json:"ForeignIdentifier,omitempty"`
	// Describe al metodo de pago.
	Description *string `json:"Description,omitempty"`
	Type *SaleResponseObjectSaleResponsePaymentMethodType `json:"Type,omitempty"`
	DebitAccount *SaleResponseObjectSaleResponsePaymentMethodDebitAccount `json:"DebitAccount,omitempty"`
	Category *SaleResponseObjectSaleResponsePaymentMethodCategory `json:"Category,omitempty"`
	// Cada elemento de este array representa a un emisor disponible para alguno de los planes informados bank.
	Issuers []SaleResponseObjectSaleResponsePaymentMethodIssuers `json:"Issuers,omitempty"`
}
...
func NewSaleResponseObjectSaleResponsePaymentMethod() *SaleResponseObjectSaleResponsePaymentMethod {
	this := SaleResponseObjectSaleResponsePaymentMethod{}
	return &this
}
...
func (o *SaleResponseObjectSaleResponsePaymentMethod) GetType() SaleResponseObjectSaleResponsePaymentMethodType {
	if o == nil || o.Type == nil {
		var ret SaleResponseObjectSaleResponsePaymentMethodType
		return ret
	}
	return *o.Type
}
...
// SetType gets a reference to the given SaleResponseObjectSaleResponsePaymentMethodType and assigns it to the Type field.
func (o *SaleResponseObjectSaleResponsePaymentMethod) SetType(v SaleResponseObjectSaleResponsePaymentMethodType) {
	o.Type = &v
}

// GetDebitAccount returns the DebitAccount field value if set, zero value otherwise.
func (o *SaleResponseObjectSaleResponsePaymentMethod) GetDebitAccount() SaleResponseObjectSaleResponsePaymentMethodDebitAccount {
	if o == nil || o.DebitAccount == nil {
		var ret SaleResponseObjectSaleResponsePaymentMethodDebitAccount
		return ret
	}
	return *o.DebitAccount
}

// GetDebitAccountOk returns a tuple with the DebitAccount field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetDebitAccount gets a reference to the given SaleResponseObjectSaleResponsePaymentMethodDebitAccount and assigns it to the DebitAccount field.
...
func (o *SaleResponseObjectSaleResponsePaymentMethod) GetCategory() SaleResponseObjectSaleResponsePaymentMethodCategory {
	if o == nil || o.Category == nil {
		var ret SaleResponseObjectSaleResponsePaymentMethodCategory
		return ret
	}
	return *o.Category
}
...
// SetCategory gets a reference to the given SaleResponseObjectSaleResponsePaymentMethodCategory and assigns it to the Category field.
...
func (o *SaleResponseObjectSaleResponsePaymentMethod) GetIssuers() []SaleResponseObjectSaleResponsePaymentMethodIssuers {
	if o == nil || o.Issuers == nil {
		var ret []SaleResponseObjectSaleResponsePaymentMethodIssuers
		return ret
	}
	return o.Issuers
}
...
// SetIssuers gets a reference to the given []SaleResponseObjectSaleResponsePaymentMethodIssuers and assigns it to the Issuers field.
func (o *SaleResponseObjectSaleResponsePaymentMethod) SetIssuers(v []SaleResponseObjectSaleResponsePaymentMethodIssuers) {
	o.Issuers = v
}

func (o SaleResponseObjectSaleResponsePaymentMethod) MarshalJSON() ([]byte, error) {
	...
	if o.DebitAccount != nil {
		toSerialize["DebitAccount"] = o.DebitAccount
	}
	if o.Category != nil {
...
type NullableSaleResponseObjectSaleResponsePaymentMethod struct {
	value *SaleResponseObjectSaleResponsePaymentMethod
	isSet bool
}

func (v NullableSaleResponseObjectSaleResponsePaymentMethod) Get() *SaleResponseObjectSaleResponsePaymentMethod {
	return v.value
}

func (v *NullableSaleResponseObjectSaleResponsePaymentMethod) Set(val *SaleResponseObjectSaleResponsePaymentMethod) {
	v.value = val
	v.isSet = true
}

func (v NullableSaleResponseObjectSaleResponsePaymentMethod) IsSet() bool {
	return v.isSet
}

func (v *NullableSaleResponseObjectSaleResponsePaymentMethod) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSaleResponseObjectSaleResponsePaymentMethod(val *SaleResponseObjectSaleResponsePaymentMethod) *NullableSaleResponseObjectSaleResponsePaymentMethod {
	return &NullableSaleResponseObjectSaleResponsePaymentMethod{value: val, isSet: true}
}

func (v NullableSaleResponseObjectSaleResponsePaymentMethod) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSaleResponseObjectSaleResponsePaymentMethod) UnmarshalJSON(src []byte) error {
	v.isSet = true
