...
// BlockCreateResponseObjectBlockCreateResponse struct for BlockCreateResponseObjectBlockCreateResponse
type BlockCreateResponseObjectBlockCreateResponse struct {
...
func NewBlockCreateResponseObjectBlockCreateResponse(responseActions []string, responseMessage string, responseCode int32) *BlockCreateResponseObjectBlockCreateResponse {
	this := BlockCreateResponseObjectBlockCreateResponse{}
...
func (o BlockCreateResponseObjectBlockCreateResponse) MarshalJSON() ([]byte, error) {
...
type NullableBlockCreateResponseObjectBlockCreateResponse struct {
	value *BlockCreateResponseObjectBlockCreateResponse
	isSet bool
}

func (v NullableBlockCreateResponseObjectBlockCreateResponse) Get() *BlockCreateResponseObjectBlockCreateResponse {
	return v.value
}

func (v *NullableBlockCreateResponseObjectBlockCreateResponse) Set(val *BlockCreateResponseObjectBlockCreateResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableBlockCreateResponseObjectBlockCreateResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableBlockCreateResponseObjectBlockCreateResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBlockCreateResponseObjectBlockCreateResponse(val *BlockCreateResponseObjectBlockCreateResponse) *NullableBlockCreateResponseObjectBlockCreateResponse {
	return &NullableBlockCreateResponseObjectBlockCreateResponse{value: val, isSet: true}
}

func (v NullableBlockCreateResponseObjectBlockCreateResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBlockCreateResponseObjectBlockCreateResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
