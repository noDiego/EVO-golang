...
// DebtInquiryResponseObjectDebtInquiryResponseAccountSummaryAccountStatus struct for DebtInquiryResponseObjectDebtInquiryResponseAccountSummaryAccountStatus
type DebtInquiryResponseObjectDebtInquiryResponseAccountSummaryAccountStatus struct {
	DebtAmount *float32 `json:"DebtAmount,omitempty"`
	AmountAvailable *float32 `json:"AmountAvailable,omitempty"`
	PointsAvailable *float32 `json:"PointsAvailable,omitempty"`
	MinimunPaymentAmount *float32 `json:"MinimunPaymentAmount,omitempty"`
...
func NewDebtInquiryResponseObjectDebtInquiryResponseAccountSummaryAccountStatus() *DebtInquiryResponseObjectDebtInquiryResponseAccountSummaryAccountStatus {
	this := DebtInquiryResponseObjectDebtInquiryResponseAccountSummaryAccountStatus{}
	return &this
}
...
// GetDebtAmount returns the DebtAmount field value if set, zero value otherwise.
func (o *DebtInquiryResponseObjectDebtInquiryResponseAccountSummaryAccountStatus) GetDebtAmount() float32 {
	if o == nil || o.DebtAmount == nil {
		var ret float32
		return ret
	}
	return *o.DebtAmount
...
// SetDebtAmount gets a reference to the given float32 and assigns it to the DebtAmount field.
...
// SetAmountAvailable gets a reference to the given float32 and assigns it to the AmountAvailable field.
...
func (o *DebtInquiryResponseObjectDebtInquiryResponseAccountSummaryAccountStatus) GetPointsAvailable() float32 {
	if o == nil || o.PointsAvailable == nil {
		var ret float32
		return ret
	}
...
// SetPointsAvailable gets a reference to the given float32 and assigns it to the PointsAvailable field.
func (o *DebtInquiryResponseObjectDebtInquiryResponseAccountSummaryAccountStatus) SetPointsAvailable(v float32) {
	o.PointsAvailable = &v
}

// GetMinimunPaymentAmount returns the MinimunPaymentAmount field value if set, zero value otherwise.
func (o *DebtInquiryResponseObjectDebtInquiryResponseAccountSummaryAccountStatus) GetMinimunPaymentAmount() float32 {
	if o == nil || o.MinimunPaymentAmount == nil {
		var ret float32
		return ret
	}
	return *o.MinimunPaymentAmount
}

// GetMinimunPaymentAmountOk returns a tuple with the MinimunPaymentAmount field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DebtInquiryResponseObjectDebtInquiryResponseAccountSummaryAccountStatus) GetMinimunPaymentAmountOk() (*float32, bool) {
	if o == nil || o.MinimunPaymentAmount == nil {
		return nil, false
	}
	return o.MinimunPaymentAmount, true
}
...
// SetMinimunPaymentAmount gets a reference to the given float32 and assigns it to the MinimunPaymentAmount field.
func (o *DebtInquiryResponseObjectDebtInquiryResponseAccountSummaryAccountStatus) SetMinimunPaymentAmount(v float32) {
	o.MinimunPaymentAmount = &v
}
...
func (o DebtInquiryResponseObjectDebtInquiryResponseAccountSummaryAccountStatus) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if o.DebtAmount != nil {
		toSerialize["DebtAmount"] = o.DebtAmount
	}
	if o.AmountAvailable != nil {
		toSerialize["AmountAvailable"] = o.AmountAvailable
	}
	if o.PointsAvailable != nil {
		toSerialize["PointsAvailable"] = o.PointsAvailable
	}
	if o.MinimunPaymentAmount != nil {
		toSerialize["MinimunPaymentAmount"] = o.MinimunPaymentAmount
	}
...
type NullableDebtInquiryResponseObjectDebtInquiryResponseAccountSummaryAccountStatus struct {
	value *DebtInquiryResponseObjectDebtInquiryResponseAccountSummaryAccountStatus
	isSet bool
}

func (v NullableDebtInquiryResponseObjectDebtInquiryResponseAccountSummaryAccountStatus) Get() *DebtInquiryResponseObjectDebtInquiryResponseAccountSummaryAccountStatus {
	return v.value
}

func (v *NullableDebtInquiryResponseObjectDebtInquiryResponseAccountSummaryAccountStatus) Set(val *DebtInquiryResponseObjectDebtInquiryResponseAccountSummaryAccountStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableDebtInquiryResponseObjectDebtInquiryResponseAccountSummaryAccountStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableDebtInquiryResponseObjectDebtInquiryResponseAccountSummaryAccountStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDebtInquiryResponseObjectDebtInquiryResponseAccountSummaryAccountStatus(val *DebtInquiryResponseObjectDebtInquiryResponseAccountSummaryAccountStatus) *NullableDebtInquiryResponseObjectDebtInquiryResponseAccountSummaryAccountStatus {
	return &NullableDebtInquiryResponseObjectDebtInquiryResponseAccountSummaryAccountStatus{value: val, isSet: true}
}

func (v NullableDebtInquiryResponseObjectDebtInquiryResponseAccountSummaryAccountStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDebtInquiryResponseObjectDebtInquiryResponseAccountSummaryAccountStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
