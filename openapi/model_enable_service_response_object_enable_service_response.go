...
// EnableServiceResponseObjectEnableServiceResponse struct for EnableServiceResponseObjectEnableServiceResponse
type EnableServiceResponseObjectEnableServiceResponse struct {
...
func NewEnableServiceResponseObjectEnableServiceResponse(responseActions []string, responseMessage string, responseCode int32, answerKey string) *EnableServiceResponseObjectEnableServiceResponse {
	this := EnableServiceResponseObjectEnableServiceResponse{}
...
func (o EnableServiceResponseObjectEnableServiceResponse) MarshalJSON() ([]byte, error) {
...
type NullableEnableServiceResponseObjectEnableServiceResponse struct {
	value *EnableServiceResponseObjectEnableServiceResponse
	isSet bool
}

func (v NullableEnableServiceResponseObjectEnableServiceResponse) Get() *EnableServiceResponseObjectEnableServiceResponse {
	return v.value
}

func (v *NullableEnableServiceResponseObjectEnableServiceResponse) Set(val *EnableServiceResponseObjectEnableServiceResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableEnableServiceResponseObjectEnableServiceResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableEnableServiceResponseObjectEnableServiceResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEnableServiceResponseObjectEnableServiceResponse(val *EnableServiceResponseObjectEnableServiceResponse) *NullableEnableServiceResponseObjectEnableServiceResponse {
	return &NullableEnableServiceResponseObjectEnableServiceResponse{value: val, isSet: true}
}

func (v NullableEnableServiceResponseObjectEnableServiceResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEnableServiceResponseObjectEnableServiceResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
