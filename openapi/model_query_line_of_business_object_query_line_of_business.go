...
// QueryLineOfBusinessObjectQueryLineOfBusiness struct for QueryLineOfBusinessObjectQueryLineOfBusiness
type QueryLineOfBusinessObjectQueryLineOfBusiness struct {
...
func NewQueryLineOfBusinessObjectQueryLineOfBusiness(companyIdentification string, systemIdentification string) *QueryLineOfBusinessObjectQueryLineOfBusiness {
	this := QueryLineOfBusinessObjectQueryLineOfBusiness{}
...
func (o QueryLineOfBusinessObjectQueryLineOfBusiness) MarshalJSON() ([]byte, error) {
...
type NullableQueryLineOfBusinessObjectQueryLineOfBusiness struct {
	value *QueryLineOfBusinessObjectQueryLineOfBusiness
	isSet bool
}

func (v NullableQueryLineOfBusinessObjectQueryLineOfBusiness) Get() *QueryLineOfBusinessObjectQueryLineOfBusiness {
	return v.value
}

func (v *NullableQueryLineOfBusinessObjectQueryLineOfBusiness) Set(val *QueryLineOfBusinessObjectQueryLineOfBusiness) {
	v.value = val
	v.isSet = true
}

func (v NullableQueryLineOfBusinessObjectQueryLineOfBusiness) IsSet() bool {
	return v.isSet
}

func (v *NullableQueryLineOfBusinessObjectQueryLineOfBusiness) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQueryLineOfBusinessObjectQueryLineOfBusiness(val *QueryLineOfBusinessObjectQueryLineOfBusiness) *NullableQueryLineOfBusinessObjectQueryLineOfBusiness {
	return &NullableQueryLineOfBusinessObjectQueryLineOfBusiness{value: val, isSet: true}
}

func (v NullableQueryLineOfBusinessObjectQueryLineOfBusiness) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQueryLineOfBusinessObjectQueryLineOfBusiness) UnmarshalJSON(src []byte) error {
	v.isSet = true
