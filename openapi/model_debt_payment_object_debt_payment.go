...
// DebtPaymentObjectDebtPayment struct for DebtPaymentObjectDebtPayment
type DebtPaymentObjectDebtPayment struct {
	...
	// Identificador de la compania obtenido a la cual se quiere pagar la deuda .
	DebtCompanyIdentification *string `json:"DebtCompanyIdentification,omitempty"`
...
func NewDebtPaymentObjectDebtPayment(companyIdentification string, systemIdentification string, amount float32) *DebtPaymentObjectDebtPayment {
	this := DebtPaymentObjectDebtPayment{}
...
// GetDebtCompanyIdentification returns the DebtCompanyIdentification field value if set, zero value otherwise.
func (o *DebtPaymentObjectDebtPayment) GetDebtCompanyIdentification() string {
	if o == nil || o.DebtCompanyIdentification == nil {
		var ret string
		return ret
	}
	return *o.DebtCompanyIdentification
}

// GetDebtCompanyIdentificationOk returns a tuple with the DebtCompanyIdentification field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DebtPaymentObjectDebtPayment) GetDebtCompanyIdentificationOk() (*string, bool) {
	if o == nil || o.DebtCompanyIdentification == nil {
		return nil, false
	}
	return o.DebtCompanyIdentification, true
}
...
// SetDebtCompanyIdentification gets a reference to the given string and assigns it to the DebtCompanyIdentification field.
func (o *DebtPaymentObjectDebtPayment) SetDebtCompanyIdentification(v string) {
	o.DebtCompanyIdentification = &v
}
...
func (o DebtPaymentObjectDebtPayment) MarshalJSON() ([]byte, error) {
	...
	if o.DebtCompanyIdentification != nil {
		toSerialize["DebtCompanyIdentification"] = o.DebtCompanyIdentification
	}
	if o.Products != nil {
...
type NullableDebtPaymentObjectDebtPayment struct {
	value *DebtPaymentObjectDebtPayment
	isSet bool
}

func (v NullableDebtPaymentObjectDebtPayment) Get() *DebtPaymentObjectDebtPayment {
	return v.value
}

func (v *NullableDebtPaymentObjectDebtPayment) Set(val *DebtPaymentObjectDebtPayment) {
	v.value = val
	v.isSet = true
}

func (v NullableDebtPaymentObjectDebtPayment) IsSet() bool {
	return v.isSet
}

func (v *NullableDebtPaymentObjectDebtPayment) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDebtPaymentObjectDebtPayment(val *DebtPaymentObjectDebtPayment) *NullableDebtPaymentObjectDebtPayment {
	return &NullableDebtPaymentObjectDebtPayment{value: val, isSet: true}
}

func (v NullableDebtPaymentObjectDebtPayment) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDebtPaymentObjectDebtPayment) UnmarshalJSON(src []byte) error {
	v.isSet = true
