...
type DebtInquiryResponseObjectDebtInquiryResponseAccountSummary struct {
	// ..
	DueDate *time.Time `json:"DueDate,omitempty"`
	// ..
	NextDueDate *time.Time `json:"NextDueDate,omitempty"`
	// ..
	NextClosingDate *time.Time `json:"NextClosingDate,omitempty"`
	// ..
	AccountStatus []DebtInquiryResponseObjectDebtInquiryResponseAccountSummaryAccountStatus `json:"AccountStatus,omitempty"`
}
...
func NewDebtInquiryResponseObjectDebtInquiryResponseAccountSummary() *DebtInquiryResponseObjectDebtInquiryResponseAccountSummary {
	this := DebtInquiryResponseObjectDebtInquiryResponseAccountSummary{}
	return &this
}
...
// SetNextDueDate gets a reference to the given time.Time and assigns it to the NextDueDate field.
func (o *DebtInquiryResponseObjectDebtInquiryResponseAccountSummary) SetNextDueDate(v time.Time) {
	o.NextDueDate = &v
}

// GetNextClosingDate returns the NextClosingDate field value if set, zero value otherwise.
func (o *DebtInquiryResponseObjectDebtInquiryResponseAccountSummary) GetNextClosingDate() time.Time {
	if o == nil || o.NextClosingDate == nil {
		var ret time.Time
		return ret
	}
	return *o.NextClosingDate
}

// GetNextClosingDateOk returns a tuple with the NextClosingDate field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DebtInquiryResponseObjectDebtInquiryResponseAccountSummary) GetNextClosingDateOk() (*time.Time, bool) {
	if o == nil || o.NextClosingDate == nil {
		return nil, false
	}
	return o.NextClosingDate, true
}
...
// SetNextClosingDate gets a reference to the given time.Time and assigns it to the NextClosingDate field.
...
func (o *DebtInquiryResponseObjectDebtInquiryResponseAccountSummary) GetAccountStatus() []DebtInquiryResponseObjectDebtInquiryResponseAccountSummaryAccountStatus {
	if o == nil || o.AccountStatus == nil {
		var ret []DebtInquiryResponseObjectDebtInquiryResponseAccountSummaryAccountStatus
		return ret
	}
...
// SetAccountStatus gets a reference to the given []DebtInquiryResponseObjectDebtInquiryResponseAccountSummaryAccountStatus and assigns it to the AccountStatus field.
...
func (o DebtInquiryResponseObjectDebtInquiryResponseAccountSummary) MarshalJSON() ([]byte, error) {
	...
	if o.NextClosingDate != nil {
		toSerialize["NextClosingDate"] = o.NextClosingDate
	}
...
type NullableDebtInquiryResponseObjectDebtInquiryResponseAccountSummary struct {
	value *DebtInquiryResponseObjectDebtInquiryResponseAccountSummary
	isSet bool
}

func (v NullableDebtInquiryResponseObjectDebtInquiryResponseAccountSummary) Get() *DebtInquiryResponseObjectDebtInquiryResponseAccountSummary {
	return v.value
}

func (v *NullableDebtInquiryResponseObjectDebtInquiryResponseAccountSummary) Set(val *DebtInquiryResponseObjectDebtInquiryResponseAccountSummary) {
	v.value = val
	v.isSet = true
}

func (v NullableDebtInquiryResponseObjectDebtInquiryResponseAccountSummary) IsSet() bool {
	return v.isSet
}

func (v *NullableDebtInquiryResponseObjectDebtInquiryResponseAccountSummary) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDebtInquiryResponseObjectDebtInquiryResponseAccountSummary(val *DebtInquiryResponseObjectDebtInquiryResponseAccountSummary) *NullableDebtInquiryResponseObjectDebtInquiryResponseAccountSummary {
	return &NullableDebtInquiryResponseObjectDebtInquiryResponseAccountSummary{value: val, isSet: true}
}

func (v NullableDebtInquiryResponseObjectDebtInquiryResponseAccountSummary) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDebtInquiryResponseObjectDebtInquiryResponseAccountSummary) UnmarshalJSON(src []byte) error {
	v.isSet = true
