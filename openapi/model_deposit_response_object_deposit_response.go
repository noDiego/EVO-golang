...
// DepositResponseObjectDepositResponse struct for DepositResponseObjectDepositResponse
type DepositResponseObjectDepositResponse struct {
...
func NewDepositResponseObjectDepositResponse(responseCode int32, responseActions []string, responseMessage string) *DepositResponseObjectDepositResponse {
	this := DepositResponseObjectDepositResponse{}
...
func (o *DepositResponseObjectDepositResponse) GetResponseCode() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *DepositResponseObjectDepositResponse) GetForeignResponseCodeOk() (*string, bool) {
	if o == nil || o.ForeignResponseCode == nil {
		return nil, false
	}
...
func (o *DepositResponseObjectDepositResponse) HasSecurity() bool {
	if o != nil && o.Security != nil {
		return true
	}
...
func (o *DepositResponseObjectDepositResponse) HasCommittedBlock() bool {
	if o != nil && o.CommittedBlock != nil {
		return true
	}
...
func (o *DepositResponseObjectDepositResponse) GetServerAddress() string {
...
// and a boolean to check if the value has been set.
func (o *DepositResponseObjectDepositResponse) GetServerNodeNameOk() (*string, bool) {
	if o == nil || o.ServerNodeName == nil {
		return nil, false
	}
...
func (o *DepositResponseObjectDepositResponse) HasAdapterOutputNodeName() bool {
	if o != nil && o.AdapterOutputNodeName != nil {
		return true
	}
...
func (o *DepositResponseObjectDepositResponse) HasPrinterResponseMessage() bool {
	if o != nil && o.PrinterResponseMessage != nil {
		return true
	}
...
func (o *DepositResponseObjectDepositResponse) GetCurrencyDescription() string {
...
func (o *DepositResponseObjectDepositResponse) SetValueFacilityPayments(v float32) {
...
func (o *DepositResponseObjectDepositResponse) HasAlternativeAmount() bool {
	if o != nil && o.AlternativeAmount != nil {
		return true
	}
...
func (o *DepositResponseObjectDepositResponse) GetCashbackAmount() float32 {
...
// and a boolean to check if the value has been set.
func (o *DepositResponseObjectDepositResponse) GetRequestAmountOk() (*float32, bool) {
	if o == nil || o.RequestAmount == nil {
		return nil, false
	}
...
func (o *DepositResponseObjectDepositResponse) HasTaxFinancialCostAmount() bool {
	if o != nil && o.TaxFinancialCostAmount != nil {
		return true
	}
...
func (o *DepositResponseObjectDepositResponse) HasIssuerName() bool {
	if o != nil && o.IssuerName != nil {
		return true
	}
...
func (o *DepositResponseObjectDepositResponse) GetAuthResultCode() string {
...
// and a boolean to check if the value has been set.
func (o *DepositResponseObjectDepositResponse) GetAuthHostMsgTypeOk() (*string, bool) {
	if o == nil || o.AuthHostMsgType == nil {
		return nil, false
	}
...
func (o *DepositResponseObjectDepositResponse) HasAuthDateTime() bool {
	if o != nil && o.AuthDateTime != nil {
		return true
	}
...
func (o *DepositResponseObjectDepositResponse) SetTerminalTrace(v int32) {
	o.TerminalTrace = &v
}
...
func (o *DepositResponseObjectDepositResponse) HasCardReadMode() bool {
	if o != nil && o.CardReadMode != nil {
		return true
	}
...
func (o *DepositResponseObjectDepositResponse) GetCardNumber() string {
...
// and a boolean to check if the value has been set.
func (o *DepositResponseObjectDepositResponse) GetCardHashingOk() (*string, bool) {
	if o == nil || o.CardHashing == nil {
		return nil, false
	}
...
func (o *DepositResponseObjectDepositResponse) GetCustomer() SaleObjectSaleCustomer {
...
// and a boolean to check if the value has been set.
func (o *DepositResponseObjectDepositResponse) GetPlanConfigVersionOk() (*int32, bool) {
	if o == nil || o.PlanConfigVersion == nil {
		return nil, false
	}
...
func (o *DepositResponseObjectDepositResponse) HasOrigAuthCode() bool {
	if o != nil && o.OrigAuthCode != nil {
		return true
	}
...
func (o *DepositResponseObjectDepositResponse) SetOrigAuthCode(v string) {
	o.OrigAuthCode = &v
}

// GetPaymentMethodId returns the PaymentMethodId field value if set, zero value otherwise.
func (o *DepositResponseObjectDepositResponse) GetPaymentMethodId() int32 {
...
// and a boolean to check if the value has been set.
func (o *DepositResponseObjectDepositResponse) GetPaymentMethodIdOk() (*int32, bool) {
	if o == nil || o.PaymentMethodId == nil {
		return nil, false
	}
...
func (o *DepositResponseObjectDepositResponse) HasPaymentMethodId() bool {
	if o != nil && o.PaymentMethodId != nil {
		return true
	}
...
func (o *DepositResponseObjectDepositResponse) SetPaymentMethodId(v int32) {
	o.PaymentMethodId = &v
}

// GetPaymentMethodDescription returns the PaymentMethodDescription field value if set, zero value otherwise.
func (o *DepositResponseObjectDepositResponse) GetPaymentMethodDescription() string {
...
// and a boolean to check if the value has been set.
func (o *DepositResponseObjectDepositResponse) GetPaymentMethodDescriptionOk() (*string, bool) {
	if o == nil || o.PaymentMethodDescription == nil {
		return nil, false
	}
...
func (o *DepositResponseObjectDepositResponse) HasPaymentMethodDescription() bool {
	if o != nil && o.PaymentMethodDescription != nil {
		return true
	}
...
func (o *DepositResponseObjectDepositResponse) SetPaymentMethodDescription(v string) {
	o.PaymentMethodDescription = &v
}

func (o DepositResponseObjectDepositResponse) MarshalJSON() ([]byte, error) {
...
type NullableDepositResponseObjectDepositResponse struct {
	value *DepositResponseObjectDepositResponse
	isSet bool
}

func (v NullableDepositResponseObjectDepositResponse) Get() *DepositResponseObjectDepositResponse {
	return v.value
}

func (v *NullableDepositResponseObjectDepositResponse) Set(val *DepositResponseObjectDepositResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDepositResponseObjectDepositResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDepositResponseObjectDepositResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDepositResponseObjectDepositResponse(val *DepositResponseObjectDepositResponse) *NullableDepositResponseObjectDepositResponse {
	return &NullableDepositResponseObjectDepositResponse{value: val, isSet: true}
}

func (v NullableDepositResponseObjectDepositResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDepositResponseObjectDepositResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
