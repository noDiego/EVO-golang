...
// SaleResponseObjectSaleResponseNotificationDistributionList Lista de distribución de e-mails
type SaleResponseObjectSaleResponseNotificationDistributionList struct {
	// Lista de distribución de e-mails establecida por sucursal
	Branch *string `json:"Branch,omitempty"`
	// Lista de distribución de e-mails establecida por compañía
	Company *string `json:"Company,omitempty"`
	// Lista de distribución de e-mails establecida por canal
	Channel *string `json:"Channel,omitempty"`
	// Lista de distribución de e-mails establecida por sistema
...
func NewSaleResponseObjectSaleResponseNotificationDistributionList() *SaleResponseObjectSaleResponseNotificationDistributionList {
	this := SaleResponseObjectSaleResponseNotificationDistributionList{}
	return &this
}
...
func (o SaleResponseObjectSaleResponseNotificationDistributionList) MarshalJSON() ([]byte, error) {
...
type NullableSaleResponseObjectSaleResponseNotificationDistributionList struct {
	value *SaleResponseObjectSaleResponseNotificationDistributionList
	isSet bool
}

func (v NullableSaleResponseObjectSaleResponseNotificationDistributionList) Get() *SaleResponseObjectSaleResponseNotificationDistributionList {
	return v.value
}

func (v *NullableSaleResponseObjectSaleResponseNotificationDistributionList) Set(val *SaleResponseObjectSaleResponseNotificationDistributionList) {
	v.value = val
	v.isSet = true
}

func (v NullableSaleResponseObjectSaleResponseNotificationDistributionList) IsSet() bool {
	return v.isSet
}

func (v *NullableSaleResponseObjectSaleResponseNotificationDistributionList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSaleResponseObjectSaleResponseNotificationDistributionList(val *SaleResponseObjectSaleResponseNotificationDistributionList) *NullableSaleResponseObjectSaleResponseNotificationDistributionList {
	return &NullableSaleResponseObjectSaleResponseNotificationDistributionList{value: val, isSet: true}
}

func (v NullableSaleResponseObjectSaleResponseNotificationDistributionList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSaleResponseObjectSaleResponseNotificationDistributionList) UnmarshalJSON(src []byte) error {
	v.isSet = true
