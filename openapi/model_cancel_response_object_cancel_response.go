...
// CancelResponseObjectCancelResponse struct for CancelResponseObjectCancelResponse
type CancelResponseObjectCancelResponse struct {
...
func NewCancelResponseObjectCancelResponse(responseActions []string, responseMessage string, responseCode int32) *CancelResponseObjectCancelResponse {
	this := CancelResponseObjectCancelResponse{}
...
func (o CancelResponseObjectCancelResponse) MarshalJSON() ([]byte, error) {
...
type NullableCancelResponseObjectCancelResponse struct {
	value *CancelResponseObjectCancelResponse
	isSet bool
}

func (v NullableCancelResponseObjectCancelResponse) Get() *CancelResponseObjectCancelResponse {
	return v.value
}

func (v *NullableCancelResponseObjectCancelResponse) Set(val *CancelResponseObjectCancelResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCancelResponseObjectCancelResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCancelResponseObjectCancelResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCancelResponseObjectCancelResponse(val *CancelResponseObjectCancelResponse) *NullableCancelResponseObjectCancelResponse {
	return &NullableCancelResponseObjectCancelResponse{value: val, isSet: true}
}

func (v NullableCancelResponseObjectCancelResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCancelResponseObjectCancelResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
