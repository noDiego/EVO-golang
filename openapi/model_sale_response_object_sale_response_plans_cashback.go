...
// SaleResponseObjectSaleResponsePlansCashback Objeto que contiene toda la información para conocer lo que el plan permite con respecto al cashback.
type SaleResponseObjectSaleResponsePlansCashback struct {
	// Permite CashBack.
	...
	// Porcentaje mínimo del total de la venta  a entregar en efectivo.
	MinPercAmount *float32 `json:"MinPercAmount,omitempty"`
	// Porcentaje Máximo del Total de la venta a entregar en efectivo.
	MaxPercAmount *float32 `json:"MaxPercAmount,omitempty"`
}
...
func NewSaleResponseObjectSaleResponsePlansCashback() *SaleResponseObjectSaleResponsePlansCashback {
	this := SaleResponseObjectSaleResponsePlansCashback{}
	return &this
}
...
// GetMinPercAmount returns the MinPercAmount field value if set, zero value otherwise.
func (o *SaleResponseObjectSaleResponsePlansCashback) GetMinPercAmount() float32 {
	if o == nil || o.MinPercAmount == nil {
		var ret float32
		return ret
	}
	return *o.MinPercAmount
}

// GetMinPercAmountOk returns a tuple with the MinPercAmount field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SaleResponseObjectSaleResponsePlansCashback) GetMinPercAmountOk() (*float32, bool) {
	if o == nil || o.MinPercAmount == nil {
		return nil, false
	}
	return o.MinPercAmount, true
}
...
// SetMinPercAmount gets a reference to the given float32 and assigns it to the MinPercAmount field.
func (o *SaleResponseObjectSaleResponsePlansCashback) SetMinPercAmount(v float32) {
	o.MinPercAmount = &v
}

// GetMaxPercAmount returns the MaxPercAmount field value if set, zero value otherwise.
func (o *SaleResponseObjectSaleResponsePlansCashback) GetMaxPercAmount() float32 {
	if o == nil || o.MaxPercAmount == nil {
		var ret float32
		return ret
	}
	return *o.MaxPercAmount
}

// GetMaxPercAmountOk returns a tuple with the MaxPercAmount field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SaleResponseObjectSaleResponsePlansCashback) GetMaxPercAmountOk() (*float32, bool) {
	if o == nil || o.MaxPercAmount == nil {
		return nil, false
	}
	return o.MaxPercAmount, true
}
...
// SetMaxPercAmount gets a reference to the given float32 and assigns it to the MaxPercAmount field.
func (o *SaleResponseObjectSaleResponsePlansCashback) SetMaxPercAmount(v float32) {
	o.MaxPercAmount = &v
}

func (o SaleResponseObjectSaleResponsePlansCashback) MarshalJSON() ([]byte, error) {
	...
	if o.MinPercAmount != nil {
		toSerialize["MinPercAmount"] = o.MinPercAmount
	}
	if o.MaxPercAmount != nil {
		toSerialize["MaxPercAmount"] = o.MaxPercAmount
	}
	return json.Marshal(toSerialize)
}

type NullableSaleResponseObjectSaleResponsePlansCashback struct {
	value *SaleResponseObjectSaleResponsePlansCashback
	isSet bool
}

func (v NullableSaleResponseObjectSaleResponsePlansCashback) Get() *SaleResponseObjectSaleResponsePlansCashback {
	return v.value
}

func (v *NullableSaleResponseObjectSaleResponsePlansCashback) Set(val *SaleResponseObjectSaleResponsePlansCashback) {
	v.value = val
	v.isSet = true
}

func (v NullableSaleResponseObjectSaleResponsePlansCashback) IsSet() bool {
	return v.isSet
}

func (v *NullableSaleResponseObjectSaleResponsePlansCashback) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSaleResponseObjectSaleResponsePlansCashback(val *SaleResponseObjectSaleResponsePlansCashback) *NullableSaleResponseObjectSaleResponsePlansCashback {
	return &NullableSaleResponseObjectSaleResponsePlansCashback{value: val, isSet: true}
}

func (v NullableSaleResponseObjectSaleResponsePlansCashback) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSaleResponseObjectSaleResponsePlansCashback) UnmarshalJSON(src []byte) error {
	v.isSet = true
