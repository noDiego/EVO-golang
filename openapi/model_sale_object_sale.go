...
// SaleObjectSale struct for SaleObjectSale
type SaleObjectSale struct {
...
func (o SaleObjectSale) MarshalJSON() ([]byte, error) {
...
type NullableSaleObjectSale struct {
	value *SaleObjectSale
	isSet bool
}

func (v NullableSaleObjectSale) Get() *SaleObjectSale {
	return v.value
}

func (v *NullableSaleObjectSale) Set(val *SaleObjectSale) {
	v.value = val
	v.isSet = true
}

func (v NullableSaleObjectSale) IsSet() bool {
	return v.isSet
}

func (v *NullableSaleObjectSale) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSaleObjectSale(val *SaleObjectSale) *NullableSaleObjectSale {
	return &NullableSaleObjectSale{value: val, isSet: true}
}

func (v NullableSaleObjectSale) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSaleObjectSale) UnmarshalJSON(src []byte) error {
	v.isSet = true
