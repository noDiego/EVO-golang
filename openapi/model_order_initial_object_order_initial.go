...
// OrderInitialObjectOrderInitial struct for OrderInitialObjectOrderInitial
type OrderInitialObjectOrderInitial struct {
...
func NewOrderInitialObjectOrderInitial(systemIdentification string, companyIdentification string) *OrderInitialObjectOrderInitial {
	this := OrderInitialObjectOrderInitial{}
...
func (o OrderInitialObjectOrderInitial) MarshalJSON() ([]byte, error) {
...
type NullableOrderInitialObjectOrderInitial struct {
	value *OrderInitialObjectOrderInitial
	isSet bool
}

func (v NullableOrderInitialObjectOrderInitial) Get() *OrderInitialObjectOrderInitial {
	return v.value
}

func (v *NullableOrderInitialObjectOrderInitial) Set(val *OrderInitialObjectOrderInitial) {
	v.value = val
	v.isSet = true
}

func (v NullableOrderInitialObjectOrderInitial) IsSet() bool {
	return v.isSet
}

func (v *NullableOrderInitialObjectOrderInitial) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrderInitialObjectOrderInitial(val *OrderInitialObjectOrderInitial) *NullableOrderInitialObjectOrderInitial {
	return &NullableOrderInitialObjectOrderInitial{value: val, isSet: true}
}

func (v NullableOrderInitialObjectOrderInitial) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOrderInitialObjectOrderInitial) UnmarshalJSON(src []byte) error {
	v.isSet = true
