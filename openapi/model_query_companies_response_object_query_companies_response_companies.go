...
// QueryCompaniesResponseObjectQueryCompaniesResponseCompanies struct for QueryCompaniesResponseObjectQueryCompaniesResponseCompanies
type QueryCompaniesResponseObjectQueryCompaniesResponseCompanies struct {
	// Identificacion de la Compania
	Id *string `json:"Id,omitempty"`
	// Nombre de la compania
	Name *string `json:"Name,omitempty"`
	// Descripcion de la compania
	Description *string `json:"Description,omitempty"`
	// Rubro de Pertenencias de la Compania
	LineOfBusinessIdentification *string `json:"LineOfBusinessIdentification,omitempty"`
	// Orden
	Order *int32 `json:"Order,omitempty"`
	// Tipo de Importe que se puede usar para pagar esta empresa
	AmountType *int32 `json:"AmountType,omitempty"`
	// Indicador de Habilitacion de Pagos Recurrentes
	EnableRecurringPayment *bool `json:"EnableRecurringPayment,omitempty"`
	...
	AdditionalInformation []QueryCompaniesResponseObjectQueryCompaniesResponseAdditionalInformation `json:"AdditionalInformation,omitempty"`
}
...
func NewQueryCompaniesResponseObjectQueryCompaniesResponseCompanies() *QueryCompaniesResponseObjectQueryCompaniesResponseCompanies {
	this := QueryCompaniesResponseObjectQueryCompaniesResponseCompanies{}
	return &this
}
...
// GetLineOfBusinessIdentification returns the LineOfBusinessIdentification field value if set, zero value otherwise.
func (o *QueryCompaniesResponseObjectQueryCompaniesResponseCompanies) GetLineOfBusinessIdentification() string {
	if o == nil || o.LineOfBusinessIdentification == nil {
		var ret string
		return ret
	}
	return *o.LineOfBusinessIdentification
}

// GetLineOfBusinessIdentificationOk returns a tuple with the LineOfBusinessIdentification field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *QueryCompaniesResponseObjectQueryCompaniesResponseCompanies) GetLineOfBusinessIdentificationOk() (*string, bool) {
	if o == nil || o.LineOfBusinessIdentification == nil {
		return nil, false
	}
	return o.LineOfBusinessIdentification, true
}
...
// SetLineOfBusinessIdentification gets a reference to the given string and assigns it to the LineOfBusinessIdentification field.
func (o *QueryCompaniesResponseObjectQueryCompaniesResponseCompanies) SetLineOfBusinessIdentification(v string) {
	o.LineOfBusinessIdentification = &v
}
...
// SetAmountType gets a reference to the given int32 and assigns it to the AmountType field.
func (o *QueryCompaniesResponseObjectQueryCompaniesResponseCompanies) SetAmountType(v int32) {
	o.AmountType = &v
}

// GetEnableRecurringPayment returns the EnableRecurringPayment field value if set, zero value otherwise.
func (o *QueryCompaniesResponseObjectQueryCompaniesResponseCompanies) GetEnableRecurringPayment() bool {
	if o == nil || o.EnableRecurringPayment == nil {
		var ret bool
		return ret
	}
	return *o.EnableRecurringPayment
}

// GetEnableRecurringPaymentOk returns a tuple with the EnableRecurringPayment field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *QueryCompaniesResponseObjectQueryCompaniesResponseCompanies) GetEnableRecurringPaymentOk() (*bool, bool) {
	if o == nil || o.EnableRecurringPayment == nil {
		return nil, false
	}
	return o.EnableRecurringPayment, true
}
...
// SetEnableRecurringPayment gets a reference to the given bool and assigns it to the EnableRecurringPayment field.
func (o *QueryCompaniesResponseObjectQueryCompaniesResponseCompanies) SetEnableRecurringPayment(v bool) {
	o.EnableRecurringPayment = &v
}
...
func (o *QueryCompaniesResponseObjectQueryCompaniesResponseCompanies) GetAdditionalInformation() []QueryCompaniesResponseObjectQueryCompaniesResponseAdditionalInformation {
	if o == nil || o.AdditionalInformation == nil {
		var ret []QueryCompaniesResponseObjectQueryCompaniesResponseAdditionalInformation
		return ret
	}
...
// SetAdditionalInformation gets a reference to the given []QueryCompaniesResponseObjectQueryCompaniesResponseAdditionalInformation and assigns it to the AdditionalInformation field.
...
func (o QueryCompaniesResponseObjectQueryCompaniesResponseCompanies) MarshalJSON() ([]byte, error) {
	...
	if o.LineOfBusinessIdentification != nil {
		toSerialize["LineOfBusinessIdentification"] = o.LineOfBusinessIdentification
	}
	if o.Order != nil {
	...
	if o.EnableRecurringPayment != nil {
		toSerialize["EnableRecurringPayment"] = o.EnableRecurringPayment
	}
	if o.Provider != nil {
...
type NullableQueryCompaniesResponseObjectQueryCompaniesResponseCompanies struct {
	value *QueryCompaniesResponseObjectQueryCompaniesResponseCompanies
	isSet bool
}

func (v NullableQueryCompaniesResponseObjectQueryCompaniesResponseCompanies) Get() *QueryCompaniesResponseObjectQueryCompaniesResponseCompanies {
	return v.value
}

func (v *NullableQueryCompaniesResponseObjectQueryCompaniesResponseCompanies) Set(val *QueryCompaniesResponseObjectQueryCompaniesResponseCompanies) {
	v.value = val
	v.isSet = true
}

func (v NullableQueryCompaniesResponseObjectQueryCompaniesResponseCompanies) IsSet() bool {
	return v.isSet
}

func (v *NullableQueryCompaniesResponseObjectQueryCompaniesResponseCompanies) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQueryCompaniesResponseObjectQueryCompaniesResponseCompanies(val *QueryCompaniesResponseObjectQueryCompaniesResponseCompanies) *NullableQueryCompaniesResponseObjectQueryCompaniesResponseCompanies {
	return &NullableQueryCompaniesResponseObjectQueryCompaniesResponseCompanies{value: val, isSet: true}
}

func (v NullableQueryCompaniesResponseObjectQueryCompaniesResponseCompanies) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQueryCompaniesResponseObjectQueryCompaniesResponseCompanies) UnmarshalJSON(src []byte) error {
	v.isSet = true
