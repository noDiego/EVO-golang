...
// OrderFinalObjectOrderFinal struct for OrderFinalObjectOrderFinal
type OrderFinalObjectOrderFinal struct {
...
func NewOrderFinalObjectOrderFinal() *OrderFinalObjectOrderFinal {
	this := OrderFinalObjectOrderFinal{}
	return &this
}
...
func (o OrderFinalObjectOrderFinal) MarshalJSON() ([]byte, error) {
...
type NullableOrderFinalObjectOrderFinal struct {
	value *OrderFinalObjectOrderFinal
	isSet bool
}

func (v NullableOrderFinalObjectOrderFinal) Get() *OrderFinalObjectOrderFinal {
	return v.value
}

func (v *NullableOrderFinalObjectOrderFinal) Set(val *OrderFinalObjectOrderFinal) {
	v.value = val
	v.isSet = true
}

func (v NullableOrderFinalObjectOrderFinal) IsSet() bool {
	return v.isSet
}

func (v *NullableOrderFinalObjectOrderFinal) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrderFinalObjectOrderFinal(val *OrderFinalObjectOrderFinal) *NullableOrderFinalObjectOrderFinal {
	return &NullableOrderFinalObjectOrderFinal{value: val, isSet: true}
}

func (v NullableOrderFinalObjectOrderFinal) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOrderFinalObjectOrderFinal) UnmarshalJSON(src []byte) error {
	v.isSet = true
