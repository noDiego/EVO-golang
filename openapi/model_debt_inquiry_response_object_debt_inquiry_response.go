...
// DebtInquiryResponseObjectDebtInquiryResponse struct for DebtInquiryResponseObjectDebtInquiryResponse
type DebtInquiryResponseObjectDebtInquiryResponse struct {
	...
	// Estado actual (saldo) de la cuenta. El formato de este valor utilizara las reglas del uso de signos de la matematica. Es decir, el signo \"+\" sera opcional cuando el salgo sea a favor (crédito), y sera obligatorio el uso del signo \"-\" cuando el saldo sea en contra (deudor)
	Balance *string `json:"Balance,omitempty"`
	AccountSummary *DebtInquiryResponseObjectDebtInquiryResponseAccountSummary `json:"AccountSummary,omitempty"`
	// Descripción del tipo de cuenta de débito utilizada para realizar la transacción. Este tipo de dato es utilizado, por ejemplo, para tarjetas de la marca MAESTRO.
	DebitAccountType *string `json:"DebitAccountType,omitempty"`
	// Número de cuenta informado por el host, relaciónado con la tarjeta que realizo la transacción. Este valor estara presente solo si ha sido solicitado al host al momento de enviar la petición.
	...
	// Código de identificación, generado por Plataforma, de la operación realizada
	PaymentIdentification *string `json:"PaymentIdentification,omitempty"`
	// Indicador de utilización de fallback para captura de los datos de tarjeta. Cuando se capturan los datos de una tarjeta EMV CHIP a traves de la banda magnética, este flag sera enviado, informando de esta situación
	FallbackForced *int32 `json:"FallbackForced,omitempty"`
	// ID que identifica a la operación que acaba de ser reversada.
	ReversedPaymentIdentification *string `json:"ReversedPaymentIdentification,omitempty"`
	...
	// Companias 
	Companies []DebtInquiryResponseObjectDebtInquiryResponseCompanies `json:"Companies,omitempty"`
}
...
func NewDebtInquiryResponseObjectDebtInquiryResponse(responseCode int32, responseActions []string, responseMessage string) *DebtInquiryResponseObjectDebtInquiryResponse {
	this := DebtInquiryResponseObjectDebtInquiryResponse{}
...
func (o *DebtInquiryResponseObjectDebtInquiryResponse) GetAccountSummary() DebtInquiryResponseObjectDebtInquiryResponseAccountSummary {
	if o == nil || o.AccountSummary == nil {
		var ret DebtInquiryResponseObjectDebtInquiryResponseAccountSummary
		return ret
	}
...
// SetAccountSummary gets a reference to the given DebtInquiryResponseObjectDebtInquiryResponseAccountSummary and assigns it to the AccountSummary field.
...
func (o *DebtInquiryResponseObjectDebtInquiryResponse) GetDebitAccountType() string {
	if o == nil || o.DebitAccountType == nil {
		var ret string
		return ret
	}
...
// GetPaymentIdentification returns the PaymentIdentification field value if set, zero value otherwise.
func (o *DebtInquiryResponseObjectDebtInquiryResponse) GetPaymentIdentification() string {
	if o == nil || o.PaymentIdentification == nil {
		var ret string
		return ret
	}
	return *o.PaymentIdentification
}

// GetPaymentIdentificationOk returns a tuple with the PaymentIdentification field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DebtInquiryResponseObjectDebtInquiryResponse) GetPaymentIdentificationOk() (*string, bool) {
	if o == nil || o.PaymentIdentification == nil {
		return nil, false
	}
	return o.PaymentIdentification, true
}
...
// SetPaymentIdentification gets a reference to the given string and assigns it to the PaymentIdentification field.
func (o *DebtInquiryResponseObjectDebtInquiryResponse) SetPaymentIdentification(v string) {
	o.PaymentIdentification = &v
}

// GetFallbackForced returns the FallbackForced field value if set, zero value otherwise.
func (o *DebtInquiryResponseObjectDebtInquiryResponse) GetFallbackForced() int32 {
	if o == nil || o.FallbackForced == nil {
		var ret int32
		return ret
	}
	return *o.FallbackForced
}

// GetFallbackForcedOk returns a tuple with the FallbackForced field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DebtInquiryResponseObjectDebtInquiryResponse) GetFallbackForcedOk() (*int32, bool) {
	if o == nil || o.FallbackForced == nil {
		return nil, false
	}
	return o.FallbackForced, true
}
...
// SetFallbackForced gets a reference to the given int32 and assigns it to the FallbackForced field.
func (o *DebtInquiryResponseObjectDebtInquiryResponse) SetFallbackForced(v int32) {
	o.FallbackForced = &v
}

// GetReversedPaymentIdentification returns the ReversedPaymentIdentification field value if set, zero value otherwise.
func (o *DebtInquiryResponseObjectDebtInquiryResponse) GetReversedPaymentIdentification() string {
	if o == nil || o.ReversedPaymentIdentification == nil {
		var ret string
		return ret
	}
	return *o.ReversedPaymentIdentification
}

// GetReversedPaymentIdentificationOk returns a tuple with the ReversedPaymentIdentification field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DebtInquiryResponseObjectDebtInquiryResponse) GetReversedPaymentIdentificationOk() (*string, bool) {
	if o == nil || o.ReversedPaymentIdentification == nil {
		return nil, false
	}
	return o.ReversedPaymentIdentification, true
}
...
// SetReversedPaymentIdentification gets a reference to the given string and assigns it to the ReversedPaymentIdentification field.
func (o *DebtInquiryResponseObjectDebtInquiryResponse) SetReversedPaymentIdentification(v string) {
	o.ReversedPaymentIdentification = &v
}
...
func (o *DebtInquiryResponseObjectDebtInquiryResponse) GetCompanies() []DebtInquiryResponseObjectDebtInquiryResponseCompanies {
	if o == nil || o.Companies == nil {
		var ret []DebtInquiryResponseObjectDebtInquiryResponseCompanies
		return ret
	}
	return o.Companies
}
...
// SetCompanies gets a reference to the given []DebtInquiryResponseObjectDebtInquiryResponseCompanies and assigns it to the Companies field.
func (o *DebtInquiryResponseObjectDebtInquiryResponse) SetCompanies(v []DebtInquiryResponseObjectDebtInquiryResponseCompanies) {
	o.Companies = v
}

func (o DebtInquiryResponseObjectDebtInquiryResponse) MarshalJSON() ([]byte, error) {
	...
	if o.AccountSummary != nil {
		toSerialize["AccountSummary"] = o.AccountSummary
	}
	if o.DebitAccountType != nil {
	...
	if o.PaymentIdentification != nil {
		toSerialize["PaymentIdentification"] = o.PaymentIdentification
	}
	if o.FallbackForced != nil {
		toSerialize["FallbackForced"] = o.FallbackForced
	}
	if o.ReversedPaymentIdentification != nil {
		toSerialize["ReversedPaymentIdentification"] = o.ReversedPaymentIdentification
	}
...
type NullableDebtInquiryResponseObjectDebtInquiryResponse struct {
	value *DebtInquiryResponseObjectDebtInquiryResponse
	isSet bool
}

func (v NullableDebtInquiryResponseObjectDebtInquiryResponse) Get() *DebtInquiryResponseObjectDebtInquiryResponse {
	return v.value
}

func (v *NullableDebtInquiryResponseObjectDebtInquiryResponse) Set(val *DebtInquiryResponseObjectDebtInquiryResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDebtInquiryResponseObjectDebtInquiryResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDebtInquiryResponseObjectDebtInquiryResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDebtInquiryResponseObjectDebtInquiryResponse(val *DebtInquiryResponseObjectDebtInquiryResponse) *NullableDebtInquiryResponseObjectDebtInquiryResponse {
	return &NullableDebtInquiryResponseObjectDebtInquiryResponse{value: val, isSet: true}
}

func (v NullableDebtInquiryResponseObjectDebtInquiryResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDebtInquiryResponseObjectDebtInquiryResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
