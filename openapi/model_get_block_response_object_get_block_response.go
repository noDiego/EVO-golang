...
// GetBlockResponseObjectGetBlockResponse struct for GetBlockResponseObjectGetBlockResponse
type GetBlockResponseObjectGetBlockResponse struct {
...
func NewGetBlockResponseObjectGetBlockResponse(responseActions []string, responseMessage string, responseCode int32) *GetBlockResponseObjectGetBlockResponse {
	this := GetBlockResponseObjectGetBlockResponse{}
...
func (o GetBlockResponseObjectGetBlockResponse) MarshalJSON() ([]byte, error) {
...
type NullableGetBlockResponseObjectGetBlockResponse struct {
	value *GetBlockResponseObjectGetBlockResponse
	isSet bool
}

func (v NullableGetBlockResponseObjectGetBlockResponse) Get() *GetBlockResponseObjectGetBlockResponse {
	return v.value
}

func (v *NullableGetBlockResponseObjectGetBlockResponse) Set(val *GetBlockResponseObjectGetBlockResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableGetBlockResponseObjectGetBlockResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableGetBlockResponseObjectGetBlockResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetBlockResponseObjectGetBlockResponse(val *GetBlockResponseObjectGetBlockResponse) *NullableGetBlockResponseObjectGetBlockResponse {
	return &NullableGetBlockResponseObjectGetBlockResponse{value: val, isSet: true}
}

func (v NullableGetBlockResponseObjectGetBlockResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetBlockResponseObjectGetBlockResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
